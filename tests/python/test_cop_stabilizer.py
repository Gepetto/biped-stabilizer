...
class TestCopStabilizer(unittest.TestCase):
    def setUp(self):
        ...
        LF = eMatrixHom()
        LF.set_translation(np.array([0.  , 0.09, 0.  ]))
        LF.set_rotation(np.eye(3))
        
        RF = eMatrixHom()
        RF.set_translation(np.array([0.  , -0.09, 0.  ]))
    ...
    def test_pcc_stabilization(self):
        ...
        self.assertTrue((desired_1000["com"][:2] +
                         desired_1000["dcom"][:2]/w < 1e-6).all())
        ...
        self.assertTrue((desired_1000["com"][:2] +
                         desired_1000["dcom"][:2]/w < 1e-4).all())
        ...
        self.assertTrue((desired_1000["com"][:2] +
                         desired_1000["dcom"][:2]/w == error3).all())
