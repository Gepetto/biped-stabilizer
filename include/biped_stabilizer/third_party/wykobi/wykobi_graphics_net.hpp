...
class wykobi_graphics_net {
 public:
  wykobi_graphics_net(Graphics ^ gc, const unsigned int& w,
                      const unsigned int& h)
      : gc_(gc), width_(w), height_(h) {
    pen_ = gcnew Pen(System::Drawing::Color::Black, 1);
  }

  ~wykobi_graphics_net() { delete gc_; }

  inline void set_pen(Pen ^ _pen) const { pen_ = _pen; }

  inline float get_pen_width() const { return pen_->Width; }
  ...
  inline void set_color(const unsigned int& color) const {
    switch (color % 15) {
      case 0:
        pen_->Color = System::Drawing::Color::Aqua;
        break;
      case 1:
        pen_->Color = System::Drawing::Color::Black;
        break;
      case 2:
        pen_->Color = System::Drawing::Color::Blue;
        break;
      case 3:
        pen_->Color = System::Drawing::Color::Brown;
        break;
      case 4:
        pen_->Color = System::Drawing::Color::Cyan;
        break;
      case 5:
        pen_->Color = System::Drawing::Color::Gray;
        break;
      case 6:
        pen_->Color = System::Drawing::Color::Green;
        break;
      case 7:
        pen_->Color = System::Drawing::Color::Indigo;
        break;
      case 8:
        pen_->Color = System::Drawing::Color::LimeGreen;
        break;
      case 9:
        pen_->Color = System::Drawing::Color::Magenta;
        break;
      case 10:
        pen_->Color = System::Drawing::Color::Orange;
        break;
      case 11:
        pen_->Color = System::Drawing::Color::Purple;
        break;
      case 12:
        pen_->Color = System::Drawing::Color::Red;
        break;
      case 13:
        pen_->Color = System::Drawing::Color::Violet;
        break;
      case 14:
        pen_->Color = System::Drawing::Color::White;
        break;
      case 15:
        pen_->Color = System::Drawing::Color::Yellow;
        break;
    }
  }
  ...
  inline void draw_segment(const T& x1, const T& y1, const T& x2,
                           const T& y2) const {
    gc_->DrawLine(pen_, float(x1), float(y1), float(x2), float(y2));
  }

  inline void draw_segment(const point2d<T>& point1,
                           const point2d<T>& point2) const {
    draw_segment(point1.x, point1.y, point2.x, point2.y);
  }

  inline void draw_line(const T& x1, const T& y1, const T& x2,
                        const T& y2) const {
    T dx = x2 - x1;
    T dy = y2 - y1;
  ...
  inline void draw_triangle(const T& x1, const T& y1, const T& x2, const T& y2,
  ...
  inline void draw_rectangle(const T& x1, const T& y1, const T& x2,
                             const T& y2) const {
    gc_->DrawRectangle(pen_, float(x1), float(y1), fabs(float(x2 - x1)),
                       fabs(float(y2 - y1)));
  }

  inline void draw_quadix(const T& x1, const T& y1, const T& x2, const T& y2,
  ...
  inline void draw_circle(const T& x, const T& y, const T& radius) const {
    gc_->DrawEllipse(pen_, float(x - radius), float(y - radius),
  ...
  inline void clear(System::Drawing::Color color) const { gc_->Clear(color); }

  inline void clear() const { clear(System::Drawing::Color::White); }

  inline void clear(const unsigned int& color) const {
    switch (color) {
      case 0:
        clear(System::Drawing::Color::Aqua);
        break;
      case 1:
        clear(System::Drawing::Color::Black);
        break;
      case 2:
        clear(System::Drawing::Color::Blue);
        break;
      case 3:
        clear(System::Drawing::Color::Brown);
        break;
      case 4:
        clear(System::Drawing::Color::Cyan);
        break;
      case 5:
        clear(System::Drawing::Color::Gray);
        break;
      case 6:
        clear(System::Drawing::Color::Green);
        break;
      case 7:
        clear(System::Drawing::Color::Indigo);
        break;
      case 8:
        clear(System::Drawing::Color::LimeGreen);
        break;
      case 9:
        clear(System::Drawing::Color::Magenta);
        break;
      case 10:
        clear(System::Drawing::Color::Orange);
        break;
      case 11:
        clear(System::Drawing::Color::Purple);
        break;
      case 12:
        clear(System::Drawing::Color::Red);
        break;
      case 13:
        clear(System::Drawing::Color::Violet);
        break;
      case 14:
        clear(System::Drawing::Color::White);
        break;
      case 15:
        clear(System::Drawing::Color::Yellow);
        break;
      default:
        clear(System::Drawing::Color::White);
        break;
  ...
  inline void draw(const triangle<T, 2>& triangle) const {
    draw_triangle(triangle[0].x, triangle[0].y, triangle[1].x, triangle[1].y,
                  triangle[2].x, triangle[2].y);
  }

  inline void draw(const rectangle<T>& rectangle) const {
    draw_rectangle(rectangle[0].x, rectangle[0].y, rectangle[1].x,
                   rectangle[1].y);
  }

  inline void draw(const quadix<T, 2>& quadix) const {
    draw_quadix(quadix[0].x, quadix[0].y, quadix[1].x, quadix[1].y, quadix[2].x,
                quadix[2].y, quadix[3].x, quadix[3].y);
  }
  ...
  inline void draw(const cubic_bezier<T, 2>& bezier,
                   const std::size_t& point_count) const {
    std::vector<point2d<T> > point_list;
    point_list.reserve(point_count);

    wykobi::generate_bezier(bezier, std::back_inserter(point_list),
                            point_count);

    draw_polyline(point_list);
  }

  inline void draw(const quadratic_bezier<T, 2>& bezier,
                   const std::size_t& point_count) const {
    std::vector<point2d<T> > point_list;
    point_list.reserve(point_count);
