...
inline std::ostream& operator<<(std::ostream& os, const point2d<Type>& point) {
  os << std::scientific << std::showpoint << std::setprecision(6) << "("
     << point.x << "," << point.y << ")";
...
inline std::ostream& operator<<(std::ostream& os, const vector2d<Type>& v) {
  os << std::scientific << std::showpoint << std::setprecision(6) << "(" << v.x
     << "," << v.y << ")";
...
inline std::ostream& operator<<(std::ostream& os,
  ...
  for (std::size_t i = 0; i < Dimension - 1; ++i) {
    os << std::scientific << std::showpoint << std::setprecision(6) << point[i]
       << ",";
  }
...
inline std::ostream& operator<<(std::ostream& os,
  ...
  for (unsigned int i = 0; i < wykobi::segment<Type, Dimension>::PointCount;
       ++i) {
    os << segment[i];
  }
...
inline std::ostream& operator<<(std::ostream& os,
  ...
  for (unsigned int i = 0; i < wykobi::triangle<Type, Dimension>::PointCount;
       ++i) {
    os << triangle[i];
  }
...
inline std::ostream& operator<<(std::ostream& os,
  ...
  for (unsigned int i = 0; i < wykobi::quadix<Type, Dimension>::PointCount;
       ++i) {
    os << quadix[i];
  }
...
inline std::ostream& operator<<(std::ostream& os, const circle<Type>& circle) {
  os << std::scientific << std::showpoint << std::setprecision(10) << "("
