...
namespace wykobi {
template <typename T>
inline int orientation(const T& x1, const T& y1, const T& x2, const T& y2,
...
template <typename T>
inline int orientation(const T& x1, const T& y1, const T& z1, const T& x2,
                       const T& y2, const T& z2, const T& x3, const T& y3,
                       const T& z3, const T& px, const T& py, const T& pz) {
  const T px1 = x1 - px;
  const T px2 = x2 - px;
  const T px3 = x3 - px;
  ...
  const T orin = px1 * (py2 * pz3 - pz2 * py3) + px2 * (py3 * pz1 - pz3 * py1) +
                 px3 * (py1 * pz2 - pz1 * py2);
  ...
  if (orin < T(0.0))
    ...
    return CoplanarOrientation; /* Orientaion is coplanar to plane if Result is
                                   0 */
}

template <typename T>
inline int robust_orientation(const T& x1, const T& y1, const T& x2,
                              const T& y2, const T& px, const T& py) {
  const T orin = (x2 - x1) * (py - y1) - (px - x1) * (y2 - y1);
  ...
  /*
     ...
     Where:
       Orin : is the "real" mathematically precise orientation value, using
     infinite precision arithmetic (hypothetical) Orin`: is the calculated
     imprecise orientation value, using finite precision arithmetic
  */
...
template <typename T>
inline int orientation(const point2d<T>& point1, const point2d<T>& point2,
                       const T& px, const T& py) {
...
inline int orientation(const point2d<T>& point1, const point2d<T>& point2,
  ...
  return orientation(point1.x, point1.y, point2.x, point2.y, point3.x,
                     point3.y);
}
...
template <typename T>
inline int orientation(const point3d<T>& point1, const point3d<T>& point2,
                       const point3d<T>& point3, const T& px, const T& py,
                       const T& pz) {
  return orientation(point1.x, point1.y, point1.z, point2.x, point2.y, point2.z,
                     point3.x, point3.y, point3.z, px, py, pz);
}

template <typename T>
inline int orientation(const point3d<T>& point1, const point3d<T>& point2,
                       const point3d<T>& point3, const point3d<T>& point4) {
  return orientation(point1.x, point1.y, point1.z, point2.x, point2.y, point2.z,
                     point3.x, point3.y, point3.z, point4.x, point4.y,
                     point4.z);
}
...
template <typename T>
inline bool differing_orientation(const T& x1, const T& y1, const T& x2,
                                  const T& y2, const T& p1x, const T& p1y,
                                  const T& p2x, const T& p2y) {
  /* Collinear orientation is not considered */
  return ((orientation(x1, y1, x2, y2, p1x, p1y) *
           orientation(x1, y1, x2, y2, p2x, p2y)) == -1);
}
...
template <typename T>
inline int in_circle(const T& x1, const T& y1, const T& x2, const T& y2,
                     const T& x3, const T& y3, const T& px, const T& py) {
  const T dx1 = x1 - px;
  const T dy1 = y1 - py;
  const T dx2 = x2 - px;
  const T dy2 = y2 - py;
...
template <typename T>
inline int in_circle(const point2d<T>& point1, const point2d<T>& point2,
                     const point2d<T>& point3, const point2d<T>& point4) {
  return in_circle(point1.x, point1.y, point2.x, point2.y, point3.x, point3.y,
                   point4.x, point4.y);
}
...
template <typename T>
inline int in_sphere(const T& x1, const T& y1, const T& z1, const T& x2,
                     const T& y2, const T& z2, const T& x3, const T& y3,
                     const T& z3, const T& x4, const T& y4, const T& z4,
                     const T& px, const T& py, const T& pz) {
  const T dx1 = x1 - px;
  const T dx2 = x2 - px;
  const T dx3 = x3 - px;
...
template <typename T>
inline int in_sphere(const point3d<T>& point1, const point3d<T>& point2,
                     const point3d<T>& point3, const point3d<T>& point4,
                     const point3d<T>& point5) {
  return in_sphere(point1.x, point1.y, point1.z, point2.x, point2.y, point2.z,
                   point3.x, point3.y, point3.z, point4.x, point4.y, point4.z,
...
template <typename T>
inline T signed_area(const T& x1, const T& y1, const T& x2, const T& y2,
                     const T& px, const T& py) {
  return (x2 - x1) * (py - y1) - (px - x1) * (y2 - y1);
}

template <typename T>
inline T signed_area(const point2d<T>& point1, const point2d<T>& point2,
                     const T& px, const T& py) {
...
inline T signed_area(const point2d<T>& point1, const point2d<T>& point2,
                     const point2d<T>& point3) {
  return signed_area(point1.x, point1.y, point2.x, point2.y, point3.x,
                     point3.y);
}
...
template <typename T>
inline T signed_volume(const T& x1, const T& y1, const T& z1, const T& x2,
                       const T& y2, const T& z2, const T& x3, const T& y3,
                       const T& z3, const T& px, const T& py, const T& pz) {
  const T px1 = x1 - px;
  const T px2 = x2 - px;
  ...
  return px1 * (py2 * pz3 - pz2 * py3) + px2 * (py3 * pz1 - pz3 * py1) +
         px3 * (py1 * pz2 - pz1 * py2);
}

template <typename T>
inline T signed_volume(const point3d<T>& point1, const point3d<T>& point2,
                       const point3d<T>& point3, const T& px, const T& py,
                       const T& pz) {
  return signed_volume(point1.x, point1.y, point1.z, point2.x, point2.y,
                       point2.z, point3.x, point3.y, point3.z, px, py, pz);
}
...
inline T signed_volume(const point3d<T>& point1, const point3d<T>& point2,
                       const point3d<T>& point3, const point3d<T>& point4) {
  return signed_volume(point1.x, point1.y, point1.z, point2.x, point2.y,
                       point2.z, point3.x, point3.y, point3.z, point4.x,
                       point4.y, point4.z);
}

template <typename T>
inline T signed_volume(const triangle<T, 3>& triangle,
                       const point3d<T>& point) {
  return signed_volume(triangle[0], triangle[1], triangle[2], point);
}

template <typename T>
inline bool collinear(const T& x1, const T& y1, const T& x2, const T& y2,
                      const T& x3, const T& y3, const T& epsilon) {
  return is_equal((x2 - x1) * (y3 - y1), (x3 - x1) * (y2 - y1), epsilon);
}

template <typename T>
inline bool collinear(const T& x1, const T& y1, const T& z1, const T& x2,
                      const T& y2, const T& z2, const T& x3, const T& y3,
                      const T& z3, const T& epsilon) {
  const T dx1 = x2 - x1;
  const T dy1 = y2 - y1;
  const T dz1 = z2 - z1;
  const T dx2 = x3 - x1;
...
template <typename T>
inline bool collinear(const point2d<T>& point1, const point2d<T>& point2,
                      const point2d<T>& point3) {
  return collinear(point1.x, point1.y, point2.x, point2.y, point3.x, point3.y);
}

template <typename T>
inline bool collinear(const point3d<T>& point1, const point3d<T>& point2,
                      const point3d<T>& point3) {
  return collinear(point1.x, point1.y, point1.z, point2.x, point2.y, point2.z,
                   point3.x, point3.y, point3.z);
}

template <typename T>
inline bool robust_collinear(const T& x1, const T& y1, const T& x2, const T& y2,
                             const T& x3, const T& y3, const T& epsilon) {
  ...
  if (leydist1 >= leydist2)
    if (leydist1 >= leydist3)
      return is_equal(
          minimum_distance_from_point_to_line(x3, y3, x1, y1, x2, y2), T(0.0),
          epsilon);
    else
      return is_equal(
          minimum_distance_from_point_to_line(x2, y2, x3, y3, x1, y1), T(0.0),
          epsilon);
  else if (leydist2 >= leydist3)
    return is_equal(minimum_distance_from_point_to_line(x1, y1, x2, y2, x3, y3),
                    T(0.0), epsilon);
  else
    return is_equal(minimum_distance_from_point_to_line(x2, y2, x3, y3, x1, y1),
                    T(0.0), epsilon);
}

template <typename T>
inline bool robust_collinear(const point2d<T>& point1, const point2d<T>& point2,
                             const point2d<T>& point3, const T& epsilon) {
  return robust_collinear(point1.x, point1.y, point2.x, point2.y, point3.x,
                          point3.y, epsilon);
}

template <typename T>
inline bool robust_collinear(const T& x1, const T& y1, const T& z1, const T& x2,
                             const T& y2, const T& z2, const T& x3, const T& y3,
                             const T& z3, const T& epsilon) {
  ...
  if (leydist1 >= leydist2)
    if (leydist1 >= leydist3)
      return is_equal(minimum_distance_from_point_to_line(x3, y3, z3, x1, y1,
                                                          z1, x2, y2, z2),
                      T(0.0), epsilon);
    else
      return is_equal(minimum_distance_from_point_to_line(x2, y2, z2, x3, y3,
                                                          z3, x1, y1, z1),
                      T(0.0), epsilon);
  else if (leydist2 >= leydist3)
    return is_equal(
        minimum_distance_from_point_to_line(x1, y1, z1, x2, y2, z2, x3, y3, z3),
        T(0.0), epsilon);
  else
    return is_equal(
        minimum_distance_from_point_to_line(x2, y2, z2, x3, y3, z3, x1, y1, z1),
        T(0.0), epsilon);
}

template <typename T>
inline bool robust_collinear(const point3d<T>& point1, const point3d<T>& point2,
                             const point3d<T>& point3, const T& epsilon) {
  return robust_collinear(point1.x, point1.y, point1.z, point2.x, point2.y,
                          point2.z, point3.x, point3.y, point3.z, epsilon);
}

template <typename T>
inline bool robust_collinear(const line<T, 2>& line, const point2d<T>& point,
                             const T& epsilon) {
  return robust_collinear(line[0], line[1], point, epsilon);
}

template <typename T>
inline bool robust_collinear(const line<T, 3>& line, const point3d<T>& point,
                             const T& epsilon) {
  return robust_collinear(line[0], line[1], point, epsilon);
}

template <typename T>
inline bool is_point_collinear(const T& x1, const T& y1, const T& x2,
                               const T& y2, const T& px, const T& py,
                               const bool robust) {
  /*
     This method will return true iff the point (px,py) is collinear
     to points (x1,y1) and (x2,y2) and exists on the line segment
     A(x1,y1)->B(x2,y2)
  */
...
inline bool is_point_collinear(const point2d<T>& point1,
                               ...
                               const point2d<T>& point3, const bool robust) {
  return is_point_collinear(point1.x, point1.y, point2.x, point2.y, point3.x,
                            point3.y, robust);
}

template <typename T>
inline bool is_point_collinear(const point2d<T>& point1,
                               const point2d<T>& point2, const T& px,
                               const T& py, const bool robust) {
  return is_point_collinear(point1.x, point1.y, point2.x, point2.y, px, py,
                            robust);
}

template <typename T>
inline bool is_point_collinear(const segment<T, 2>& segment,
                               const point2d<T>& point, const bool robust) {
...
inline bool is_point_collinear(const T& x1, const T& y1, const T& z1,
  ...
  /*
    ...
    to points (x1,y1,z1) and (x2,y2,z2) and exists on the line segment
...
inline bool is_point_collinear(const point3d<T>& point1,
                               ...
                               const point3d<T>& point3, const bool robust) {
  return is_point_collinear(point1.x, point1.y, point1.z, point2.x, point2.y,
                            point2.z, point3.x, point3.y, point3.z, robust);
}

template <typename T>
inline bool is_point_collinear(const segment<T, 3>& segment,
                               const point3d<T>& point, const bool robust) {
  return is_point_collinear(segment[0], segment[1], point, robust);
}

template <typename T>
inline bool robust_coplanar(const point3d<T> point1, const point3d<T> point2,
                            const point3d<T> point3, const point3d<T> point4,
                            const T& epsilon) {
  return less_than_or_equal(
      lay_distance(point4, make_plane(point1, point2, point3)), sqr(epsilon));
}
...
inline bool coplanar(const ray<T, 3>& ray1, const ray<T, 3>& ray2) {
  ...
  if (robust_collinear(ray1.origin, pnt1, pnt2) &&
      robust_collinear(ray2.origin, pnt2, pnt1))
    return true;
  else
...
template <typename T>
inline bool coplanar(const segment<T, 3>& segment1,
...
template <typename T>
inline bool coplanar(const triangle<T, 3>& triangle1,
                     const triangle<T, 3>& triangle2) {
  return robust_coplanar(triangle1[0], triangle1[1], triangle1[2],
                         triangle2[0]) &&
         robust_coplanar(triangle1[0], triangle1[1], triangle1[2],
                         triangle2[1]) &&
         robust_coplanar(triangle1[0], triangle1[1], triangle1[2],
                         triangle2[2]);
}
...
template <typename T>
inline bool cocircular(const T& x1, const T& y1, const T& x2, const T& y2,
                       const T& x3, const T& y3, const T& x4, const T& y4,
                       const T& epsilon) {
...
template <typename T>
inline bool cocircular(const point2d<T>& point1, const point2d<T>& point2,
                       const point2d<T>& point3, const point2d<T>& point4,
                       const T& epsilon) {
  return cocircular(point1.x, point1.y, point2.x, point2.y, point3.x, point3.y,
                    point4.x, point4.y, epsilon);
}

template <typename T>
inline bool cocircular(const triangle<T, 2>& triangle, const point2d<T>& point,
                       const T& epsilon) {
  return cocircular(triangle[0], triangle[1], triangle[2], point, epsilon);
}

template <typename T>
inline bool cocircular(const circle<T>& circle, const point2d<T>& point,
                       const T& epsilon) {
  return is_equal(distance(point.x, point.y, circle.x, circle.y), circle.radius,
                  epsilon);
}

template <typename T>
inline bool is_skinny_triangle(const T& x1, const T& y1, const T& x2,
                               const T& y2, const T& x3, const T& y3) {
  /*
  ...
  */
  ...
  const T shortest_length =
      sqrt(min(lay_distance(x1, y1, x2, y2), lay_distance(x1, y1, x3, y3),
...
inline bool is_skinny_triangle(const point2d<T>& point1,
                               const point2d<T>& point2,
                               const point2d<T>& point3) {
  return is_skinny_triangle(point1.x, point1.y, point2.x, point2.y, point3.x,
                            point3.y);
}
...
template <typename T>
inline bool intersect(const T& x1, const T& y1, const T& x2, const T& y2,
                      const T& x3, const T& y3, const T& x4, const T& y4) {
  const T ax = x2 - x1;
  const T bx = x3 - x4;
...
template <typename T>
inline bool intersect(const T& x1, const T& y1, const T& x2, const T& y2,
                      const T& x3, const T& y3, const T& x4, const T& y4, T& ix,
                      T& iy) {
  const T ax = x2 - x1;
  const T bx = x3 - x4;
...
inline bool intersect(const point2d<T>& point1, const point2d<T>& point2,
                      const point2d<T>& point3, const point2d<T>& point4) {
  return intersect(point1.x, point1.y, point2.x, point2.y, point3.x, point3.y,
                   point4.x, point4.y);
}
...
inline bool intersect(const point2d<T>& point1, const point2d<T>& point2,
                      ...
                      point2d<T>& int_point) {
  return intersect(point1.x, point1.y, point2.x, point2.y, point3.x, point3.y,
                   point4.x, point4.y, int_point.x, int_point.y);
}

template <typename T>
inline bool intersect(const segment<T, 2>& segment1,
                      const segment<T, 2>& segment2) {
  return intersect(segment1[0], segment1[1], segment2[0], segment2[1]);
}

template <typename T>
inline bool intersect_vertical_horizontal(const segment<T, 2>& segment1,
                                          const segment<T, 2>& segment2) {
  return (((segment1[0].y <= segment2[0].y) &&
           (segment2[0].y <= segment1[1].y)) ||
          ((segment1[1].y <= segment2[0].y) &&
           (segment2[0].y <= segment1[0].y))) &&
         (((segment2[0].x <= segment1[0].x) &&
           (segment1[0].x <= segment2[1].x)) ||
          ((segment2[1].x <= segment1[0].x) &&
           (segment1[0].x <= segment2[0].x)));
}

template <typename T>
inline bool intersect_vertical_vertical(const segment<T, 2>& segment1,
                                        const segment<T, 2>& segment2) {
  return (segment1[0].x == segment2[0].x) &&
         (((segment1[0].y <= segment2[0].y) &&
           (segment2[0].y <= segment1[1].y)) ||
          ((segment1[0].y <= segment2[1].y) &&
           (segment2[1].y <= segment1[1].y)));
}

template <typename T>
inline bool intersect_horizontal_horizontal(const segment<T, 2>& segment1,
                                            const segment<T, 2>& segment2) {
  return (segment1[0].y == segment2[0].y) &&
         (((segment1[0].x <= segment2[0].x) &&
           (segment2[0].x <= segment1[1].x)) ||
          ((segment1[0].x <= segment2[1].x) &&
           (segment2[1].x <= segment1[1].x)));
}

template <typename T>
inline bool intersect(const segment<T, 2>& segment1,
                      const segment<T, 2>& segment2, T& ix, T& iy) {
...
template <typename T>
inline bool intersect(const segment<T, 2>& segment1,
                      const segment<T, 2>& segment2, point2d<T>& i_point) {
  return intersect(segment1[0].x, segment1[0].y, segment1[1].x, segment1[1].y,
                   segment2[0].x, segment2[0].y, segment2[1].x, segment2[1].y,
                   i_point.x, i_point.y);
}
...
template <typename T>
inline bool intersect(const T& x1, const T& y1, const T& z1, const T& x2,
                      const T& y2, const T& z2, const T& x3, const T& y3,
                      const T& z3, const T& x4, const T& y4, const T& z4,
                      const T& fuzzy) {
  return (
      less_than_or_equal(lay_distance_segment_to_segment(
                             x1, y1, z1, x2, y2, z2, x3, y3, z3, x4, y4, z4),
                         fuzzy));
}

template <typename T>
inline bool intersect(const point3d<T>& point1, const point3d<T>& point2,
                      const point3d<T>& point3, const point3d<T>& point4,
                      const T& fuzzy) {
  return intersect(point1.x, point1.y, point1.z, point2.x, point2.y, point2.z,
                   point3.x, point3.y, point3.z, point4.x, point4.y, point4.z,
                   fuzzy);
}

template <typename T>
inline bool intersect(const segment<T, 3>& segment1,
                      const segment<T, 3>& segment2, const T& fuzzy) {
  return intersect(segment1[0], segment1[1], segment2[0], segment2[1], fuzzy);
}

template <typename T>
inline bool intersect(const segment<T, 2>& segment,
                      const rectangle<T>& rectangle) {
  if (intersect(rectangle, make_rectangle(segment[0], segment[1]))) {
    int orin =
        orientation(segment[0], segment[1], rectangle[0].x, rectangle[0].y);

    if ((orientation(segment[0], segment[1], rectangle[0].x, rectangle[1].y) ==
         orin) &&
        (orientation(segment[0], segment[1], rectangle[1].x, rectangle[1].y) ==
         orin) &&
        (orientation(segment[0], segment[1], rectangle[1].x, rectangle[0].y) ==
         orin))
      return false;
    else
      return true;
...
inline bool intersect(const segment<T, 3>& segment, const line<T, 3>& line,
  ...
  return intersect(
      segment,
      make_segment(closest_point_on_line_from_point(line, segment[0]),
...
inline bool intersect(const segment<T, 2>& segment, const circle<T>& circle) {
  ...
  closest_point_on_segment_from_point(segment[0].x, segment[0].y, segment[1].x,
                                      segment[1].y, circle.x, circle.y, px, py);

  return (lay_distance(px, py, circle.x, circle.y) <=
...
inline bool intersect(const segment<T, 2>& segment,
  ...
  return simplex_to_bezier_intersect<T, 2, wykobi::segment<T, 2>,
                                     quadratic_bezier<T, 2> >(segment, bezier,
                                                              steps);
}
...
inline bool intersect(const segment<T, 2>& segment,
                      ...
                      const std::size_t& steps) {
  return simplex_to_bezier_intersect<T, 2, wykobi::segment<T, 2>,
                                     cubic_bezier<T, 2> >(segment, bezier,
                                                          steps);
}
...
inline bool intersect(const segment<T, 3>& segment, const sphere<T>& sphere) {
  ...
  const T b = 2 * ((segment[1].x - segment[0].x) * (segment[0].x - sphere.x) +
                   (segment[1].y - segment[0].y) * (segment[0].y - sphere.y) +
                   (segment[1].z - segment[0].z) * (segment[0].z - sphere.z));
  const T c = sqr(sphere.x) + sqr(sphere.y) + sqr(sphere.z) +
              sqr(segment[1].x) + sqr(segment[1].y) + sqr(segment[1].z) -
              2 * (sphere.x * segment[1].x + sphere.y * segment[1].y +
                   sphere.z * segment[1].z) -
              sqr(sphere.radius);
...
inline bool intersect(const segment<T, 3>& segment, const plane<T, 3>& plane) {
  T signed_dist1 =
      dot_product(plane.normal, make_vector(segment[0])) - plane.constant;
  T signed_dist2 =
      dot_product(plane.normal, make_vector(segment[1])) - plane.constant;
...
template <typename T>
inline bool intersect(const segment<T, 3>& segment,
                      const quadratic_bezier<T, 3>& bezier,
                      const std::size_t& steps) {
  return simplex_to_bezier_intersect<T, 3, wykobi::segment<T, 3>,
                                     quadratic_bezier<T, 3> >(segment, bezier,
                                                              steps);
}
...
inline bool intersect(const segment<T, 3>& segment,
                      ...
                      const std::size_t& steps) {
  return simplex_to_bezier_intersect<T, 3, wykobi::segment<T, 3>,
                                     cubic_bezier<T, 3> >(segment, bezier,
                                                          steps);
}
...
inline bool intersect(const line<T, 2>& line, const circle<T>& circle) {
  ...
  */
  ...
  return greater_than_or_equal(
      ((circle.radius * circle.radius) * lay_distance(x1, y1, x2, y2) -
       sqr(x1 * y2 - x2 * y1)),
      T(0.0));
}

template <typename T>
inline bool intersect(const line<T, 2>& line,
                      const quadratic_bezier<T, 2>& bezier,
                      const std::size_t& steps) {
  return simplex_to_bezier_intersect<T, 2, wykobi::line<T, 2>,
                                     quadratic_bezier<T, 2> >(line, bezier,
                                                              steps);
}

template <typename T>
inline bool intersect(const line<T, 2>& line, const cubic_bezier<T, 2>& bezier,
                      const std::size_t& steps) {
  return simplex_to_bezier_intersect<T, 2, wykobi::line<T, 2>,
                                     cubic_bezier<T, 2> >(line, bezier, steps);
}
...
inline bool intersect(const line<T, 3>& line, const sphere<T>& sphere) {
  ...
  const T c = sqr(sphere.x) + sqr(sphere.y) + sqr(sphere.z) + sqr(line[0].x) +
              sqr(line[0].y) + sqr(line[0].z) -
              T(2.0) * (sphere.x * line[0].x + sphere.y * line[0].y +
                        sphere.z * line[0].z) -
              sqr(sphere.radius);
...
template <typename T>
inline bool intersect(const line<T, 3>& line,
                      const quadratic_bezier<T, 3>& bezier,
                      const std::size_t& steps) {
  return simplex_to_bezier_intersect<T, 3, wykobi::line<T, 3>,
                                     quadratic_bezier<T, 3> >(line, bezier,
                                                              steps);
}

template <typename T>
inline bool intersect(const line<T, 3>& line, const cubic_bezier<T, 3>& bezier,
                      const std::size_t& steps) {
  return simplex_to_bezier_intersect<T, 3, wykobi::line<T, 3>,
                                     cubic_bezier<T, 3> >(line, bezier, steps);
}
...
template <typename T>
inline bool intersect(const triangle<T, 2>& triangle,
                      const rectangle<T>& rectangle) {
...
inline bool intersect(const triangle<T, 2>& triangle,
                      const quadratic_bezier<T, 2>& bezier,
                      const std::size_t& steps) {
  return simplex_to_bezier_intersect<T, 2, wykobi::triangle<T, 2>,
                                     quadratic_bezier<T, 2> >(triangle, bezier,
                                                              steps);
}
...
inline bool intersect(const triangle<T, 2>& triangle,
                      ...
                      const std::size_t& steps) {
  return simplex_to_bezier_intersect<T, 2, wykobi::triangle<T, 2>,
                                     cubic_bezier<T, 2> >(triangle, bezier,
                                                          steps);
}

template <typename T>
inline bool intersect(const triangle<T, 2>& triangle1,
                      const triangle<T, 2>& triangle2) {
  for (std::size_t i = 0; i < triangle<T, 2>::PointCount; ++i) {
    if (is_equal(
            minimum_distance_from_point_to_triangle(triangle1[i], triangle2),
            T(0.0)) ||
        is_equal(
...
template <typename T>
inline bool intersect(const rectangle<T>& rectangle1,
...
template <typename T>
inline bool intersect(const rectangle<T>& rectangle,
                      const quadratic_bezier<T, 2>& bezier,
                      const std::size_t& steps) {
  return simplex_to_bezier_intersect<T, 2, wykobi::rectangle<T>,
                                     quadratic_bezier<T, 2> >(rectangle, bezier,
                                                              steps);
}
...
inline bool intersect(const rectangle<T>& rectangle,
                      ...
                      const std::size_t& steps) {
  return simplex_to_bezier_intersect<T, 2, wykobi::rectangle<T>,
                                     cubic_bezier<T, 2> >(rectangle, bezier,
                                                          steps);
}
...
template <typename T>
inline bool intersect(const quadix<T, 2>& quadix,
                      const quadratic_bezier<T, 2>& bezier,
                      const std::size_t& steps) {
  return simplex_to_bezier_intersect<T, 2, wykobi::quadix<T, 2>,
                                     quadratic_bezier<T, 2> >(quadix, bezier,
                                                              steps);
}
...
inline bool intersect(const quadix<T, 2>& quadix,
                      ...
                      const std::size_t& steps) {
  return simplex_to_bezier_intersect<T, 2, wykobi::quadix<T, 2>,
                                     cubic_bezier<T, 2> >(quadix, bezier,
                                                          steps);
}
...
inline bool intersect(const circle<T>& circle1, const circle<T>& circle2) {
  return (
      lay_distance(circle1.x, circle1.y, circle2.x, circle2.y) <=
      ((circle1.radius + circle2.radius) * (circle1.radius + circle2.radius)));
}

template <typename T>
inline bool intersect(const circle<T>& circle,
                      const quadratic_bezier<T, 2>& bezier,
                      const std::size_t& steps) {
  return simplex_to_bezier_intersect<T, 2, wykobi::circle<T>,
                                     quadratic_bezier<T, 2> >(circle, bezier,
                                                              steps);
}

template <typename T>
inline bool intersect(const circle<T>& circle, const cubic_bezier<T, 2>& bezier,
                      const std::size_t& steps) {
  return simplex_to_bezier_intersect<T, 2, wykobi::circle<T>,
                                     cubic_bezier<T, 2> >(circle, bezier,
                                                          steps);
}
...
inline bool intersect(const box<T, 3>& box, const sphere<T>& sphere) {
  return point_in_sphere(
      closest_point_on_box_from_point(box, sphere.x, sphere.y, sphere.z),
      sphere);
}

template <typename T>
inline bool intersect(const sphere<T>& sphere1, const sphere<T>& sphere2) {
  return (lay_distance(sphere1.x, sphere1.y, sphere1.z, sphere2.x, sphere2.y,
                       sphere2.z) <= ((sphere1.radius + sphere2.radius) *
                                      (sphere1.radius + sphere2.radius)));
}

template <typename T>
inline bool intersect(const sphere<T>& sphere,
                      const quadratic_bezier<T, 3>& bezier,
                      const std::size_t& steps) {
  return simplex_to_bezier_intersect<T, 3, wykobi::sphere<T>,
                                     quadratic_bezier<T, 3> >(sphere, bezier,
                                                              steps);
}

template <typename T>
inline bool intersect(const sphere<T>& sphere, const cubic_bezier<T, 3>& bezier,
                      const std::size_t& steps) {
  return simplex_to_bezier_intersect<T, 3, wykobi::sphere<T>,
                                     cubic_bezier<T, 3> >(sphere, bezier,
                                                          steps);
}
...
inline bool intersect(const ray<T, 2>& ray, const segment<T, 2>& segment) {
  ...
  if (denom != T(0.0)) {
    ...
    return greater_than_or_equal(t, T(0.0)) && less_than_or_equal(t, T(1.0)) &&
           greater_than_or_equal(s, T(0.0));
  } else
...
inline bool intersect(const ray<T, 3>& ray, const segment<T, 3>& segment) {
  if (robust_coplanar(segment[0], segment[1], ray.origin,
                      generate_point_on_ray(ray, T(1.0))))
    return point_on_segment(closest_point_on_ray_from_point(ray, segment[0]),
                            segment);
  else
    return false;
}
...
inline bool intersect(const ray<T, 3>& ray, const triangle<T, 3>& triangle) {
  ...
  const T v = (ray.direction.x * qvec_x + ray.direction.y * qvec_y +
               ray.direction.z * qvec_z) *
              inv_det;

  if ((v < 0.0) || ((u + v) > 1.0)) return false;

  const T t =
      (edge2_x * qvec_x + edge2_y * qvec_y + edge2_z * qvec_z) * inv_det;
...
inline bool intersect(const ray<T, 2>& ray, const quadix<T, 2>& quadix) {
  if (point_in_quadix(ray.origin, quadix))
    ...
    return intersect(ray, edge(quadix, 0)) || intersect(ray, edge(quadix, 1)) ||
           intersect(ray, edge(quadix, 2)) || intersect(ray, edge(quadix, 3));
}
...
inline bool intersect(const plane<T, 3>& plane, const sphere<T>& sphere) {
  return less_than_or_equal(
      distance(make_point(sphere.x, sphere.y, sphere.z), plane), sphere.radius);
}
...
template <typename T>
inline bool simple_intersect(const T& x1, const T& y1, const T& x2, const T& y2,
                             const T& x3, const T& y3, const T& x4,
                             const T& y4) {
...
inline bool simple_intersect(const point2d<T>& point1, const point2d<T>& point2,
  ...
  return simple_intersect(point1.x, point1.y, point2.x, point2.y, point3.x,
                          point3.y, point4.x, point4.y);
}

template <typename T>
inline bool simple_intersect(const segment<T, 2>& segment1,
                             const segment<T, 2>& segment2) {
  return simple_intersect(segment1[0], segment1[1], segment2[0], segment2[1]);
}

template <typename T>
inline void intersection_point(const T& x1, const T& y1, const T& x2,
                               const T& y2, const T& x3, const T& y3,
                               const T& x4, const T& y4, T& ix, T& iy) {
  const T dx1 = x2 - x1;
  const T dx2 = x4 - x3;
  const T dx3 = x1 - x3;
...
inline void intersection_point(const point2d<T>& point1,
                               const point2d<T>& point2,
                               const point2d<T>& point3,
                               const point2d<T>& point4, T& ix, T& iy) {
  intersection_point(point1.x, point1.y, point2.x, point2.y, point3.x, point3.y,
                     point4.x, point4.y, ix, iy);
}
...
inline point2d<T> intersection_point(const point2d<T>& point1,
  ...
  point2d<T> point_;
  intersection_point(point1.x, point1.y, point2.x, point2.y, point3.x, point3.y,
                     point4.x, point4.y, point_.x, point_.y);
  return point_;
}
...
inline void intersection_point(const T& x1, const T& y1, const T& z1,
                               const T& x2, const T& y2, const T& z2,
                               const T& x3, const T& y3, const T& z3,
                               const T& x4, const T& y4, const T& z4, T& ix,
                               T& iy, T& iz, const T& fuzzy) {
  const T ux = x2 - x1;
  const T uy = y2 - y1;
  const T uz = z2 - z1;
...
inline void intersection_point(const point3d<T>& point1,
                               const point3d<T>& point2,
                               const point3d<T>& point3,
                               const point3d<T>& point4, T& ix, T& iy, T& iz,
                               const T& fuzzy) {
  intersection_point(point1.x, point1.y, point1.z, point2.x, point2.y, point2.z,
                     point3.x, point3.y, point3.z, point4.x, point4.y, point4.z,
                     ix, iy, iz, fuzzy);
}
...
inline void intersection_point(const segment<T, 2>& segment,
                               const quadratic_bezier<T, 2>& bezier,
                               OutputIterator out, const std::size_t& steps) {
  simplex_to_bezier_intersection_point<T, 2, wykobi::segment<T, 2>,
                                       quadratic_bezier<T, 2>, OutputIterator>(
      segment, bezier, out, steps);
}
...
inline void intersection_point(const segment<T, 2>& segment,
                               ...
                               OutputIterator out, const std::size_t& steps) {
  simplex_to_bezier_intersection_point<T, 2, wykobi::segment<T, 2>,
                                       cubic_bezier<T, 2>, OutputIterator>(
      segment, bezier, out, steps);
}
...
inline void intersection_point(const segment<T, 3>& segment,
                               const quadratic_bezier<T, 3>& bezier,
                               OutputIterator out, const std::size_t& steps) {
  simplex_to_bezier_intersection_point<T, 3, wykobi::segment<T, 3>,
                                       quadratic_bezier<T, 3>, OutputIterator>(
      segment, bezier, out, steps);
}
...
inline void intersection_point(const segment<T, 3>& segment,
                               ...
                               OutputIterator out, const std::size_t& steps) {
  simplex_to_bezier_intersection_point<T, 3, wykobi::segment<T, 3>,
                                       cubic_bezier<T, 3>, OutputIterator>(
      segment, bezier, out, steps);
}
...
inline point3d<T> intersection_point(const line<T, 3>& line1,
                                     const line<T, 3>& line2, const T& fuzzy) {
  point3d<T> point_;

  intersection_point_line_to_line(
      line1[0].x, line1[0].y, line1[0].z, line1[1].x, line1[1].y, line1[1].z,
      line2[0].x, line2[0].y, line2[0].z, line2[1].x, line2[1].y, line2[1].z,
      point_.x, point_.y, point_.z, fuzzy);
...
inline void intersection_point(const circle<T>& circle1,
                               const circle<T>& circle2, point2d<T>& point1,
                               point2d<T>& point2) {
...
template <typename T, typename OutputIterator>
inline void intersection_point(const T& x1, const T& y1, const T& x2,
                               const T& y2, const T& cx, const T& cy,
                               const T& radius, OutputIterator out) {
  ...
  if ((is_equal(x1, px) && is_equal(y1, py)) ||
...
template <typename T, typename OutputIterator>
inline void intersection_point(const segment<T, 2>& segment,
                               const circle<T>& circle, OutputIterator out) {
  intersection_point(segment[0].x, segment[0].y, segment[1].x, segment[1].y,
                     circle.x, circle.y, circle.radius, out);
}

template <typename T, typename OutputIterator>
inline void intersection_point(const line<T, 2>& line, const circle<T>& circle,
                               OutputIterator out) {
  const T a = sqr(line[1].x - line[0].x) + sqr(line[1].y - line[0].y);
  ...
  const T c = sqr(circle.x) + sqr(circle.y) + sqr(line[0].x) + sqr(line[0].y) -
              T(2.0) * (circle.x * line[0].x + circle.y * line[0].y) -
              sqr(circle.radius);
...
template <typename T, typename OutputIterator>
inline void intersection_point(const segment<T, 3>& segment,
                               const sphere<T>& sphere, OutputIterator out) {
...
template <typename T, typename OutputIterator>
inline void intersection_point(const line<T, 3>& line, const sphere<T>& sphere,
                               OutputIterator out) {
  const T a = sqr(line[1].x - line[0].x) + sqr(line[1].y - line[0].y) +
              sqr(line[1].z - line[0].z);
...
template <typename T>
inline point2d<T> intersection_point(const ray<T, 2>& ray1,
                                     const ray<T, 2>& ray2) {
  const T denom = (ray2.direction.y * ray1.direction.x -
                   ray2.direction.x * ray1.direction.y);

  if (denom != T(0.0)) {
    const T ta = (ray2.direction.x * (ray1.origin.y - ray2.origin.y) -
                  ray2.direction.y * (ray1.origin.x - ray2.origin.x)) /
                 denom;
    const T tb = (ray1.direction.y * (ray2.origin.x - ray1.origin.x) -
                  ray1.direction.x * (ray2.origin.y - ray1.origin.y)) /
                 denom;

    if (greater_than_or_equal(ta, T(0.0)) && greater_than_or_equal(tb, T(0.0)))
      return make_point(ray1.origin.x + (ray1.direction.x * ta),
...
template <typename T>
inline point3d<T> intersection_point(const ray<T, 3>& ray,
                                     const triangle<T, 3>& triangle) {
  const T edge1_x = triangle[1].x - triangle[0].x;
  const T edge1_y = triangle[1].y - triangle[0].y;
  const T edge1_z = triangle[1].z - triangle[0].z;
...
template <typename T, typename OutputIterator>
inline void intersection_point(const ray<T, 2>& ray, const circle<T>& circle,
                               OutputIterator out)
...
template <typename T, typename OutputIterator>
inline void intersection_point(const ray<T, 3>& ray, const sphere<T>& sphere,
                               OutputIterator out) {
...
template <typename T>
inline void intersection_point_line_to_line(
    const T& x1, const T& y1, const T& z1, const T& x2, const T& y2,
    const T& z2, const T& x3, const T& y3, const T& z3, const T& x4,
    const T& y4, const T& z4, T& ix, T& iy, T& iz, const T& fuzzy) {
  const T ux = x2 - x1;
  const T uy = y2 - y1;
  const T uz = z2 - z1;
...
inline T vertical_mirror(const T& angle) {
  if (is_equal(angle, T(0.0)) || is_equal(angle, T(180.0)) ||
...
template <typename T>
inline T vertex_angle(const T& x1, const T& y1, const T& x2, const T& y2,
...
template <typename T>
inline T vertex_angle(const point2d<T>& point1, const point2d<T>& point2,
                      const point2d<T>& point3) {
  return vertex_angle(point1.x, point1.y, point2.x, point2.y, point3.x,
                      point3.y);
}

template <typename T>
inline T vertex_angle(const T& x1, const T& y1, const T& z1, const T& x2,
                      const T& y2, const T& z2, const T& x3, const T& y3,
                      const T& z3) {
  /*
  ...
  */
  ...
  const T dist =
      (x1_ * x1_ + y1_ * y1_ + z1_ * z1_) * (x3_ * x3_ + y3_ * y3_ + z3_ * z3_);

  if (is_equal(dist, T(0.0)))
    return T(0.0);
  else
    return T(acos((x1_ * x3_ + y1_ * y3_ + z1_ * z3_) / sqrt(dist)) *
             _180DivPI);
}

template <typename T>
inline T vertex_angle(const point3d<T>& point1, const point3d<T>& point2,
                      const point3d<T>& point3) {
  return vertex_angle(point1.x, point1.y, point1.z, point2.x, point2.y,
                      point2.z, point3.x, point3.y, point3.z);
}

template <typename T>
inline T oriented_vertex_angle(const T& x1, const T& y1, const T& x2,
                               const T& y2, const T& x3, const T& y3,
                               const int orient) {
...
inline T oriented_vertex_angle(const point2d<T>& point1,
                               const point2d<T>& point2,
                               const point2d<T>& point3, const int orient) {
  return oriented_vertex_angle(point1.x, point1.y, point2.x, point2.y, point3.x,
                               point3.y, orient);
}
...
template <typename T>
inline T robust_cartesian_angle(const T& x, const T& y, const T& ox,
                                const T& oy) {
...
template <typename T>
inline bool parallel(const T& x1, const T& y1, const T& x2, const T& y2,
                     const T& x3, const T& y3, const T& x4, const T& y4,
                     const T& epsilon) {
...
template <typename T>
inline bool parallel(const point2d<T>& point1, const point2d<T>& point2,
                     const point2d<T>& point3, const point2d<T>& point4,
                     const T& epsilon) {
  return parallel(point1.x, point1.y, point2.x, point2.y, point3.x, point3.y,
                  point4.x, point4.y, epsilon);
}

template <typename T>
inline bool parallel(const segment<T, 2>& segment1,
                     const segment<T, 2>& segment2, const T& epsilon) {
  return parallel(segment1[0], segment1[1], segment2[0], segment2[1], epsilon);
}

template <typename T>
inline bool parallel(const line<T, 2>& line1, const line<T, 2>& line2,
                     const T& epsilon) {
  return parallel(line1[0], line1[1], line2[0], line2[1], epsilon);
}

template <typename T>
inline bool parallel(const T& x1, const T& y1, const T& z1, const T& x2,
                     const T& y2, const T& z2, const T& x3, const T& y3,
                     const T& z3, const T& x4, const T& y4, const T& z4,
                     const T& epsilon) {
  /*
...
template <typename T>
inline bool parallel(const point3d<T>& point1, const point3d<T>& point2,
                     const point3d<T>& point3, const point3d<T>& point4,
                     const T& epsilon) {
  return parallel(point1.x, point1.y, point1.z, point2.x, point2.y, point2.z,
                  point3.x, point3.y, point3.z, point4.x, point4.y, point4.z,
                  epsilon);
}
...
inline bool parallel(const segment<T, 3>& segment1,
                     const segment<T, 3>& segment2, const T& epsilon) {
  return parallel(segment1[0], segment1[1], segment2[0], segment2[1], epsilon);
}

template <typename T>
inline bool parallel(const line<T, 3>& line1, const line<T, 3>& line2,
                     const T& epsilon) {
  return parallel(line1[0], line1[1], line2[0], line2[1], epsilon);
}

template <typename T>
inline bool robust_parallel(const T& x1, const T& y1, const T& x2, const T& y2,
                            const T& x3, const T& y3, const T& x4, const T& y4,
                            const T& epsilon) {
  T px1 = T(0.0);
  T py1 = T(0.0);
  ...
  return is_equal(distance(x3, y3, px1, py1), distance(x4, y4, px2, py2),
                  epsilon);
}

template <typename T>
inline bool robust_parallel(const point2d<T>& point1, const point2d<T>& point2,
                            const point2d<T>& point3, const point2d<T>& point4,
                            const T& epsilon) {
  return robust_parallel(point1.x, point1.y, point2.x, point2.y, point3.x,
                         point3.y, point4.x, point4.y, epsilon);
}

template <typename T>
inline bool robust_parallel(const segment<T, 2>& segment1,
                            const segment<T, 2>& segment2, const T& epsilon) {
  return robust_parallel(segment1[0], segment1[1], segment2[0], segment2[1],
                         epsilon);
}

template <typename T>
inline bool robust_parallel(const line<T, 2>& line1, const line<T, 2>& line2,
                            const T& epsilon) {
  return robust_parallel(line1[0], line1[1], line2[0], line2[1], epsilon);
}

template <typename T>
inline bool robust_parallel(const line<T, 2>& line,
                            const segment<T, 2>& segment, const T& epsilon) {
  return robust_parallel(line[0], line[1], segment[0], segment[1], epsilon);
}

template <typename T>
inline bool robust_parallel(const T& x1, const T& y1, const T& z1, const T& x2,
                            const T& y2, const T& z2, const T& x3, const T& y3,
                            const T& z3, const T& x4, const T& y4, const T& z4,
                            const T& epsilon) {
  T px1 = T(0.0);
  ...
  closest_point_on_line_from_point(x1, y1, z1, x2, y2, z2, x3, y3, z3, px1, py1,
                                   pz1);
  closest_point_on_line_from_point(x1, y1, z1, x2, y2, z2, x4, y4, z4, px2, py2,
                                   pz2);

  return is_equal(distance(x3, y3, z3, px1, py1, pz1),
                  distance(x4, y4, z4, px2, py2, pz2), epsilon);
}

template <typename T>
inline bool robust_parallel(const point3d<T>& point1, const point3d<T>& point2,
                            const point3d<T>& point3, const point3d<T>& point4,
                            const T& epsilon) {
  return robust_parallel(point1.x, point1.y, point1.z, point2.x, point2.y,
                         point2.z, point3.x, point3.y, point3.z, point4.x,
                         point4.y, point4.z, epsilon);
}
...
template <typename T>
inline bool robust_parallel(const line<T, 3>& line1, const line<T, 3>& line2,
                            const T& epsilon) {
  return robust_parallel(line1[0], line1[1], line2[0], line2[1], epsilon);
}
...
inline bool robust_parallel(const line<T, 3>& line,
                            const segment<T, 3>& segment, const T& epsilon) {
  return robust_parallel(line[0], line[1], segment[0], segment[1], epsilon);
}

template <typename T>
inline bool perpendicular(const T& x1, const T& y1, const T& x2, const T& y2,
                          const T& x3, const T& y3, const T& x4, const T& y4,
                          const T& epsilon) {
  return is_equal(T(-1.0) * (y2 - y1) * (y4 - y3), (x4 - x3) * (x2 - x1),
                  epsilon);
}

template <typename T>
inline bool perpendicular(const point2d<T>& point1, const point2d<T>& point2,
                          const point2d<T>& point3, const point2d<T>& point4,
                          const T& epsilon) {
  return perpendicular(point1.x, point1.y, point2.x, point2.y, point3.x,
                       point3.y, point4.x, point4.y, epsilon);
}
...
inline bool perpendicular(const segment<T, 2>& segment1,
                          const segment<T, 2>& segment2, const T& epsilon) {
  return perpendicular(segment1[0], segment1[1], segment2[0], segment2[1],
                       epsilon);
}

template <typename T>
inline bool perpendicular(const line<T, 2>& line1, const line<T, 2>& line2,
                          const T& epsilon) {
  return perpendicular(line1[0], line1[1], line2[0], line2[1], epsilon);
}

template <typename T>
inline bool perpendicular(const line<T, 2>& line, const segment<T, 2>& segment,
                          const T& epsilon) {
  return perpendicular(line[0], line[1], segment[0], segment[1], epsilon);
}

template <typename T>
inline bool perpendicular(const T& x1, const T& y1, const T& z1, const T& x2,
                          const T& y2, const T& z2, const T& x3, const T& y3,
                          const T& z3, const T& x4, const T& y4, const T& z4,
                          const T& epsilon) {
  /*
...
template <typename T>
inline bool perpendicular(const point3d<T>& point1, const point3d<T>& point2,
                          const point3d<T>& point3, const point3d<T>& point4,
                          const T& epsilon) {
  return perpendicular(point1.x, point1.y, point1.z, point2.x, point2.y,
                       point2.z, point3.x, point3.y, point3.z, point4.x,
                       point4.y, point4.z, epsilon);
}
...
template <typename T>
inline bool perpendicular(const line<T, 3>& line1, const line<T, 3>& line2,
                          const T& epsilon) {
  return perpendicular(line1[0], line1[1], line2[0], line2[1], epsilon);
}

template <typename T>
inline bool robust_perpendicular(const T& x1, const T& y1, const T& x2,
                                 const T& y2, const T& x3, const T& y3,
                                 const T& x4, const T& y4, const T& epsilon) {
  T p1x = T(0.0);
  T p1y = T(0.0);
  T p2x = T(0.0);
  T p2y = T(0.0);
...
inline bool robust_perpendicular(const point2d<T>& point1,
                                 const point2d<T>& point2,
                                 const point2d<T>& point3,
                                 const point2d<T>& point4, const T& epsilon) {
  return robust_perpendicular(point1.x, point1.y, point2.x, point2.y, point3.x,
                              point3.y, point4.x, point4.y, epsilon);
}
...
inline bool robust_perpendicular(const segment<T, 2>& segment1,
                                 const segment<T, 2>& segment2,
                                 const T& epsilon) {
  return robust_perpendicular(segment1[0], segment1[1], segment2[0],
                              segment2[1], epsilon);
}

template <typename T>
inline bool robust_perpendicular(const line<T, 2>& line1,
                                 const line<T, 2>& line2, const T& epsilon) {
  return robust_perpendicular(line1[0], line1[1], line2[0], line2[1], epsilon);
}
...
inline bool robust_perpendicular(const line<T, 2>& line,
                                 ...
                                 const T& epsilon) {
  return robust_perpendicular(line[0], line[1], segment[0], segment[1],
                              epsilon);
}
...
inline bool robust_perpendicular(const T& x1, const T& y1, const T& z1,
  ...
  closest_point_on_line_from_point(x1, y1, z1, x2, y2, z2, x3, y3, z3, p1x, p1y,
                                   p1z);
  closest_point_on_line_from_point(x1, y1, z1, x2, y2, z2, x4, y4, z4, p2x, p2y,
                                   p2z);
...
inline bool robust_perpendicular(const point3d<T>& point1,
                                 const point3d<T>& point2,
                                 const point3d<T>& point3,
                                 const point3d<T>& point4, const T& epsilon) {
  return robust_perpendicular(point1.x, point1.y, point1.z, point2.x, point2.y,
                              point2.z, point3.x, point3.y, point3.z, point4.x,
                              point4.y, point4.z, epsilon);
}
...
inline bool robust_perpendicular(const line<T, 3>& line1,
                                 const line<T, 3>& line2, const T& epsilon) {
  return robust_perpendicular(line1[0], line1[1], line2[0], line2[1], epsilon);
}

template <typename T>
inline bool line_to_line_intersect(const T& x1, const T& y1, const T& x2,
                                   const T& y2, const T& x3, const T& y3,
...
template <typename T>
inline bool line_to_line_intersect(const line<T, 2>& line1,
                                   const line<T, 2>& line2) {
...
inline bool box_to_box_intersect(const T& x1, const T& y1, const T& z1,
                                 ...
                                 const T& x3, const T& y3, const T& z3,
                                 const T& x4, const T& y4, const T& z4) {
  return ((x1 <= x4) && (x2 >= x3) && (y1 <= y4) && (y2 >= y3) && (z1 <= z4) &&
          (z2 >= z3));
}

template <typename T>
inline bool box_to_box_intersect(const box<T, 3>& box1, const box<T, 3>& box2) {
  return box_to_box_intersect(box1[0].x, box1[0].y, box1[0].z, box1[1].x,
                              box1[1].y, box1[1].z, box2[0].x, box2[0].y,
                              box2[0].z, box2[1].x, box2[1].y, box2[1].z);
}
...
template <typename T, unsigned int Dimension, typename Bezier,
          typename Iterator>
inline bool simplex_to_bezier_intersect(const Iterator& begin,
  ...
  for (std::size_t i = 1; i < steps; ++i) {
    ...
    wykobi::segment<T, Dimension> segment =
        make_segment(previous_point, current_point);
...
template <typename T>
inline bool rectangle_within_rectangle(const T& x1, const T& y1, const T& x2,
                                       const T& y2, const T& x3, const T& y3,
                                       const T& x4, const T& y4) {
...
template <typename T>
inline bool box_within_box(const T& x1, const T& y1, const T& z1, const T& x2,
                           const T& y2, const T& z2, const T& x3, const T& y3,
                           const T& z3, const T& x4, const T& y4, const T& z4) {
...
inline bool box_within_box(const box<T, 3>& box1, const box<T, 3>& box2) {
  return box_within_box(box1[0].x, box1[0].y, box1[0].z, box1[1].x, box1[1].y,
                        box1[1].z, box2[0].x, box2[0].y, box2[0].z, box2[1].x,
                        box2[1].y, box2[1].z);
}
...
inline bool circle_within_rectangle(const T& x, const T& y, const T& radius,
                                    ...
                                    const T& y2) {
  return rectangle_within_rectangle(aabb(make_circle(x, y, radius)),
                                    make_rectangle(x1, y1, x2, y2));
}

template <typename T>
inline bool circle_within_rectangle(const circle<T>& circle,
                                    const rectangle<T>& rectangle) {
  return circle_within_rectangle(circle.x, circle.y, circle.radius,
                                 rectangle[0].x, rectangle[0].y, rectangle[1].x,
                                 rectangle[1].y);
}

template <typename T>
inline bool triangle_within_rectangle(const T& x1, const T& y1, const T& x2,
                                      const T& y2, const T& x3, const T& y3,
                                      const T& x4, const T& y4, const T& x5,
                                      const T& y5) {
...
template <typename T>
inline bool triangle_within_rectangle(const triangle<T, 2>& triangle,
                                      const rectangle<T>& rectangle) {
  return triangle_within_rectangle(triangle[0].x, triangle[0].y, triangle[1].x,
...
template <typename T>
inline bool segment_within_rectangle(const T& x1, const T& y1, const T& x2,
                                     const T& y2, const T& x3, const T& y3,
                                     const T& x4, const T& y4) {
  return point_in_rectangle(x1, y1, x3, y3, x4, y4) &&
         point_in_rectangle(x2, y2, x3, y3, x4, y4);
...
template <typename T>
inline bool segment_within_rectangle(const segment<T, 2>& segment,
                                     const rectangle<T>& rectangle) {
  return segment_within_rectangle(segment[0].x, segment[0].y, segment[1].x,
                                  segment[1].y, rectangle[0].x, rectangle[0].y,
                                  rectangle[1].x, rectangle[1].y);
}

template <typename T>
inline bool quadix_within_rectangle(const T& x1, const T& y1, const T& x2,
                                    const T& y2, const T& x3, const T& y3,
                                    const T& x4, const T& y4, const T& x5,
                                    const T& y5, const T& x6, const T& y6) {
...
template <typename T>
inline bool quadix_within_rectangle(const quadix<T, 2>& quadix,
                                    const rectangle<T>& rectangle) {
  return quadix_within_rectangle(
      quadix[0].x, quadix[0].y, quadix[1].x, quadix[1].y, quadix[2].x,
      quadix[2].y, quadix[3].x, quadix[3].y, rectangle[0].x, rectangle[0].y,
      rectangle[1].x, rectangle[1].y);
}

template <typename T>
inline bool polygon_within_rectangle(const polygon<T, 2>& polygon,
                                     const rectangle<T>& rectangle) {
  for (std::size_t i = 0; i < polygon.size(); ++i) {
...
template <typename T>
inline bool sphere_within_box(const T& x, const T& y, const T& z,
                              const T& radius, const T& x1, const T& y1,
                              const T& z1, const T& x2, const T& y2,
                              const T& z2) {
  return box_within_box(aabb(make_sphere(x, y, z, radius)),
...
inline bool sphere_within_box(const sphere<T>& sphere, const box<T, 3>& box) {
  return sphere_within_box(sphere.x, sphere.y, sphere.z, sphere.radius,
                           box[0].x, box[0].y, box[0].z, box[1].x, box[1].y,
                           box[1].z);
}
...
template <typename T>
inline bool triangle_within_box(const triangle<T, 3>& triangle,
                                const box<T, 3>& box) {
  return triangle_within_box(
      triangle[0].x, triangle[0].y, triangle[0].z, triangle[1].x, triangle[1].y,
      triangle[1].z, triangle[2].x, triangle[2].y, triangle[2].z, box[0].x,
      box[0].y, box[0].z, box[1].x, box[1].y, box[1].z);
}
...
template <typename T>
inline bool segment_within_box(const segment<T, 3>& segment,
                               const box<T, 3>& box) {
  return segment_within_box(segment[0].x, segment[0].y, segment[0].z,
                            segment[1].x, segment[1].y, segment[1].z, box[0].x,
                            box[0].y, box[0].z, box[1].x, box[1].y, box[1].z);
}
...
template <typename T>
inline bool quadix_within_box(const quadix<T, 3>& quadix,
                              const box<T, 3>& box) {
  return quadix_within_box(quadix[0].x, quadix[0].y, quadix[0].z, quadix[1].x,
                           quadix[1].y, quadix[1].z, quadix[2].x, quadix[2].y,
                           quadix[2].z, quadix[3].x, quadix[3].y, quadix[3].z,
                           box[0].x, box[0].y, box[0].z, box[1].x, box[1].y,
                           box[1].z);
}

template <typename T>
inline bool polygon_within_box(const polygon<T, 3>& polygon,
                               const box<T, 3>& box) {
  for (std::size_t i = 0; i < polygon.size(); ++i) {
...
template <typename T>
inline bool circle_in_circle(const circle<T>& circle1,
                             const circle<T>& circle2) {
  return greater_than_or_equal(
      circle2.radius - (distance(circle1.x, circle1.y, circle2.x, circle2.y) +
                        circle1.radius),
      T(0.0));
}
...
inline bool is_tangent(const segment<T, 2>& segment, const circle<T>& circle) {
  ...
  const T dsqr = wykobi::sqr(tmp_segment[0].x * tmp_segment[1].y -
                             tmp_segment[1].x * tmp_segment[0].y);

  return is_equal((rsqr * drsqr - dsqr), T(0.0));
}

template <typename T>
inline bool point_of_reflection(const T& sx1, const T& sy1, const T& sx2,
                                const T& sy2, const T& p1x, const T& p1y,
                                const T& p2x, const T& p2y, T& rpx, T& rpy) {
  if ((!collinear(sx1, sy1, sx2, sy2, p1x, p1y)) &&
...
inline bool point_of_reflection(const segment<T, 2>& segment,
  ...
  return point_of_reflection(segment[0].x, segment[0].y, segment[1].x,
                             segment[1].y, point1.x, point1.y, point2.x,
                             point2.y, reflection_point.x, reflection_point.y);
}

template <typename T>
inline segment<T, 2> edge(const triangle<T, 2>& triangle,
...
template <typename T>
inline segment<T, 3> edge(const triangle<T, 3>& triangle,
                          const std::size_t& edge_index) {
  switch (edge_index) {
    case 0:
      return make_segment(triangle[0], triangle[1]);
...
template <typename T>
inline segment<T, 2> edge(const quadix<T, 2>& quadix,
                          const std::size_t& edge_index) {
  switch (edge_index) {
    case 0:
...
template <typename T>
inline segment<T, 3> edge(const quadix<T, 3>& quadix,
                          const std::size_t& edge_index) {
  switch (edge_index) {
    case 0:
      return make_segment(quadix[0], quadix[1]);
...
template <typename T>
inline segment<T, 2> edge(const rectangle<T>& rectangle,
                          const std::size_t& edge_index) {
  switch (edge_index) {
    case 0:
      return make_segment(rectangle[0].x, rectangle[0].y, rectangle[1].x,
                          rectangle[0].y);
    case 1:
      return make_segment(rectangle[1].x, rectangle[0].y, rectangle[1].x,
                          rectangle[1].y);
    case 2:
      return make_segment(rectangle[1].x, rectangle[1].y, rectangle[0].x,
                          rectangle[1].y);
    case 3:
      return make_segment(rectangle[0].x, rectangle[1].y, rectangle[0].x,
                          rectangle[0].y);
    default:
      return degenerate_segment2d<T>();
  }
...
template <typename T>
inline segment<T, 2> edge(const polygon<T, 2>& polygon,
                          const std::size_t& edge_index) {
...
template <typename T>
inline segment<T, 3> edge(const polygon<T, 3>& polygon,
                          const std::size_t& edge_index) {
  if (edge_index >= polygon.size())
...
template <typename T>
inline segment<T, 2> opposing_edge(const triangle<T, 2>& triangle,
...
template <typename T>
inline segment<T, 3> opposing_edge(const triangle<T, 3>& triangle,
                                   const std::size_t& corner) {
  switch (corner) {
    case 0:
      return edge(triangle, 1);
...
template <typename T>
inline point2d<T> rectangle_corner(const rectangle<T>& rectangle,
...
template <typename T>
inline point3d<T> box_corner(const box<T, 3>& box,
                             const std::size_t& corner_index) {
  switch (corner_index) {
    case 0:
      return box[0];
...
template <typename T>
inline line<T, 2> triangle_bisector(const triangle<T, 2>& triangle,
...
template <typename T>
inline line<T, 3> triangle_bisector(const triangle<T, 3>& triangle,
                                    const std::size_t& bisector) {
  switch (bisector) {
    case 0:
      return create_line_from_bisector(triangle[2], triangle[0], triangle[1]);
...
template <typename T>
inline line<T, 2> triangle_external_bisector(
    const triangle<T, 2>& triangle, const std::size_t& corner,
    const std::size_t& opposing_corner) {
  return create_line_from_bisector(
      project_point_t(triangle[corner], triangle[opposing_corner], T(2.0)),
      triangle[opposing_corner], triangle[(opposing_corner + 1) % 3]);
}

template <typename T>
inline line<T, 3> triangle_external_bisector(
    const triangle<T, 3>& triangle, const std::size_t& corner,
    const std::size_t& opposing_corner) {
  return create_line_from_bisector(
      project_point_t(triangle[corner], triangle[opposing_corner], T(2.0)),
      triangle[opposing_corner], triangle[(opposing_corner + 1) % 3]);
...
template <typename T>
inline line<T, 2> triangle_median(const triangle<T, 2>& triangle,
                                  const std::size_t& median) {
  switch (median) {
    case 0:
      return make_line(triangle[0],
                       segment_mid_point(triangle[1], triangle[2]));
    case 1:
      return make_line(triangle[1],
                       segment_mid_point(triangle[0], triangle[2]));
    case 2:
      return make_line(triangle[2],
...
template <typename T>
inline line<T, 3> triangle_median(const triangle<T, 3>& triangle,
                                  const std::size_t& median) {
  switch (median) {
    case 0:
      return make_line(triangle[0],
...
template <typename T>
inline line<T, 2> triangle_symmedian(const triangle<T, 2>& triangle,
                                     const std::size_t& symmedian) {
  if (symmedian < 3)
    return mirror(triangle_median(triangle, symmedian),
                  triangle_bisector(triangle, symmedian));
  else
    return degenerate_line2d<T>();
}

template <typename T>
inline line<T, 3> triangle_symmedian(const triangle<T, 3>& triangle,
                                     const std::size_t& symmedian) {
  if (symmedian < 3)
    return mirror(triangle_median(triangle, symmedian),
                  triangle_bisector(triangle, symmedian));
...
template <typename T>
inline point2d<T> exmedian_point(const triangle<T, 2>& triangle,
                                 const std::size_t& corner) {
  line<T, 2> line1 = create_parallel_line_on_point(
      make_line(triangle[corner], triangle[(corner + 1) % 3]),
      triangle[(corner + 2) % 3]);
  line<T, 2> line2 = create_parallel_line_on_point(
      make_line(triangle[corner], triangle[(corner + 2) % 3]),
      triangle[(corner + 1) % 3]);
...
template <typename T>
inline point3d<T> exmedian_point(const triangle<T, 3>& triangle,
                                 const std::size_t& corner) {
  line<T, 3> line1 = create_parallel_line_on_point(
      make_line(triangle[corner], triangle[(corner + 1) % 3]),
      triangle[(corner + 2) % 3]);
  line<T, 3> line2 = create_parallel_line_on_point(
      make_line(triangle[corner], triangle[(corner + 2) % 3]),
      triangle[(corner + 1) % 3]);
...
inline point2d<T> feuerbach_point(const triangle<T, 2>& triangle) {
  ...
  intersection_point(inscribed_circle(triangle), nine_point_circle(triangle),
                     ipoint1, ipoint2);
...
template <typename T>
inline line<T, 2> confined_triangle_median(const triangle<T, 2>& triangle,
  ...
  switch (median) {
    case 0:
      return make_line(
          triangle[0],
          intersection_point(edge(triangle, 1), make_line(triangle[0], point)));
    case 1:
      return make_line(
          triangle[1],
          intersection_point(edge(triangle, 2), make_line(triangle[1], point)));
    case 2:
      return make_line(
          triangle[2],
          intersection_point(edge(triangle, 0), make_line(triangle[2], point)));
    default:
      return degenerate_line2d<T>();
  }
}
...
template <typename T>
inline line<T, 3> confined_triangle_median(const triangle<T, 3>& triangle,
                                           const point3d<T>& point,
                                           const std::size_t& median) {
  switch (median) {
    case 0:
...
template <typename T>
inline line<T, 2> create_parallel_line_on_point(const line<T, 2>& line,
                                                const point2d<T>& point) {
  return make_line(point, point + (line[1] - line[0]));
}

template <typename T>
inline line<T, 3> create_parallel_line_on_point(const line<T, 3>& line,
                                                const point3d<T>& point) {
  return make_line(point, point + (line[1] - line[0]));
}

template <typename T>
inline segment<T, 2> create_parallel_segment_on_point(const line<T, 2>& line,
                                                      const point2d<T>& point) {
  return make_segment(point, point + (line[1] - line[0]));
}

template <typename T>
inline segment<T, 3> create_parallel_segment_on_point(const line<T, 3>& line,
                                                      const point3d<T>& point) {
  return make_segment(point, point + (line[1] - line[0]));
}

template <typename T>
inline bool point_in_rectangle(const T& px, const T& py, const T& x1,
                               const T& y1, const T& x2, const T& y2) {
  return ((x1 <= px) && (px <= x2) && (y1 <= py) && (py <= y2)) ||
         ((x2 <= px) && (px <= x1) && (y2 <= py) && (py <= y1));
}

template <typename T>
inline bool point_in_rectangle(const point2d<T>& point, const T& x1,
                               const T& y1, const T& x2, const T& y2) {
...
inline bool point_in_rectangle(const T& px, const T& py,
                               const rectangle<T>& rectangle) {
  return point_in_rectangle(px, py, rectangle[0].x, rectangle[0].y,
                            rectangle[1].x, rectangle[1].y);
}
...
inline bool point_in_rectangle(const point2d<T>& point,
  ...
  return point_in_rectangle(point.x, point.y, rect_point1.x, rect_point1.y,
                            rect_point2.x, rect_point2.y);
}

template <typename T>
inline bool point_in_rectangle(const point2d<T>& point,
                               const segment<T, 2>& segment) {
  return point_in_rectangle(point.x, point.y, segment[0].x, segment[0].y,
                            segment[1].x, segment[1].y);
}

template <typename T>
inline bool point_in_box(const T& px, const T& py, const T& pz, const T& x1,
                         const T& y1, const T& z1, const T& x2, const T& y2,
                         const T& z2) {
  return ((x1 <= px) && (px <= x2) && (y1 <= py) && (py <= y2) && (z1 <= pz) &&
          (pz <= z2)) ||
         ((x2 <= px) && (px <= x1) && (y2 <= py) && (py <= y1) && (z2 <= pz) &&
          (pz <= z1));
}

template <typename T>
inline bool point_in_box(const point3d<T>& point, const T& x1, const T& y1,
...
inline bool point_in_box(const T& px, const T& py, const T& pz,
                         const box<T, 3>& box) {
  return point_in_box(px, py, pz, box[0].x, box[0].y, box[0].z, box[1].x,
                      box[1].y, box[1].z);
}
...
template <typename T>
inline bool point_in_box(const point3d<T>& point, const point3d<T>& box_point1,
                         const point3d<T>& box_point2) {
  return point_in_box(point.x, point.y, point.z, box_point1.x, box_point1.y,
                      box_point1.z, box_point2.x, box_point2.y, box_point2.z);
}
...
template <typename T>
inline bool point_in_triangle(const T& px, const T& py, const T& x1,
                              const T& y1, const T& x2, const T& y2,
                              const T& x3, const T& y3) {
...
inline bool point_in_triangle(const T& px, const T& py,
                              const triangle<T, 2>& triangle) {
  return point_in_triangle(px, py, triangle[0].x, triangle[0].y, triangle[1].x,
                           triangle[1].y, triangle[2].x, triangle[2].y);
}

template <typename T>
inline bool point_in_triangle(const point2d<T>& point, const point2d<T>& point1,
                              const point2d<T>& point2,
                              const point2d<T>& point3) {
  return point_in_triangle(point.x, point.y, point1.x, point1.y, point2.x,
...
inline bool point_in_triangle(const point2d<T>& point,
                              const triangle<T, 2>& triangle) {
  return point_in_triangle(point.x, point.y, triangle[0].x, triangle[0].y,
                           triangle[1].x, triangle[1].y, triangle[2].x,
                           triangle[2].y);
}

template <typename T>
inline bool point_in_quadix(const T& px, const T& py, const T& x1, const T& y1,
                            const T& x2, const T& y2, const T& x3, const T& y3,
                            const T& x4, const T& y4) {
  const int or1 = orientation(x1, y1, x2, y2, px, py);
  const int or2 = orientation(x2, y2, x3, y3, px, py);
...
template <typename T>
inline bool point_in_quadix(const point2d<T>& point, const point2d<T>& point1,
                            const point2d<T>& point2, const point2d<T>& point3,
                            const point2d<T>& point4) {
  return point_in_quadix(point.x, point.y, point1.x, point1.y, point2.x,
...
inline bool point_in_quadix(const T& px, const T& py,
                            const quadix<T, 2>& quadix) {
  return point_in_quadix(px, py, quadix[0].x, quadix[0].y, quadix[1].x,
                         quadix[1].y, quadix[2].x, quadix[2].y, quadix[3].x,
                         quadix[3].y);
}
...
template <typename T>
inline bool point_in_circle(const T& px, const T& py, const T& cx, const T& cy,
                            const T& radius) {
...
template <typename T>
inline bool point_in_sphere(const T& px, const T& py, const T& pz, const T& cx,
                            const T& cy, const T& cz, const T& radius) {
  return less_than_or_equal(lay_distance(px, py, pz, cx, cy, cz),
                            radius * radius);
}

template <typename T>
inline bool point_in_sphere(const T& px, const T& py, const T& pz,
                            const sphere<T>& sphere) {
  return point_in_sphere(px, py, pz, sphere.x, sphere.y, sphere.z,
                         sphere.radius);
}
...
template <typename T>
inline bool point_in_three_point_circle(const T& px, const T& py, const T& x1,
                                        const T& y1, const T& x2, const T& y2,
                                        const T& x3, const T& y3) {
  const T dx1 = x1 - px;
  const T dx2 = x2 - px;
...
inline bool point_in_three_point_circle(const point2d<T>& point,
                                        ...
                                        const point2d<T>& point2,
                                        const point2d<T>& point3) {
  return point_in_three_point_circle(point.x, point.y, point1.x, point1.y,
...
inline bool point_in_three_point_circle(const point2d<T>& point,
                                        const triangle<T, 2> triangle) {
  return point_in_three_point_circle(point, triangle[0], triangle[1],
                                     triangle[2]);
}

template <typename T>
inline bool point_in_focus_area(const T& px, const T& py, const T& x1,
                                const T& y1, const T& x2, const T& y2,
                                const T& x3, const T& y3) {
  return (
      -1 ==
      (orientation((x2 + x3) * T(0.5), (y2 + y3) * T(0.5), x1, y1, px, py) *
...
inline bool point_in_focus_area(const point2d<T>& point,
                                ...
                                const point2d<T>& point2,
                                const point2d<T>& point3) {
  return point_in_focus_area(point.x, point.y, point1.x, point1.y, point2.x,
                             point2.y, point3.x, point3.y);
}

template <typename T>
inline bool point_on_segment(const point2d<T>& point,
                             const segment<T, 2>& segment) {
  return is_point_collinear(segment, point, true);
}

template <typename T>
inline bool point_on_segment(const point3d<T>& point,
                             const segment<T, 3>& segment) {
  return is_point_collinear(segment, point, true);
}

template <typename T>
inline bool point_on_ray(const T& px, const T& py, const T& ox, const T& oy,
                         const T& dx, const T& dy) {
  return point_on_ray(make_point(px, py), make_ray(ox, oy, dx, dy));
}

template <typename T>
inline bool point_on_ray(const T& px, const T& py, const T& pz, const T& ox,
                         const T& oy, const T& oz, const T& dx, const T& dy,
                         const T& dz) {
...
template <typename T>
inline bool point_on_rectangle(const T& px, const T& py, const T& x1,
                               const T& y1, const T& x2, const T& y2) {
...
template <typename T>
inline bool point_on_rectangle(const point2d<T>& point, const T& x1,
                               const T& y1, const T& x2, const T& y2) {
...
inline bool point_on_rectangle(const T& px, const T& py,
                               const rectangle<T>& rectangle) {
  return point_on_rectangle(px, py, rectangle[0].x, rectangle[0].y,
                            rectangle[1].x, rectangle[1].y);
}
...
template <typename T>
inline bool point_on_triangle(const T& px, const T& py, const T& x1,
                              const T& y1, const T& x2, const T& y2,
                              const T& x3, const T& y3) {
...
inline bool point_on_triangle(const T& px, const T& py,
                              const triangle<T, 2>& triangle) {
  return point_on_triangle(px, py, triangle[0].x, triangle[0].y, triangle[1].x,
                           triangle[1].y, triangle[2].x, triangle[2].y);
}

template <typename T>
inline bool point_on_triangle(const point2d<T>& point, const point2d<T>& point1,
                              const point2d<T>& point2,
                              const point2d<T>& point3) {
  return point_on_triangle(point.x, point.y, point1.x, point1.y, point2.x,
                           point2.y, point3.x, point3.y);
}
...
inline bool point_on_triangle(const point2d<T>& point,
                              const triangle<T, 2>& triangle) {
  return point_on_triangle(point.x, point.y, triangle[0].x, triangle[0].y,
                           triangle[1].x, triangle[1].y, triangle[2].x,
                           triangle[2].y);
}

template <typename T>
inline bool point_on_quadix(const T& px, const T& py, const T& x1, const T& y1,
                            const T& x2, const T& y2, const T& x3, const T& y3,
                            const T& x4, const T& y4) {
  return is_point_collinear(x1, y1, x2, y2, px, py, true) ||
         is_point_collinear(x2, y2, x3, y3, px, py, true) ||
...
template <typename T>
inline bool point_on_quadix(const point2d<T>& point, const point2d<T>& point1,
                            const point2d<T>& point2, const point2d<T>& point3,
                            const point2d<T>& point4) {
  return point_on_quadix(point.x, point.y, point1.x, point1.y, point2.x,
                         point2.y, point3.x, point3.y, point4.x, point4.y);
}
...
inline bool point_on_quadix(const T& px, const T& py,
                            const quadix<T, 2>& quadix) {
  return point_on_quadix(px, py, quadix[0].x, quadix[0].y, quadix[1].x,
                         quadix[1].y, quadix[2].x, quadix[2].y, quadix[3].x,
                         quadix[3].y);
}
...
template <typename T>
inline bool point_on_circle(const T& px, const T& py, const T& cx, const T& cy,
                            const T& radius) {
  return (lay_distance(px, py, cx, cy) == (radius * radius));
}
...
template <typename T>
inline bool point_on_bezier(const point2d<T>& point,
                            const quadratic_bezier<T, 2>& bezier,
                            const std::size_t& steps, const T& fuzzy) {
  return (is_equal(
      distance(closest_point_on_bezier_from_point(bezier, point, steps), point),
      T(0.0), fuzzy));
}
...
template <typename T>
inline bool point_on_bezier(const point3d<T>& point,
                            const quadratic_bezier<T, 3>& bezier,
                            const std::size_t& steps, const T& fuzzy) {
  return (is_equal(
      distance(closest_point_on_bezier_from_point(bezier, point, steps), point),
...
template <typename T>
inline point2d<T> isogonal_conjugate(const point2d<T>& point,
                                     const triangle<T, 2>& triangle) {
  return intersection_point(
...
template <typename T>
inline point3d<T> isogonal_conjugate(const point3d<T>& point,
                                     const triangle<T, 3>& triangle) {
  return intersection_point(
      mirror(make_line(triangle[0], point), triangle_median(triangle, 0)),
      mirror(make_line(triangle[1], point), triangle_median(triangle, 1)));
...
template <typename T>
inline point2d<T> cyclocevian_conjugate(const point2d<T>& point,
                                        const triangle<T, 2>& triangle) {
  point2d<T> a_prime = intersection_point(make_line(triangle[0], point),
                                          make_line(edge(triangle, 1)));
  point2d<T> b_prime = intersection_point(make_line(triangle[1], point),
                                          make_line(edge(triangle, 2)));
  point2d<T> c_prime = intersection_point(make_line(triangle[2], point),
                                          make_line(edge(triangle, 0)));
...
template <typename T>
inline void create_equilateral_triangle(const T& x1, const T& y1, const T& x2,
                                        const T& y2, T& x3, T& y3) {
...
template <typename T>
inline triangle<T, 2> create_equilateral_triangle(const T& cx, const T& cy,
                                                  const T& side_length) {
  return center_at_location(
      create_equilateral_triangle(-side_length * T(0.5), T(0.0),
                                  side_length * T(0.5), T(0.0)),
      cx, cy);
}

template <typename T>
inline triangle<T, 2> create_equilateral_triangle(
    const point2d<T>& center_point, const T& side_length) {
  return create_equilateral_triangle(center_point.x, center_point.y,
                                     side_length);
}

template <typename T>
inline triangle<T, 2> create_isosceles_triangle(const point2d<T>& point1,
                                                const point2d<T>& point2,
                                                const T& angle) {
...
template <typename T>
inline triangle<T, 2> create_isosceles_triangle(const segment<T, 2>& segment,
                                                const T& angle) {
  return create_isosceles_triangle(segment[0], segment[1], angle);
}

template <typename T>
inline triangle<T, 2> create_triangle(const point2d<T>& point1,
                                      const point2d<T>& point2, const T& angle1,
                                      const T& angle2) {
...
template <typename T>
inline triangle<T, 2> create_triangle(const segment<T, 2>& segment,
                                      const T& angle1, const T& angle2) {
...
inline triangle<T, 2> create_morley_triangle(const triangle<T, 2>& triangle) {
  ...
  const wykobi::triangle<T, 2> triangle1 =
      create_triangle(edge(tri, 0), angle1, angle2);
  const wykobi::triangle<T, 2> triangle2 =
      create_triangle(edge(tri, 1), angle2, angle3);
  const wykobi::triangle<T, 2> triangle3 =
      create_triangle(edge(tri, 2), angle3, angle1);

  return make_triangle(triangle1[0], triangle2[0], triangle3[0]);
}

template <typename T>
inline triangle<T, 2> create_cevian_triangle(const triangle<T, 2>& triangle,
                                             const point2d<T>& point) {
...
template <typename T>
inline triangle<T, 3> create_cevian_triangle(const triangle<T, 3>& triangle,
                                             const point3d<T>& point) {
  return make_triangle(
      intersection_point(make_segment(triangle[0], point), edge(triangle, 1)),
      intersection_point(make_segment(triangle[1], point), edge(triangle, 2)),
...
template <typename T>
inline triangle<T, 2> create_anticevian_triangle(const triangle<T, 2>& triangle,
                                                 const point2d<T>& point) {
  ...
  for (std::size_t i = 0; i < 3; ++i) {
    ...
    {
      point_list[i] = wykobi::intersection_point(
          cevian_edge,
          make_line(orthic_edge[i], wykobi::mirror(point, opp_edge)));
    }
    // else
...
template <typename T>
inline triangle<T, 3> create_anticevian_triangle(const triangle<T, 3>& triangle,
                                                 const point3d<T>& point) {
  return make_triangle(
      intersection_point(
          make_line(triangle[0], point),
          make_line(closest_point_on_line_from_point(
                        make_line(opposing_edge(triangle, 0)), triangle[0]),
                    mirror(point, make_line(opposing_edge(triangle, 0))))),
      intersection_point(
          make_line(triangle[1], point),
          make_line(closest_point_on_line_from_point(
                        make_line(opposing_edge(triangle, 1)), triangle[1]),
                    mirror(point, make_line(opposing_edge(triangle, 1))))),
      intersection_point(
          make_line(triangle[2], point),
          make_line(closest_point_on_line_from_point(
                        make_line(opposing_edge(triangle, 2)), triangle[2]),
                    mirror(point, make_line(opposing_edge(triangle, 2))))));
}

template <typename T>
inline triangle<T, 2> create_anticomplementary_triangle(
    const triangle<T, 2>& triangle) {
  return make_triangle(exmedian_point(triangle, 0), exmedian_point(triangle, 1),
                       exmedian_point(triangle, 2));
}

template <typename T>
inline triangle<T, 3> create_anticomplementary_triangle(
    const triangle<T, 3>& triangle) {
  return make_triangle(exmedian_point(triangle, 0), exmedian_point(triangle, 1),
                       exmedian_point(triangle, 2));
}
...
template <typename T>
inline triangle<T, 2> create_inner_napoleon_triangle(
    const triangle<T, 2>& triangle) {
...
template <typename T>
inline triangle<T, 2> create_outer_napoleon_triangle(
    const triangle<T, 2>& triangle) {
  if (orientation(triangle) == RightHandSide) {
    return make_triangle(
        centroid(create_equilateral_triangle(triangle[0], triangle[1])),
...
template <typename T>
inline triangle<T, 2> create_inner_vecten_triangle(
    const triangle<T, 2>& triangle) {
  if (orientation(triangle) == RightHandSide) {
    return make_triangle(
        ...
        centroid(
            create_equilateral_quadix(reverse_segment(edge(triangle, 2)))));
  } else {
    return make_triangle(
...
template <typename T>
inline triangle<T, 2> create_outer_vecten_triangle(
    const triangle<T, 2>& triangle) {
  if (orientation(triangle) == RightHandSide) {
    return make_triangle(
        centroid(create_equilateral_quadix(edge(triangle, 0))),
...
template <typename T>
inline triangle<T, 2> create_symmedial_triangle(const triangle<T, 2>& triangle,
                                                const point2d<T>& point) {
...
inline triangle<T, 2> create_orthic_triangle(const triangle<T, 2>& triangle) {
  return make_triangle(closest_point_on_line_from_point(
                           make_line(edge(triangle, 0)), triangle[2]),
                       closest_point_on_line_from_point(
                           make_line(edge(triangle, 1)), triangle[0]),
                       closest_point_on_line_from_point(
                           make_line(edge(triangle, 2)), triangle[1]));
}
...
template <typename T>
inline triangle<T, 2> create_pedal_triangle(const point2d<T>& point,
                                            const triangle<T, 2>& triangle) {
  return make_triangle(
...
template <typename T>
inline triangle<T, 3> create_pedal_triangle(const point3d<T>& point,
                                            const triangle<T, 3>& triangle) {
  return make_triangle(
      closest_point_on_line_from_point(make_line(edge(triangle, 0)), point),
      closest_point_on_line_from_point(make_line(edge(triangle, 1)), point),
...
template <typename T>
inline triangle<T, 2> create_antipedal_triangle(
    const point2d<T>& point, const triangle<T, 2>& triangle) {
  typedef const line<T, 2> line_t;

  line_t line1 = create_perpendicular_line_at_end_point(make_line(
      point,
      closest_point_on_line_from_point(make_line(edge(triangle, 0)), point)));
  line_t line2 = create_perpendicular_line_at_end_point(make_line(
      point,
      closest_point_on_line_from_point(make_line(edge(triangle, 1)), point)));
  line_t line3 = create_perpendicular_line_at_end_point(make_line(
      point,
      closest_point_on_line_from_point(make_line(edge(triangle, 2)), point)));
...
template <typename T>
inline triangle<T, 2> create_excentral_triangle(
    const triangle<T, 2>& triangle) {
  return make_triangle(excenter(triangle, 0), excenter(triangle, 1),
                       excenter(triangle, 2));
}

template <typename T>
inline triangle<T, 3> create_excentral_triangle(
    const triangle<T, 3>& triangle) {
  return make_triangle(excenter(triangle, 0), excenter(triangle, 1),
                       excenter(triangle, 2));
}
...
template <typename T>
inline triangle<T, 2> create_incentral_triangle(
    const triangle<T, 2>& triangle) {
  return create_cevian_triangle(triangle, incenter(triangle));
}

template <typename T>
inline triangle<T, 3> create_incentral_triangle(
    const triangle<T, 3>& triangle) {
  return create_cevian_triangle(triangle, incenter(triangle));
}
...
inline triangle<T, 2> create_extouch_triangle(const triangle<T, 2>& triangle) {
  ...
  triangle_[0] = closest_point_on_segment_from_point(opposing_edge(triangle, 0),
                                                     triangle_[0]);
  triangle_[1] = closest_point_on_segment_from_point(opposing_edge(triangle, 1),
                                                     triangle_[1]);
  triangle_[2] = closest_point_on_segment_from_point(opposing_edge(triangle, 2),
                                                     triangle_[2]);
...
template <typename T>
inline triangle<T, 2> create_feuerbach_triangle(
    const triangle<T, 2>& triangle) {
  circle<T> circle = nine_point_circle(triangle);

  return make_triangle(
      project_point(make_point(circle), make_point(excircle(triangle, 0)),
                    circle.radius),
      project_point(make_point(circle), make_point(excircle(triangle, 1)),
                    circle.radius),
      project_point(make_point(circle), make_point(excircle(triangle, 2)),
                    circle.radius));
}

template <typename T>
inline triangle<T, 2> create_circumcevian_triangle(
    const triangle<T, 2>& triangle, const point2d<T>& point) {
  ...
  intersection_point(make_line(triangle[0], point), circum_circle,
  ...
  intersection_point(make_line(triangle[1], point), circum_circle,
                     std::back_inserter(ipoint));
  ...
  intersection_point(make_line(triangle[2], point), circum_circle,
                     std::back_inserter(ipoint));
...
template <typename T>
inline triangle<T, 2> create_circummedial_triangle(
    const triangle<T, 2>& triangle) {
  circle<T> circum_circle = make_circle(triangle);
  ...
  intersection_point(make_line(triangle[0], point_), circum_circle,
                     std::back_inserter(ipoint));
  ...
  intersection_point(make_line(triangle[1], point_), circum_circle,
                     std::back_inserter(ipoint));
  ...
  intersection_point(make_line(triangle[2], point_), circum_circle,
                     std::back_inserter(ipoint));
...
template <typename T>
inline triangle<T, 2> create_first_brocard_triangle(
    const triangle<T, 2>& triangle) {
  ...
  for (std::size_t i = 0; i < 3; ++i) {
    ...
    intersection_point(make_segment(o, closest_point), circle,
...
template <typename T>
inline void create_right_triangle(const wykobi::point2d<T>& p1,
  ...
  const wykobi::vector2d<T> v =
      wykobi::normalize(wykobi::perpendicular(p1 - p2)) * (distance / T(2.0));
...
template <typename T>
inline void create_equilateral_quadix(const T& x1, const T& y1, const T& x2,
                                      const T& y2, T& x3, T& y3, T& x4, T& y4) {
  const T tx = x2 - x1;
  const T ty = y2 - y1;
...
inline void create_equilateral_quadix(const point2d<T>& point1,
                                      const point2d<T>& point2,
                                      point2d<T>& point3, point2d<T>& point4) {
...
inline quadix<T, 2> create_equilateral_quadix(const T& x1, const T& y1,
  ...
  create_equilateral_quadix(x1, y1, x2, y2, quadix_[2].x, quadix_[2].y,
                            quadix_[3].x, quadix_[3].y);
...
template <typename T>
inline quadix<T, 2> create_equilateral_quadix(const T& cx, const T& cy,
                                              const T& side_length) {
  return center_at_location(
      create_equilateral_quadix(-side_length * T(0.5), T(0.0),
                                side_length * T(0.5), T(0.0)),
      cx, cy);
}

template <typename T>
inline quadix<T, 2> create_equilateral_quadix(const point2d<T>& center_point,
                                              const T& side_length) {
  return create_equilateral_quadix(center_point.x, center_point.y, side_length);
}

template <typename T>
inline void torricelli_point(const T& x1, const T& y1, const T& x2, const T& y2,
                             const T& x3, const T& y3, T& px, T& py) {
  /*
  ...
  */
  if (greater_than_or_equal(vertex_angle(x1, y1, x2, y2, x3, y3), T(120.0))) {
    ...
    return;
  } else if (greater_than_or_equal(vertex_angle(x3, y3, x1, y1, x2, y2),
                                   T(120.0))) {
    px = x1;
    py = y1;

    return;
  } else if (greater_than_or_equal(vertex_angle(x2, y2, x3, y3, x1, y1),
                                   T(120.0))) {
    px = x3;
    py = y3;
...
inline point2d<T> torricelli_point(const point2d<T>& point1,
  ...
  torricelli_point(point1.x, point1.y, point2.x, point2.y, point3.x, point3.y,
                   point_.x, point_.y);
...
inline bool trilateration(const T& c0x, const T& c0y, const T& c0r,
                          ...
                          const T& c2x, const T& c2y, const T& c2r, T& px,
                          T& py) {
  if ((lay_distance(c0x, c0y, c1x, c1y) > sqr(c0r + c1r)) ||
  ...
  const T eqn2 =
      sqr(c0r) - sqr(c1r) - sqr(c0x) + sqr(c1x) - sqr(c0y) + sqr(c1y);
  const T eqn3 = T(2.0) * (c2x - c1x);
  const T eqn4 = T(2.0) * (c2y - c1y);
  const T eqn5 =
      sqr(c1r) - sqr(c2r) - sqr(c1x) + sqr(c2x) - sqr(c1y) + sqr(c2y);
...
template <typename T>
inline point2d<T> trilateration(const circle<T>& c0, const circle<T>& c1,
                                const circle<T>& c2) {
  point2d<T> p;

  const bool result = trilateration(c0.x, c0.y, c0.radius, c1.x, c1.y,
                                    c1.radius, c2.x, c2.y, c2.radius, p.x, p.y);

  return result ? p : degenerate_point2d<T>();
}

template <typename T>
inline void incenter(const T& x1, const T& y1, const T& x2, const T& y2,
                     const T& x3, const T& y3, T& px, T& py) {
  /* Using Heron's s=ur */
...
template <typename T>
inline void incenter(const T& x1, const T& y1, const T& z1, const T& x2,
                     const T& y2, const T& z2, const T& x3, const T& y3,
                     const T& z3, T& px, T& py, T& pz) {
  /* Using Heron's s=ur */
...
template <typename T>
inline point2d<T> incenter(const point2d<T>& point1, const point2d<T>& point2,
                           const point2d<T>& point3) {
  point2d<T> point_;

  incenter(point1.x, point1.y, point2.x, point2.y, point3.x, point3.y, point_.x,
           point_.y);
...
template <typename T>
inline point3d<T> incenter(const point3d<T>& point1, const point3d<T>& point2,
                           const point3d<T>& point3) {
  point3d<T> point_;

  incenter(point1.x, point1.y, point1.z, point2.x, point2.y, point2.z, point3.x,
           point3.y, point3.z, point_.x, point_.y, point_.z);
...
template <typename T>
inline void circumcenter(const T& x1, const T& y1, const T& x2, const T& y2,
                         const T& x3, const T& y3, T& px, T& py) {
  const T a = x2 - x1;
  const T b = y2 - y1;
  const T c = x3 - x1;
...
template <typename T>
inline void circumcenter(const T& x1, const T& y1, const T& z1, const T& x2,
                         const T& y2, const T& z2, const T& x3, const T& y3,
                         const T& z3, T& px, T& py, T& pz) {
  ...
  const point3d<T> p1 =
      make_point((x1 + x2) * T(0.5), (y1 + y2) * T(0.5), (z1 + z2) * T(0.5));
  const point3d<T> p2 =
      make_point((x3 + x2) * T(0.5), (y3 + y2) * T(0.5), (z3 + z2) * T(0.5));

  const point3d<T> p1_ = p1 + (vec1 * tri_plane.normal);
  const point3d<T> p2_ = p2 + (vec2 * tri_plane.normal);

  intersection_point_line_to_line(p1.x, p1.y, p1.z, p1_.x, p1_.y, p1_.z, p2.x,
                                  p2.y, p2.z, p2_.x, p2_.y, p2_.z, px, py, pz,
                                  T(Epsilon));
}
...
inline point2d<T> circumcenter(const point2d<T>& point1,
  ...
  circumcenter(point1.x, point1.y, point2.x, point2.y, point3.x, point3.y,
               point_.x, point_.y);
...
inline point3d<T> circumcenter(const point3d<T>& point1,
  ...
  circumcenter(point1.x, point1.y, point1.z, point2.x, point2.y, point2.z,
               point3.x, point3.y, point3.z, point_.x, point_.y, point_.z);
...
template <typename T>
inline circle<T> circumcircle(const T& x1, const T& y1, const T& x2,
                              const T& y2, const T& x3, const T& y3) {
  T cx = T(0.0);
  T cy = T(0.0);
...
inline circle<T> circumcircle(const point2d<T>& point1,
                              const point2d<T>& point2,
                              const point2d<T>& point3) {
  return circumcircle(point1.x, point1.y, point2.x, point2.y, point3.x,
                      point3.y);
}
...
inline sphere<T> circumsphere(const point3d<T>& point1,
                              const point3d<T>& point2,
                              const point3d<T>& point3) {
  return circumsphere(point1.x, point1.y, point1.z, point2.x, point2.y,
                      point2.z, point3.x, point3.y, point3.z);
}
...
template <typename T>
inline circle<T> inscribed_circle(const T& x1, const T& y1, const T& x2,
                                  const T& y2, const T& x3, const T& y3) {
  /* using heron's s = ur */
  const T side12 = distance(x1, y1, x2, y2);
  const T side23 = distance(x2, y2, x3, y3);
  ...
  return make_circle(
      ...
      T(0.5) * sqrt((-side12 + side23 + side31) * (side12 - side23 + side31) *
                    (side12 + side23 - side31) * perimeter));
}
...
inline circle<T> inscribed_circle(const point2d<T>& point1,
                                  const point2d<T>& point2,
                                  const point2d<T>& point3) {
  return inscribed_circle(point1.x, point1.y, point2.x, point2.y, point3.x,
                          point3.y);
}
...
inline sphere<T> inscribed_sphere(const T& x1, const T& y1, const T& z1,
  ...
  return make_sphere(
      int_point,
      distance(int_point, closest_point_on_line_from_point(
                              make_line(x1, y1, z1, x2, y2, z2), int_point)));
}
...
inline sphere<T> inscribed_sphere(const point3d<T>& point1,
                                  const point3d<T>& point2,
                                  const point3d<T>& point3) {
  return inscribed_sphere(point1.x, point1.y, point1.z, point2.x, point2.y,
                          point2.z, point3.x, point3.y, point3.z);
}
...
template <typename T>
inline circle<T> nine_point_circle(const T& x1, const T& y1, const T& x2,
                                   const T& y2, const T& x3, const T& y3) {
  T hx1 = T(0.0);
  T hy1 = T(0.0);
  T hx2 = T(0.0);
...
inline circle<T> nine_point_circle(const point2d<T>& point1,
                                   const point2d<T>& point2,
                                   const point2d<T>& point3) {
  return nine_point_circle(point1.x, point1.y, point2.x, point2.y, point3.x,
                           point3.y);
}
...
inline point2d<T> orthocenter(const triangle<T, 2>& triangle) {
  return intersection_point(
      make_line(triangle[0],
                closest_point_on_line_from_point(
                    make_line(opposing_edge(triangle, 0)), triangle[0])),
      make_line(triangle[1],
                closest_point_on_line_from_point(
                    make_line(opposing_edge(triangle, 1)), triangle[0])));
}
...
template <typename T>
inline point2d<T> excenter(const triangle<T, 2>& triangle,
                           const std::size_t& corner) {
  return intersection_point(
...
template <typename T>
inline point3d<T> excenter(const triangle<T, 3>& triangle,
                           const std::size_t& corner) {
  return intersection_point(
      triangle_bisector(triangle, corner),
      triangle_external_bisector(triangle, corner, (corner + 1) % 3));
...
template <typename T>
inline circle<T> invert_circle_across_circle(const circle<T>& circle1,
                                             const circle<T>& circle2) {
  const T t =
      sqr(circle2.radius) / (sqr(circle2.x - circle1.x) +
                             sqr(circle2.y - circle1.y) - sqr(circle1.radius));

  return make_circle(
      project_point_t(make_point(circle2), make_point(circle1), t),
      t * circle1.radius);
}

template <typename T>
inline sphere<T> invert_sphere_across_sphere(const sphere<T>& sphere1,
                                             const sphere<T>& sphere2) {
  const T t = sqr(sphere2.radius) /
              (sqr(sphere2.x - sphere1.x) + sqr(sphere2.y - sphere1.y) +
               sqr(sphere2.z - sphere1.z) - sqr(sphere1.radius));

  return make_sphere(
      project_point_t(make_point(sphere2), make_point(sphere1), t),
      t * sphere1.radius);
}

template <typename T>
inline void circle_tangent_points(const circle<T>& circle,
                                  const point2d<T>& point, point2d<T>& point1,
                                  point2d<T>& point2) {
  ...
  if (greater_than_or_equal(sqr_length, radius_sqr)) {
    ...
    point1.x = circle.x +
               circle.radius * (circle.radius * v.x - v.y * delta_dist) * ratio;
    point1.y = circle.y +
               circle.radius * (circle.radius * v.y + v.x * delta_dist) * ratio;
    point2.x = circle.x +
               circle.radius * (circle.radius * v.x + v.y * delta_dist) * ratio;
    point2.y = circle.y +
               circle.radius * (circle.radius * v.y - v.x * delta_dist) * ratio;
...
inline void circle_internal_tangent_lines(const circle<T>& circle0,
  ...
  if ((dist - (circle0.radius + circle1.radius)) < T(0))
    ...
    const point2d<T> i =
        make_point<T>((h1 * circle0.x + h0 * circle1.x) / dist,
...
template <typename T>
inline void circle_internal_tangent_segments(
    const circle<T>& circle0, const circle<T>& circle1,
...
inline void circle_outer_tangent_lines(const circle<T>& circle0,
  ...
  if (dist < std::abs(circle0.radius - circle1.radius))
    return;
  else if (is_equal(std::abs(dist - std::abs(circle0.radius - circle1.radius)),
                    T(0.0)))
    lines.push_back(create_perpendicular_bisector(make_segment(c0, c1)));
  else if (is_equal(circle0.radius - circle1.radius, T(0.0))) {
    const point2d<T> c0pnt0 =
        c0 + (+circle0.radius * perpendicular(normalize(c1 - c0)));
    const point2d<T> c0pnt1 =
        c0 + (-circle0.radius * perpendicular(normalize(c1 - c0)));
    const point2d<T> c1pnt0 =
        c1 + (+circle1.radius * perpendicular(normalize(c0 - c1)));
    const point2d<T> c1pnt1 =
        c1 + (-circle1.radius * perpendicular(normalize(c0 - c1)));
    ...
    if (circle0.radius > circle1.radius)
      p = make_point(c1.x * circle0.radius - c0.x * circle1.radius,
                     c1.y * circle0.radius - c0.y * circle1.radius);
    else
      p = make_point(c0.x * circle1.radius - c1.x * circle0.radius,
...
template <typename T>
inline void circle_outer_tangent_segments(
    const circle<T>& circle0, const circle<T>& circle1,
    std::vector<segment<T, 2> >& segments) {
  std::vector<line<T, 2> > lines;
...
template <typename T>
inline line<T, 2> tangent_line(const circle<T>& circle,
                               const point2d<T>& point) {
...
template <typename T>
inline ray<T, 2> create_ray_from_bisector(const T& x1, const T& y1, const T& x2,
                                          const T& y2, const T& x3,
                                          const T& y3) {
...
template <typename T>
inline line<T, 3> create_line_from_bisector(const T& x1, const T& y1,
  ...
  return make_line(x2, y2, z2, x3 + ratio * (x1 - x3), y3 + ratio * (y1 - y3),
                   z3 + ratio * (z1 - z3));
}

template <typename T>
inline segment<T, 3> create_segment_from_bisector(const T& x1, const T& y1,
                                                  const T& z1, const T& x2,
                                                  const T& y2, const T& z2,
                                                  const T& x3, const T& y3,
                                                  const T& z3) {
  ...
  return make_segment(x2, y2, z2, x3 + ratio * (x1 - x3),
                      y3 + ratio * (y1 - y3), z3 + ratio * (z1 - z3));
}
...
inline ray<T, 3> create_ray_from_bisector(const T& x1, const T& y1, const T& z1,
                                          ...
                                          const T& z3) {
  segment<T, 3> segment =
      create_segment_from_bisector(x1, y1, z1, x2, y2, z2, x3, y3, z3);

  return make_ray(segment[0], segment[1] - segment[0]);
}

template <typename T>
inline line<T, 2> create_line_from_bisector(const point2d<T>& point1,
                                            const point2d<T>& point2,
                                            const point2d<T>& point3) {
  return create_line_from_bisector(point1.x, point1.y, point2.x, point2.y,
                                   point3.x, point3.y);
}

template <typename T>
inline segment<T, 2> create_segment_from_bisector(const point2d<T>& point1,
                                                  const point2d<T>& point2,
                                                  const point2d<T>& point3) {
  return create_segment_from_bisector(point1.x, point1.y, point2.x, point2.y,
                                      point3.x, point3.y);
}

template <typename T>
inline ray<T, 2> create_ray_from_bisector(const point2d<T>& point1,
                                          const point2d<T>& point2,
                                          const point2d<T>& point3) {
  return create_ray_from_bisector(point1.x, point1.y, point2.x, point2.y,
                                  point3.x, point3.y);
}

template <typename T>
inline line<T, 3> create_line_from_bisector(const point3d<T>& point1,
                                            const point3d<T>& point2,
                                            const point3d<T>& point3) {
  return create_line_from_bisector(point1.x, point1.y, point1.z, point2.x,
                                   point2.y, point2.z, point3.x, point3.y,
                                   point3.z);
}

template <typename T>
inline segment<T, 3> create_segment_from_bisector(const point3d<T>& point1,
                                                  const point3d<T>& point2,
                                                  const point3d<T>& point3) {
  return create_segment_from_bisector(point1.x, point1.y, point1.z, point2.x,
                                      point2.y, point2.z, point3.x, point3.y,
                                      point3.z);
}

template <typename T>
inline ray<T, 3> create_ray_from_bisector(const point3d<T>& point1,
                                          const point3d<T>& point2,
                                          const point3d<T>& point3) {
  return create_ray_from_bisector(point1.x, point1.y, point1.z, point2.x,
                                  point2.y, point2.z, point3.x, point3.y,
                                  point3.z);
}

template <typename T>
inline line<T, 2> create_perpendicular_bisector(const T& x1, const T& y1,
                                                const T& x2, const T& y2) {
...
template <typename T>
inline line<T, 2> create_perpendicular_bisector(const point2d<T>& point1,
                                                const point2d<T>& point2) {
...
template <typename T>
inline line<T, 2> create_perpendicular_line_at_end_point(
    const line<T, 2>& line) {
...
template <typename T>
inline void closest_point_on_segment_from_point(
    const T& x1, const T& y1, const T& z1, const T& x2, const T& y2,
    const T& z2, const T& px, const T& py, const T& pz, T& nx, T& ny, T& nz) {
  const T vx = x2 - x1;
  const T vy = y2 - y1;
  const T vz = z2 - z1;
  const T wx = px - x1;
...
template <typename T>
inline void order_sensitive_closest_point_on_segment_from_point(
    const T& x1, const T& y1, const T& x2, const T& y2, const T& px,
...
inline void order_sensitive_closest_point_on_segment_from_point(
    ...
    const T& z2, const T& px, const T& py, const T& pz, T& nx, T& ny, T& nz) {
  if (x1 < x2) {
    closest_point_on_segment_from_point(x1, y1, z1, x2, y2, z2, px, py, pz, nx,
                                        ny, nz);
    return;
  } else if (is_equal(x1, x2) && (y1 < y2)) {
    closest_point_on_segment_from_point(x1, y1, z1, x2, y2, z2, px, py, pz, nx,
    ...
    closest_point_on_segment_from_point(x2, y2, z2, x1, y1, z1, px, py, pz, nx,
                                        ny, nz);
}

template <typename T>
inline void order_sensitive_closest_point_on_line_from_point(
    const T& x1, const T& y1, const T& x2, const T& y2, const T& px,
    const T& py, T& nx, T& ny) {
  if (x1 < x2) {
...
inline void order_sensitive_closest_point_on_line_from_point(
    ...
    const T& z2, const T& px, const T& py, const T& pz, T& nx, T& ny, T& nz) {
  if (x1 < x2) {
    closest_point_on_line_from_point(x1, y1, z1, x2, y2, z2, px, py, pz, nx, ny,
                                     nz);
    return;
  } else if (is_equal(x1, x2) && (y1 < y2)) {
    closest_point_on_line_from_point(x1, y1, z1, x2, y2, z2, px, py, pz, nx, ny,
...
template <typename T>
inline point3d<T> closest_point_on_segment_from_point(const T& x1, const T& y1,
                                                      const T& z1, const T& x2,
                                                      const T& y2, const T& z2,
                                                      const T& px, const T& py,
                                                      const T& pz) {
  point3d<T> point;
  closest_point_on_segment_from_point(x1, y1, z1, x2, y2, z2, px, py, pz,
...
template <typename T>
inline point2d<T> closest_point_on_segment_from_point(
    const segment<T, 2>& segment, const point2d<T>& point) {
  point2d<T> point_;
  closest_point_on_segment_from_point(segment[0].x, segment[0].y, segment[1].x,
                                      segment[1].y, point.x, point.y, point_.x,
                                      point_.y);
  return point_;
}

template <typename T>
inline point3d<T> closest_point_on_segment_from_point(
    const segment<T, 3>& segment, const point3d<T>& point) {
  point3d<T> point_;
  closest_point_on_segment_from_point(
      segment[0].x, segment[0].y, segment[0].z, segment[1].x, segment[1].y,
      segment[1].z, point.x, point.y, point.z, point_.x, point_.y, point_.z);
  return point_;
}
...
template <typename T>
inline point3d<T> closest_point_on_line_from_point(const T& x1, const T& y1,
                                                   const T& z1, const T& x2,
                                                   const T& y2, const T& z2,
                                                   const T& px, const T& py,
                                                   const T& pz) {
  point3d<T> point;
  closest_point_on_line_from_point(x1, y1, z1, x2, y2, z2, px, py, pz, point.x,
                                   point.y, point.z);
  return point;
}

template <typename T>
inline point2d<T> closest_point_on_line_from_point(const line<T, 2>& line,
                                                   const point2d<T>& point) {
  point2d<T> point_;

  closest_point_on_line_from_point(line[0].x, line[0].y, line[1].x, line[1].y,
                                   point.x, point.y, point_.x, point_.y);

  return point_;
}

template <typename T>
inline point3d<T> closest_point_on_line_from_point(const line<T, 3>& line,
                                                   const point3d<T>& point) {
  point3d<T> point_;

  closest_point_on_line_from_point(line[0].x, line[0].y, line[0].z, line[1].x,
                                   line[1].y, line[1].z, point.x, point.y,
                                   point.z, point_.x, point_.y, point_.z);
...
template <typename T>
inline point3d<T> closest_point_on_ray_from_point(const T& ox, const T& oy,
                                                  const T& oz, const T& dx,
                                                  const T& dy, const T& dz,
                                                  const T& px, const T& py,
                                                  const T& pz) {
  point3d<T> point_;
  closest_point_on_ray_from_point(ox, oy, oz, dx, dy, dz, px, py, pz, point_.x,
                                  point_.y, point_.z);
  return point_;
}

template <typename T>
inline point2d<T> closest_point_on_ray_from_point(const ray<T, 2>& ray,
                                                  const point2d<T>& point) {
...
template <typename T>
inline point3d<T> closest_point_on_ray_from_point(const ray<T, 3>& ray,
                                                  const point3d<T>& point) {
  return closest_point_on_ray_from_point(
      ray.origin.x, ray.origin.y, ray.origin.z, ray.direction.x,
      ray.direction.y, ray.direction.z, point.x, point.y, point.z);
}
...
inline void closest_point_on_triangle_from_point(const T& x1, const T& y1,
  ...
  if (differing_orientation(x1, y1, x2, y2, px, py, x3, y3) &&
      ((or1 * or2) == -1)) {
    closest_point_on_segment_from_point(x1, y1, x2, y2, px, py, nx, ny);
    return;
  }
  ...
  const int or3 =
      orientation((x1 + x2) * T(0.5), (y1 + y2) * T(0.5), x3, y3, px, py);

  if (differing_orientation(x2, y2, x3, y3, px, py, x1, y1) &&
      ((or2 * or3) == -1)) {
    closest_point_on_segment_from_point(x2, y2, x3, y3, px, py, nx, ny);
    return;
  }

  if (differing_orientation(x3, y3, x1, y1, px, py, x2, y2) &&
      ((or3 * or1) == -1)) {
...
inline point2d<T> closest_point_on_triangle_from_point(const T& x1, const T& y1,
                                                       ...
                                                       const T& py) {
  point2d<T> point;
  closest_point_on_triangle_from_point(x1, y1, x2, y2, x3, y3, px, py, point.x,
                                       point.y);
  return point;
}

template <typename T>
inline point2d<T> closest_point_on_triangle_from_point(
    const triangle<T, 2>& triangle, const T& px, const T& py) {
  return closest_point_on_triangle_from_point(
      triangle[0].x, triangle[0].y, triangle[1].x, triangle[1].y, triangle[2].x,
      triangle[2].y, px, py);
}
...
inline point2d<T> closest_point_on_triangle_from_point(
  ...
  return closest_point_on_triangle_from_point(
      triangle[0].x, triangle[0].y, triangle[1].x, triangle[1].y, triangle[2].x,
      triangle[2].y, point.x, point.y);
}

template <typename T>
inline void closest_point_on_triangle_from_point(
    const T& x1, const T& y1, const T& z1, const T& x2, const T& y2,
    const T& z2, const T& x3, const T& y3, const T& z3, const T& px,
    const T& py, const T& pz, T& nx, T& ny, T& nz) {
  point3d<T> point_;

  point_ = closest_point_on_triangle_from_point(x1, y1, z1, x2, y2, z2, x3, y3,
                                                z3, px, py, pz);
...
template <typename T>
inline point3d<T> closest_point_on_triangle_from_point(
    const T& x1, const T& y1, const T& z1, const T& x2, const T& y2,
    const T& z2, const T& x3, const T& y3, const T& z3, const T& px,
    const T& py, const T& pz) {
  return closest_point_on_triangle_from_point(
      make_triangle(x1, y1, z1, x2, y2, z2, x3, y3, z3), px, py, pz);
}

template <typename T>
inline point3d<T> closest_point_on_triangle_from_point(
    const triangle<T, 3>& triangle, const T& px, const T& py, const T& pz) {
  return closest_point_on_triangle_from_point(triangle, make_point(px, py, pz));
}

template <typename T>
inline point3d<T> closest_point_on_triangle_from_point(
    const triangle<T, 3>& triangle, const point3d<T>& point) {
...
template <typename T>
inline point2d<T> closest_point_on_rectangle_from_point(
    const T& x1, const T& y1, const T& x2, const T& y2, const T& px,
    const T& py) {
  point2d<T> point;
  closest_point_on_rectangle_from_point(x1, y1, x2, y2, px, py, point.x,
                                        point.y);
  return point;
}
...
template <typename T>
inline point2d<T> closest_point_on_rectangle_from_point(
    const rectangle<T>& rectangle, const T& px, const T& py) {
  return closest_point_on_rectangle_from_point(
      rectangle[0].x, rectangle[0].y, rectangle[1].x, rectangle[1].y, px, py);
}

template <typename T>
inline point2d<T> closest_point_on_rectangle_from_point(
    const rectangle<T>& rectangle, const point2d<T>& point) {
...
template <typename T>
inline void closest_point_on_box_from_point(const T& x1, const T& y1,
                                            const T& z1, const T& x2,
                                            const T& y2, const T& z2,
                                            const T& px, const T& py,
                                            const T& pz, T& nx, T& ny, T& nz) {
...
template <typename T>
inline point3d<T> closest_point_on_box_from_point(const T& x1, const T& y1,
                                                  const T& z1, const T& x2,
                                                  const T& y2, const T& z2,
                                                  const T& px, const T& py,
                                                  const T& pz) {
  point3d<T> point;
  closest_point_on_box_from_point(x1, y1, z1, x2, y2, z2, px, py, pz, point.x,
                                  point.y, point.z);
  return point;
}

template <typename T>
inline point3d<T> closest_point_on_box_from_point(const box<T, 3>& box,
                                                  const T& px, const T& py,
                                                  const T& pz) {
  return closest_point_on_box_from_point(box[0].x, box[0].y, box[0].z, box[1].x,
                                         box[1].y, box[1].z, px, py, pz);
}
...
inline point3d<T> closest_point_on_box_from_point(const box<T, 3>& box,
                                                  const point3d<T>& point) {
  return closest_point_on_box_from_point(box[0].x, box[0].y, box[0].z, box[1].x,
                                         box[1].y, box[1].z, point.x, point.y,
                                         point.z);
}
...
inline point2d<T> closest_point_on_quadix_from_point(const T& x1, const T& y1,
  ...
  closest_point_on_quadix_from_point(x1, y1, x2, y2, x3, y3, x4, y4, px, py,
                                     point.x, point.y);
...
inline point2d<T> closest_point_on_quadix_from_point(const quadix<T, 2>& quadix,
                                                     const point2d<T>& point) {
  return closest_point_on_quadix_from_point(
      quadix[0].x, quadix[0].y, quadix[1].x, quadix[1].y, quadix[2].x,
      quadix[2].y, quadix[3].x, quadix[3].y, point.x, point.y);
}
...
template <typename T>
inline point2d<T> closest_point_on_aabbb_from_point(
    const rectangle<T>& rectangle, const point2d<T>& point) {
  return closest_point_on_rectangle_from_point(rectangle, point);
}

template <typename T>
inline point2d<T> closest_point_on_circle_from_segment(
    const circle<T>& circle, const segment<T, 2>& segment) {
  T nx = T(0.0);
  T ny = T(0.0);
  ...
  closest_point_on_segment_from_point(segment[0].x, segment[0].y, segment[1].x,
                                      segment[1].y, circle.x, circle.y, nx, ny);
...
template <typename T>
inline point3d<T> closest_point_on_sphere_from_segment(
    const sphere<T>& sphere, const segment<T, 3>& segment) {
  T nx = T(0.0);
  T ny = T(0.0);
  T nz = T(0.0);
  ...
  closest_point_on_segment_from_point(segment[0].x, segment[0].y, segment[0].z,
                                      ...
                                      sphere.x, sphere.y, sphere.z, nx, ny, nz);
...
inline point3d<T> closest_point_on_plane_from_point(const plane<T, 3>& plane,
                                                    const point3d<T>& point) {
  const T mu = plane.normal.x * point.x + plane.normal.y * point.y +
...
template <typename T>
inline point2d<T> closest_point_on_bezier_from_point(
    const quadratic_bezier<T, 2>& bezier, const point2d<T>& point,
    const std::size_t& steps) {
  ...
  for (std::size_t i = 0; i < (point_list.size() - 1); ++i) {
    point_type current_point = closest_point_on_segment_from_point(
        make_segment(point_list[i], point_list[i + 1]), point);
...
template <typename T>
inline point2d<T> closest_point_on_bezier_from_point(
    const cubic_bezier<T, 2>& bezier, const point2d<T>& point,
    const std::size_t& steps) {
  typedef point2d<T> point_type;
...
template <typename T>
inline point3d<T> closest_point_on_bezier_from_point(
    const quadratic_bezier<T, 3>& bezier, const point3d<T>& point,
    const std::size_t& steps) {
...
template <typename T>
inline point3d<T> closest_point_on_bezier_from_point(
    const cubic_bezier<T, 3>& bezier, const point3d<T>& point,
    const std::size_t& steps) {
  typedef point3d<T> point_type;
...
template <typename T>
inline point2d<T> closest_point_on_circle_from_circle(
    const circle<T>& circle1, const circle<T>& circle2) {
  return closest_point_on_circle_from_point(
      circle1,
      closest_point_on_circle_from_point(circle2, make_point(circle1)));
}

template <typename T>
inline point3d<T> closest_point_on_sphere_from_sphere(
    const sphere<T>& sphere1, const sphere<T>& sphere2) {
  return closest_point_on_sphere_from_point(
      sphere1,
      closest_point_on_sphere_from_point(sphere2, make_point(sphere1)));
}

template <typename T>
inline point2d<T> closest_point_on_polygon_from_point(
    const polygon<T, 2>& polygon, const point2d<T>& point) {
  ...
  for (std::size_t i = 0; i < polygon.size(); ++i) {
    point2d<T> curr_point = closest_point_on_segment_from_point(
        make_segment(polygon[i], polygon[j]), point);
...
template <typename T>
inline T minimum_distance_from_point_to_segment(const T& px, const T& py,
                                                const T& pz, const T& x1,
                                                const T& y1, const T& z1,
                                                const T& x2, const T& y2,
                                                const T& z2) {
  T nx = T(0.0);
  T ny = T(0.0);
...
template <typename T>
inline T minimum_distance_from_point_to_segment(const point2d<T>& point,
                                                const segment<T, 2>& segment) {
...
template <typename T>
inline T minimum_distance_from_point_to_segment(const point3d<T>& point,
                                                const segment<T, 3>& segment) {
  return minimum_distance_from_point_to_segment(
      point.x, point.y, point.z, segment[0].x, segment[0].y, segment[0].z,
      segment[1].x, segment[1].y, segment[1].z);
}
...
template <typename T>
inline T minimum_distance_from_point_to_line(const point2d<T>& point,
                                             const line<T, 2>& line) {
  return minimum_distance_from_point_to_line(line[0].x, line[0].y, line[1].x,
                                             line[1].y, point.x, point.y);
}

template <typename T>
inline T minimum_distance_from_point_to_line(const point3d<T>& point,
                                             const line<T, 3>& line) {
...
template <typename T>
inline T minimum_distance_from_point_to_triangle(
    const point2d<T>& point, const triangle<T, 2>& triangle) {
  return minimum_distance_from_point_to_triangle(
      point.x, point.y, triangle[0].x, triangle[0].y, triangle[1].x,
      triangle[1].y, triangle[2].x, triangle[2].y);
}
...
template <typename T>
inline T minimum_distance_from_point_to_rectangle(
    const point2d<T>& point, const rectangle<T>& rectangle) {
  return minimum_distance_from_point_to_rectangle(
      rectangle[0].x, rectangle[0].y, rectangle[1].x, rectangle[1].y, point.x,
      point.y);
}

template <typename T>
inline void segment_mid_point(const T& x1, const T& y1, const T& x2,
                              const T& y2, T& midx, T& midy) {
  midx = (x1 + x2) * T(0.5);
  midy = (y1 + y2) * T(0.5);
}
...
inline void segment_mid_point(const segment<T, 2>& segment, T& midx, T& midy) {
  segment_mid_point(segment[0].x, segment[0].y, segment[1].x, segment[1].y,
                    midx, midy);
}

template <typename T>
inline point2d<T> segment_mid_point(const point2d<T>& point1,
                                    const point2d<T>& point2) {
  point2d<T> point_;
...
inline void segment_mid_point(const T& x1, const T& y1, const T& z1,
                              const T& x2, const T& y2, const T& z2, T& midx,
                              T& midy, T& midz) {
  midx = (x1 + x2) * T(0.5);
  midy = (y1 + y2) * T(0.5);
  midz = (z1 + z2) * T(0.5);
...
template <typename T>
inline void segment_mid_point(const segment<T, 3>& segment, T& midx, T& midy,
                              T& midz) {
  segment_mid_point(segment[0].x, segment[0].y, segment[0].z, segment[1].x,
                    segment[1].y, segment[1].z, midx, midy, midz);
}

template <typename T>
inline point3d<T> segment_mid_point(const point3d<T>& point1,
                                    const point3d<T>& point2) {
  point3d<T> point_;

  segment_mid_point(point1.x, point1.y, point1.z, point2.x, point2.y, point2.z,
...
template <typename T>
inline void centroid(const T& x1, const T& y1, const T& x2, const T& y2, T& x,
                     T& y) {
  x = (x1 + x2) * T(0.5);
  y = (y1 + y2) * T(0.5);
}
...
template <typename T>
inline void centroid(const T& x1, const T& y1, const T& x2, const T& y2,
                     const T& x3, const T& y3, T& x, T& y) {
  T midx1 = T(0.0);
  T midy1 = T(0.0);
  T midx2 = T(0.0);
  T midy2 = T(0.0);
...
template <typename T>
inline void centroid(const T& x1, const T& y1, const T& z1, const T& x2,
                     const T& y2, const T& z2, const T& x3, const T& y3,
                     const T& z3, T& x, T& y, T& z) {
  T midx1 = T(0.0);
  T midy1 = T(0.0);
  T midz1 = T(0.0);
  T midx2 = T(0.0);
  ...
  intersection_point(x1, y1, z1, midx1, midy1, midz1, x2, y2, z2, midx2, midy2,
                     midz2, x, y, z);
}

template <typename T>
inline void centroid(const T& x1, const T& y1, const T& x2, const T& y2,
                     const T& x3, const T& y3, const T& x4, const T& y4, T& x,
                     T& y) {
  x = 0.0;
  y = 0.0;
...
inline void centroid(const triangle<T, 2>& triangle, T& x, T& y) {
  centroid(triangle[0].x, triangle[0].y, triangle[1].x, triangle[1].y,
           triangle[2].x, triangle[2].y, x, y);
}

template <typename T>
inline void centroid(const triangle<T, 3>& triangle, T& x, T& y, T& z) {
  centroid(triangle[0].x, triangle[0].y, triangle[0].z, triangle[1].x,
           triangle[1].y, triangle[1].z, triangle[2].x, triangle[2].y,
           triangle[2].z, x, y, z);
}

template <typename T>
inline void centroid(const quadix<T, 2>& quadix, T& x, T& y) {
  centroid(quadix[0].x, quadix[0].y, quadix[1].x, quadix[1].y, quadix[2].x,
           quadix[2].y, quadix[3].x, quadix[3].y, x, y);
}
...
inline void centroid(const polygon<T, 2>& polygon, T& x, T& y) {
  ...
  for (std::size_t i = 0; i < polygon.size(); ++i) {
    const T term =
        ((polygon[j].x * polygon[i].y) - (polygon[j].y * polygon[i].x));
...
inline point2d<T> centroid(const point2d<T>& point1, const point2d<T>& point2,
  ...
  centroid(point1.x, point1.y, point2.x, point2.y, point3.x, point3.y, point_.x,
           point_.y);
...
inline point2d<T> centroid(const point2d<T>& point1, const point2d<T>& point2,
  ...
  centroid(point1.x, point1.y, point2.x, point2.y, point3.x, point3.y, point4.x,
           point4.y, point_.x, point_.y);
...
template <typename T>
inline bool point_in_convex_polygon(const T& px, const T& py,
                                    const polygon<T, 2>& polygon) {
  if (polygon.size() < 3) return false;

  int initial_orientation = orientation(
      polygon[0], polygon[static_cast<int>(polygon.size()) - 1], px, py);
  std::size_t j = 0;
...
template <typename T>
inline bool point_in_convex_polygon(const point2d<T>& point,
                                    const polygon<T, 2>& polygon) {
  return point_in_convex_polygon(point.x, point.y, polygon);
}

template <typename T>
inline bool point_on_polygon_edge(const T& px, const T& py,
                                  const polygon<T, 2>& polygon) {
  if (polygon.size() < 3) return false;
...
template <typename T>
inline bool point_on_polygon_edge(const point2d<T>& point,
                                  const polygon<T, 2>& polygon) {
  return point_on_polygon_edge(point.x, point.y, polygon);
}

template <typename T>
inline bool point_in_polygon(const T& px, const T& py,
                             const polygon<T, 2>& polygon) {
  bool result = false;
  if (polygon.size() < 3) return false;
  ...
  for (std::size_t i = 0; i < polygon.size(); ++i) {
    if (((polygon[i].y <= py) && (py < polygon[j].y)) ||  // an upward crossing
      ...
      if (px - polygon[i].x <
          ((polygon[j].x - polygon[i].x) * (py - polygon[i].y) /
...
template <typename T>
inline bool point_in_polygon(const point2d<T>& point,
                             const polygon<T, 2>& polygon) {
  return point_in_polygon(point.x, point.y, polygon);
}

template <typename T>
inline bool point_in_polygon_winding_number(const T& px, const T& py,
                                            const polygon<T, 2>& polygon) {
...
template <typename T>
inline bool point_in_polygon_winding_number(const point2d<T>& point,
                                            const polygon<T, 2>& polygon) {
...
inline bool is_convex_polygon(const polygon<T, 2>& polygon) {
  ...
  while ((initial_orientation = orientation(
              polygon[k], polygon[j], polygon[i])) == CollinearOrientation) {
    k = j;
    j = i++;
  ...
  while (i < polygon.size()) {
    if (orientation(polygon[k], polygon[j], polygon[i]) !=
        initial_orientation) {
      return false;
    }
...
template <typename T>
inline polygon<T, 2> remove_consecutive_collinear_points(
    const polygon<T, 2>& polygon) {
  ...
  for (std::size_t i = 0; i < polygon.size() - 1; ++i) {
    if (orientation(previous_point, polygon[i], polygon[i + 1]) !=
  ...
  if (orientation(previous_point, polygon.back(), polygon.front()) !=
      CollinearOrientation) {
...
inline void remove_consecutive_collinear_points(const InputIterator begin,
...
template <typename T>
inline bool convex_vertex(const std::size_t& index,
                          const polygon<T, 2>& polygon,
                          const int& polygon_orientation) {
  if (0 == index) {
    return (orientation(polygon.back(), polygon.front(), polygon[1]) ==
            polygon_orientation);
  } else if (index == (polygon.size() - 1)) {
    return (orientation(polygon[polygon.size() - 2], polygon.back(),
                        polygon.front()) == polygon_orientation);
  } else {
    return (orientation(polygon[index - 1], polygon[index],
                        polygon[index + 1]) == polygon_orientation);
  }
}

template <typename T>
inline bool collinear_vertex(const std::size_t& index,
                             const polygon<T, 2>& polygon) {
  if (0 == index) {
    return robust_collinear(polygon.back(), polygon.front(), polygon[1]);
  } else if (index == (polygon.size() - 1)) {
    return robust_collinear(polygon[polygon.size() - 2], polygon.back(),
                            polygon.front());
  } else {
    return robust_collinear(polygon[index - 1], polygon[index],
                            polygon[index + 1]);
  }
}

template <typename T>
inline bool vertex_is_ear(const std::size_t& index,
                          const polygon<T, 2>& polygon) {
  ...
  triangle<T, 2> triangle =
      make_triangle(polygon[pred_index], polygon[index], polygon[succ_index]);
...
template <typename T>
inline triangle<T, 2> vertex_triangle(const std::size_t& index,
                                      const polygon<T, 2> polygon) {
  if (0 == index) {
    return make_triangle(polygon.back(), polygon.front(), polygon[1]);
  } else if (index == (polygon.size() - 1)) {
    return make_triangle(polygon[polygon.size() - 2], polygon.back(),
                         polygon.front());
  } else {
    return make_triangle(polygon[index - 1], polygon[index],
                         polygon[index + 1]);
  }
}
...
inline int polygon_orientation(const polygon<T, 2>& polygon) {
  ...
  for (std::size_t index = 0; index < polygon.size(); ++index) {
    area += (polygon[prev_index].x * polygon[index].y -
             polygon[index].x * polygon[prev_index].y);
    prev_index = index;
  }
  ...
  for (std::size_t i = 1; i < polygon.size(); ++i)
  {
     if (polygon[i].x > polygon[anchor].x)
        anchor = i;
     else if ((polygon[i].x == polygon[anchor].x) && (polygon[i].y  <
  polygon[anchor].y)) anchor = i;
  }
  ...
  {
     return orientation(*(polygon.end() - 2),*(polygon.end() -
  1),*polygon.end());
  }
  else
  {
     return orientation(polygon[anchor - 2],polygon[anchor -
  1],polygon[anchor]);
  }
  */
}
...
inline bool is_isosceles_triangle(const triangle<T, 2>& triangle) {
  ...
  return is_equal(dist1, dist2) || is_equal(dist1, dist3) ||
         is_equal(dist2, dist3);
}
...
inline bool is_right_triangle(const wykobi::triangle<T, 2>& triangle) {
  ...
  return wykobi::is_equal(a + b, c) || wykobi::is_equal(a + c, b) ||
         wykobi::is_equal(b + c, a);
}
...
template <typename T>
inline bool are_perspective_triangles(const triangle<T, 2>& triangle1,
                                      const triangle<T, 2>& triangle2) {
  for (std::size_t i = 0; i < 3; ++i) {
  ...
  return robust_collinear(intersection_point(make_line(edge(triangle1, 0)),
                                             make_line(edge(triangle2, 0))),
                          intersection_point(make_line(edge(triangle1, 1)),
                                             make_line(edge(triangle2, 1))),
                          intersection_point(make_line(edge(triangle1, 2)),
                                             make_line(edge(triangle2, 2))));
}

template <typename T>
inline bool are_perspective_triangles(const triangle<T, 3>& triangle1,
                                      const triangle<T, 3>& triangle2) {
  for (std::size_t i = 0; i < 3; ++i) {
    if (robust_parallel(edge(triangle1, i), edge(triangle2, i))) {
      return false;
...
template <typename T>
inline line<T, 2> perspectrix(const triangle<T, 2>& triangle1,
                              const triangle<T, 2>& triangle2) {
  for (std::size_t i = 0; i < 3; ++i) {
    if (robust_parallel(edge(triangle1, i), edge(triangle2, i))) {
      return degenerate_line2d<T>();
  ...
  point2d<T> ipoint0 = intersection_point(make_line(edge(triangle1, 0)),
                                          make_line(edge(triangle2, 0)));
  point2d<T> ipoint1 = intersection_point(make_line(edge(triangle1, 1)),
                                          make_line(edge(triangle2, 1)));
  point2d<T> ipoint2 = intersection_point(make_line(edge(triangle1, 2)),
                                          make_line(edge(triangle2, 2)));

  return (robust_collinear(ipoint0, ipoint1, ipoint2))
             ? make_line(ipoint0, ipoint1)
             : degenerate_line2d<T>();
}

template <typename T>
inline line<T, 3> perspectrix(const triangle<T, 3>& triangle1,
                              const triangle<T, 3>& triangle2) {
  for (std::size_t i = 0; i < 3; ++i) {
    if (robust_parallel(edge(triangle1, i), edge(triangle2, i))) {
      return degenerate_line3d<T>();
  ...
  point3d<T> ipoint0 = intersection_point(make_line(edge(triangle1, 0)),
                                          make_line(edge(triangle2, 0)));
  point3d<T> ipoint1 = intersection_point(make_line(edge(triangle1, 1)),
                                          make_line(edge(triangle2, 1)));
  point3d<T> ipoint2 = intersection_point(make_line(edge(triangle1, 2)),
                                          make_line(edge(triangle2, 2)));
...
template <typename T>
inline void mirror(const T& px, const T& py, const T& x1, const T& y1,
                   const T& x2, const T& y2, T& nx, T& ny) {
  closest_point_on_line_from_point(x1, y1, x2, y2, px, py, nx, ny);
...
template <typename T>
inline void mirror(const T& px, const T& py, const T& pz, const T& x1,
                   const T& y1, const T& z1, const T& x2, const T& y2,
                   const T& z2, T& nx, T& ny, T& nz) {
  closest_point_on_line_from_point(x1, y1, z1, x2, y2, z2, px, py, pz, nx, ny,
                                   nz);
...
template <typename T>
inline point2d<T> mirror(const point2d<T>& point,
                         const line<T, 2>& mirror_axis) {
  wykobi::point2d<T> point_;

  mirror(point.x, point.y, mirror_axis[0].x, mirror_axis[0].y, mirror_axis[1].x,
         mirror_axis[1].y, point_.x, point_.y);

  return point_;
}

template <typename T>
inline segment<T, 2> mirror(const segment<T, 2>& segment,
                            const line<T, 2>& mirror_axis) {
...
template <typename T>
inline line<T, 2> mirror(const line<T, 2>& line,
...
template <typename T>
inline rectangle<T> mirror(const rectangle<T>& rectangle,
                           const line<T, 2>& mirror_axis) {
...
template <typename T>
inline triangle<T, 2> mirror(const triangle<T, 2>& triangle,
                             const line<T, 2>& mirror_axis) {
...
template <typename T>
inline quadix<T, 2> mirror(const quadix<T, 2>& quadix,
                           const line<T, 2>& mirror_axis) {
...
template <typename T>
inline circle<T> mirror(const circle<T>& circle,
                        const line<T, 2>& mirror_axis) {
  wykobi::circle<T> circle_ = circle;

  mirror(circle.x, circle.y, mirror_axis[0].x, mirror_axis[0].y,
         mirror_axis[1].x, mirror_axis[1].y, circle_.x, circle_.y);

  return circle_;
}

template <typename T>
inline polygon<T, 2> mirror(const polygon<T, 2>& polygon,
                            const line<T, 2>& mirror_axis) {
  wykobi::polygon<T, 2> polygon_;
...
template <typename T>
inline point3d<T> mirror(const point3d<T>& point,
...
template <typename T>
inline segment<T, 3> mirror(const segment<T, 3>& segment,
                            const line<T, 3>& mirror_axis) {
...
template <typename T>
inline line<T, 3> mirror(const line<T, 3>& line,
...
template <typename T>
inline triangle<T, 3> mirror(const triangle<T, 3>& triangle,
                             const line<T, 3>& mirror_axis) {
...
template <typename T>
inline quadix<T, 3> mirror(const quadix<T, 3>& quadix,
                           const line<T, 3>& mirror_axis) {
...
template <typename T>
inline sphere<T> mirror(const sphere<T>& sphere,
                        const line<T, 3>& mirror_axis) {
  wykobi::sphere<T> sphere_ = sphere;

  mirror(sphere.x, sphere.y, sphere.z, mirror_axis[0].x, mirror_axis[0].y,
         mirror_axis[0].z, mirror_axis[1].x, mirror_axis[1].y, mirror_axis[1].z,
...
template <typename T>
inline polygon<T, 3> mirror(const polygon<T, 3>& polygon,
                            const line<T, 3>& mirror_axis) {
...
inline point3d<T> mirror(const point3d<T>& point, const plane<T, 3>& plane) {
  return point + T(2.0) * closest_point_on_plane_from_point(plane, point) -
         point;
}
...
template <typename T>
inline void nonsymmetric_mirror(const T& px, const T& py, const T& x1,
                                const T& y1, const T& x2, const T& y2,
                                const T& ratio, T& nx, T& ny) {
  closest_point_on_line_from_point(x1, y1, x2, y2, px, py, nx, ny);
...
template <typename T>
inline point2d<T> nonsymmetric_mirror(const point2d<T>& point, const T& ratio,
                                      const line<T, 2>& line) {
  wykobi::point2d<T> point_;

  nonsymmetric_mirror(point.x, point.y, line[0].x, line[0].y, ratio, line[1].x,
                      line[1].y, point_.x, point_.y);

  return point_;
}

template <typename T>
inline segment<T, 2> nonsymmetric_mirror(const segment<T, 2>& segment,
                                         const T& ratio,
                                         const line<T, 2>& line) {
  wykobi::segment<T, 2> segment_;
...
template <typename T>
inline rectangle<T> nonsymmetric_mirror(const rectangle<T>& rectangle,
                                        const T& ratio,
                                        const line<T, 2>& line) {
  wykobi::rectangle<T> rectangle_;
...
template <typename T>
inline triangle<T, 2> nonsymmetric_mirror(const triangle<T, 2>& triangle,
                                          const T& ratio,
                                          const line<T, 2>& line) {
  wykobi::triangle<T, 2> triangle_;
...
template <typename T>
inline quadix<T, 2> nonsymmetric_mirror(const quadix<T, 2>& quadix,
                                        const T& ratio,
                                        const line<T, 2>& line) {
  wykobi::quadix<T, 2> quadix_;
...
template <typename T>
inline circle<T> nonsymmetric_mirror(const circle<T>& circle, const T& ratio,
                                     const line<T, 2>& line) {
  wykobi::circle<T> circle_ = circle;
  nonsymmetric_mirror(circle.x, circle.y, line[0].x, line[0].y, line[1].x,
                      line[1].y, ratio, circle_.x, circle_.y);
  return circle_;
}

template <typename T>
inline polygon<T, 2> nonsymmetric_mirror(const polygon<T, 2>& polygon,
                                         const T& ratio,
                                         const line<T, 2>& line) {
  wykobi::polygon<T, 2> polygon_;
  polygon_.reserve(polygon.size());
...
template <typename T>
inline point3d<T> nonsymmetric_mirror(const point3d<T>& point, const T& ratio,
                                      const plane<T, 3>& plane) {
  return point +
         T(2.0) * ratio * closest_point_on_plane_from_point(plane, point) -
         point;
}

template <typename T>
inline segment<T, 3> nonsymmetric_mirror(const segment<T, 3>& segment,
                                         const T& ratio,
                                         const plane<T, 3>& plane) {
  wykobi::segment<T, 3> segment_;
...
template <typename T>
inline box<T, 3> nonsymmetric_mirror(const box<T, 3>& box, const T& ratio,
                                     const plane<T, 3>& plane) {
  wykobi::box<T, 3> box_;
...
template <typename T>
inline triangle<T, 3> nonsymmetric_mirror(const triangle<T, 3>& triangle,
                                          const T& ratio,
                                          const plane<T, 3>& plane) {
  wykobi::triangle<T, 3> triangle_;
...
template <typename T>
inline quadix<T, 3> nonsymmetric_mirror(const quadix<T, 3>& quadix,
                                        const T& ratio,
                                        const plane<T, 3>& plane) {
  wykobi::quadix<T, 3> quadix_;
...
template <typename T>
inline sphere<T> nonsymmetric_mirror(const sphere<T>& sphere, const T& ratio,
                                     const plane<T, 3>& plane) {
  point3d<T> center = make_point(sphere);
...
template <typename T>
inline polygon<T, 3> nonsymmetric_mirror(const polygon<T, 3>& polygon,
                                         const T& ratio,
                                         const plane<T, 3>& plane) {
  wykobi::polygon<T, 3> polygon_;
  polygon_.reserve(polygon.size());
...
template <typename T>
inline point2d<T> invert_point(const point2d<T>& point,
                               const circle<T>& circle) {
  return project_point_t(
      make_point(circle), point,
      sqr(circle.radius) / (sqr(point.x - circle.x) + sqr(point.y - circle.y)));
}

template <typename T>
inline point3d<T> invert_point(const point3d<T>& point,
                               const sphere<T>& sphere) {
  return project_point_t(
      make_point(sphere), point,
      sqr(sphere.radius) / (sqr(point.x - sphere.x) + sqr(point.y - sphere.y) +
                            sqr(point.z - sphere.z)));
}

template <typename T>
inline point2d<T> antipodal_point(const point2d<T>& point,
                                  const circle<T>& circle) {
  return project_point_t(point, make_point(circle), T(2.0));
}

template <typename T>
inline point3d<T> antipodal_point(const point3d<T>& point,
                                  const sphere<T>& sphere) {
...
template <typename T>
inline T distance(const T& x1, const T& y1, const T& z1, const T& x2,
                  const T& y2, const T& z2) {
  const T dx = (x1 - x2);
  const T dy = (y1 - y2);
  const T dz = (z1 - z2);
...
template <typename T>
inline T distance(const curve_point<T, 2>& point1,
                  const curve_point<T, 2>& point2) {
  return distance(point1().x, point1().y, point2().x, point2().y);
}

template <typename T>
inline T distance(const curve_point<T, 3>& point1,
                  const curve_point<T, 3>& point2) {
  return distance(point1().x, point1().y, point1().z, point2().x, point2().y,
                  point2().z);
}
...
inline T distance(const point2d<T>& point, const rectangle<T>& rectangle) {
  return distance(closest_point_on_rectangle_from_point(rectangle, point),
                  point);
}
...
inline T distance(const line<T, 2>& line1, const line<T, 2>& line2) {
  return distance_line_to_line(line1[0].x, line1[0].y, line1[1].x, line1[1].y,
                               line2[0].x, line2[0].y, line2[1].x, line2[1].y);
}

template <typename T>
inline T distance(const line<T, 3>& line1, const line<T, 3>& line2) {
  return distance_line_to_line(line1[0].x, line1[0].y, line1[0].z, line1[1].x,
                               line1[1].y, line1[1].z, line2[0].x, line2[0].y,
                               line2[0].z, line2[1].x, line2[1].y, line2[1].z);
}

template <typename T>
inline T distance(const segment<T, 2>& segment1,
                  const segment<T, 2>& segment2) {
  return distance_segment_to_segment(
      segment1[0].x, segment1[0].y, segment1[1].x, segment1[1].y, segment2[0].x,
      segment2[0].y, segment2[1].x, segment2[1].y);
}

template <typename T>
inline T distance(const segment<T, 3>& segment1,
                  const segment<T, 3>& segment2) {
  return distance_segment_to_segment(
      segment1[0].x, segment1[0].y, segment1[0].z, segment1[1].x, segment1[1].y,
      segment1[1].z, segment2[0].x, segment2[0].y, segment2[0].z, segment2[1].x,
      segment2[1].y, segment2[1].z);
}
...
inline T distance(const segment<T, 2>& segment, const rectangle<T>& rectangle) {
  return min(min(distance(segment, edge(rectangle, 0)),
                 distance(segment, edge(rectangle, 1))),
             min(distance(segment, edge(rectangle, 2)),
                 distance(segment, edge(rectangle, 3))));
}

template <typename T>
inline T distance(const segment<T, 2>& segment, const circle<T>& circle) {
  return distance(closest_point_on_circle_from_segment(circle, segment),
                  segment);
}

template <typename T>
inline T distance(const triangle<T, 2>& triangle1,
                  const triangle<T, 2>& triangle2) {
  T min_dist =
      min(minimum_distance_from_point_to_triangle(triangle1[0], triangle2),
          minimum_distance_from_point_to_triangle(triangle2[0], triangle1));

  for (std::size_t i = 1; i < triangle<T, 2>::PointCount; ++i) {
    if (is_equal(min_dist, T(0.0))) return min_dist;
...
template <typename T>
inline T distance(const triangle<T, 2>& triangle,
                  const rectangle<T>& rectangle) {
...
template <typename T>
inline T distance(const rectangle<T>& rectangle1,
                  const rectangle<T>& rectangle2) {
  if (intersect(rectangle1, rectangle2))
    ...
    if (rec1[1].y < rec2[0].y)
      return distance(make_segment(rec1[0].x, rec1[1].y, rec1[1].x, rec1[1].y),
                      make_segment(rec2[0].x, rec2[0].y, rec2[1].x, rec2[0].y));
    else if (rec1[0].y > rec2[1].y)
      return distance(make_segment(rec1[0].x, rec1[0].y, rec1[1].x, rec1[0].y),
                      make_segment(rec2[0].x, rec2[1].y, rec2[1].x, rec2[1].y));
    else if (rec1[1].x < rec2[0].x)
      return distance(make_segment(rec1[1].x, rec1[0].y, rec1[1].x, rec1[1].y),
                      make_segment(rec2[0].x, rec2[0].y, rec2[0].x, rec2[1].y));
    else if (rec1[0].x > rec2[1].x)
      return distance(make_segment(rec1[0].x, rec1[0].y, rec1[0].x, rec1[1].y),
...
inline T distance(const triangle<T, 2>& triangle, const circle<T>& circle) {
  if (intersect(triangle, circle))
    ...
    const point2d<T> point1 =
        closest_point_on_triangle_from_point(triangle, circle.x, circle.y);
    const point2d<T> point2 =
        closest_point_on_circle_from_point(circle, point1);
...
inline T distance(const sphere<T>& sphere1, const sphere<T>& sphere2) {
  const T dist = distance(sphere1.x, sphere1.y, sphere1.z, sphere2.x, sphere2.y,
                          sphere2.z);
...
template <typename T>
inline T lay_distance(const T& x1, const T& y1, const T& z1, const T& x2,
                      const T& y2, const T& z2) {
  const T dx = (x2 - x1);
  const T dy = (y2 - y1);
  const T dz = (z2 - z1);
...
inline T lay_distance(const point3d<T>& point1, const point3d<T>& point2) {
  return lay_distance(point1.x, point1.y, point1.z, point2.x, point2.y,
                      point2.z);
}

template <typename T>
inline T lay_distance(const point2d<T>& point, const triangle<T, 2>& triangle) {
  return lay_distance(point,
                      closest_point_on_triangle_from_point(triangle, point));
}
...
inline T lay_distance(const point3d<T>& point, const plane<T, 3>& plane) {
  return sqr((plane.normal.x * point.x + plane.normal.y * point.y +
              plane.normal.z * point.z) -
             plane.constant);
}

template <typename T>
inline T lay_distance(const segment<T, 2>& segment1,
                      const segment<T, 2>& segment2) {
...
template <typename T>
inline T lay_distance(const segment<T, 3>& segment1,
                      const segment<T, 3>& segment2) {
  return lay_distance_segment_to_segment(
      segment1[0].x, segment1[0].y, segment1[0].z, segment1[1].x, segment1[1].y,
      segment1[1].z, segment2[0].x, segment2[0].y, segment2[0].z, segment2[1].x,
...
inline T lay_distance(const segment<T, 2>& segment,
                      const triangle<T, 2>& triangle) {
  return min(
      min(lay_distance_segment_to_segment(
              segment[0].x, segment[0].y, segment[1].x, segment[1].y,
              triangle[0].x, triangle[0].y, triangle[1].x, triangle[1].y),
          lay_distance_segment_to_segment(
              segment[0].x, segment[0].y, segment[1].x, segment[1].y,
              triangle[1].x, triangle[1].y, triangle[2].x, triangle[2].y)),
      lay_distance_segment_to_segment(
          segment[0].x, segment[0].y, segment[1].x, segment[1].y, triangle[2].x,
          triangle[2].y, triangle[0].x, triangle[0].y));
}
...
inline T lay_distance(const segment<T, 3>& segment,
  ...
  return min(
      min(lay_distance_segment_to_segment(
              segment[0].x, segment[0].y, segment[0].z, segment[1].x,
              segment[1].y, segment[1].z, triangle[0].x, triangle[0].y,
              triangle[0].z, triangle[1].x, triangle[1].y, triangle[1].z),
          lay_distance_segment_to_segment(
              segment[0].x, segment[0].y, segment[0].z, segment[1].x,
              segment[1].y, segment[1].z, triangle[1].x, triangle[1].y,
              triangle[1].z, triangle[2].x, triangle[2].y, triangle[2].z)),
      lay_distance_segment_to_segment(
          segment[0].x, segment[0].y, segment[0].z, segment[1].x, segment[1].y,
          segment[1].z, triangle[2].x, triangle[2].y, triangle[2].z,
          triangle[0].x, triangle[0].y, triangle[0].z));
}

template <typename T>
inline T manhattan_distance(const T& x1, const T& y1, const T& x2,
                            const T& y2) {
  return abs(x2 - x1) + abs(y2 - y1);
}

template <typename T>
inline T manhattan_distance(const T& x1, const T& y1, const T& z1, const T& x2,
                            const T& y2, const T& z2) {
  return abs(x2 - x1) + abs(y2 - y1) + abs(z2 - z1);
}

template <typename T>
inline T manhattan_distance(const point2d<T>& point1,
                            const point2d<T>& point2) {
  return manhattan_distance(point1.x, point1.y, point2.x, point2.y);
}

template <typename T>
inline T manhattan_distance(const point3d<T>& point1,
                            const point3d<T>& point2) {
  return manhattan_distance(point1.x, point1.y, point1.z, point2.x, point2.y,
                            point2.z);
}
...
template <typename T>
inline T manhattan_distance(const circle<T>& circle1,
                            const circle<T>& circle2) {
  return manhattan_distance(circle1.x, circle1.y, circle2.x, circle2.y);
}

template <typename T>
inline T chebyshev_distance(const T& x1, const T& y1, const T& x2,
                            const T& y2) {
  return max(abs(x2 - x1), abs(y2 - y1));
}

template <typename T>
inline T chebyshev_distance(const T& x1, const T& y1, const T& z1, const T& x2,
                            const T& y2, const T& z2) {
  return max(max(abs(x2 - x1), abs(y2 - y1)), abs(z2 - z1));
}

template <typename T>
inline T chebyshev_distance(const point2d<T>& point1,
                            const point2d<T>& point2) {
  return chebyshev_distance(point1.x, point1.y, point2.x, point2.y);
}

template <typename T>
inline T chebyshev_distance(const point3d<T>& point1,
                            const point3d<T>& point2) {
  return chebyshev_distance(point1.x, point1.y, point1.z, point2.x, point2.y,
                            point2.z);
}
...
template <typename T>
inline T chebyshev_distance(const circle<T>& circle1,
                            const circle<T>& circle2) {
  return chebyshev_distance(circle1.x, circle1.y, circle2.x, circle2.y);
}

template <typename T>
inline T inverse_chebyshev_distance(const T& x1, const T& y1, const T& x2,
                                    const T& y2) {
  return min(abs(x2 - x1), abs(y2 - y1));
}

template <typename T>
inline T inverse_chebyshev_distance(const T& x1, const T& y1, const T& z1,
                                    const T& x2, const T& y2, const T& z2) {
  return min(min(abs(x2 - x1), abs(y2 - y1)), abs(z2 - z1));
}

template <typename T>
inline T inverse_chebyshev_distance(const point2d<T>& point1,
                                    const point2d<T>& point2) {
  return inverse_chebyshev_distance(point1.x, point1.y, point2.x, point2.y);
}

template <typename T>
inline T inverse_chebyshev_distance(const point3d<T>& point1,
                                    const point3d<T>& point2) {
  return inverse_chebyshev_distance(point1.x, point1.y, point1.z, point2.x,
                                    point2.y, point2.z);
}
...
template <typename T>
inline T inverse_chebyshev_distance(const circle<T>& circle1,
                                    const circle<T>& circle2) {
  return inverse_chebyshev_distance(circle1.x, circle1.y, circle2.x, circle2.y);
}

template <typename T>
inline point2d<T> minkowski_sum(const point2d<T>& point1,
                                const point2d<T>& point2) {
  return point1 + point2;
}

template <typename T>
inline polygon<T, 2> minkowski_sum(const rectangle<T>& rectangle1,
                                   const rectangle<T>& rectangle2) {
  polygon<T, 2> polygon;
  polygon.reserve(16);
...
template <typename T>
inline polygon<T, 2> minkowski_sum(const triangle<T, 2>& triangle1,
                                   const triangle<T, 2>& triangle2) {
  polygon<T, 2> polygon;
  polygon.reserve(9);
...
template <typename T>
inline polygon<T, 2> minkowski_sum(const quadix<T, 2>& quadix1,
...
template <typename T>
inline polygon<T, 2> minkowski_sum(const circle<T>& circle1,
                                   const circle<T>& circle2) {
  return minkowski_sum(make_polygon(circle1), make_polygon(circle2));
}

template <typename T>
inline polygon<T, 2> minkowski_sum(const triangle<T, 2>& triangle,
                                   const rectangle<T>& rectangle) {
  polygon<T, 2> polygon;
  polygon.reserve(12);
  ...
  for (std::size_t i = 0; i < wykobi::triangle<T, 2>::PointCount; ++i) {
    for (std::size_t j = 0; j < 4; ++j) {
      polygon.push_back(
          minkowski_sum(triangle[i], rectangle_corner(rectangle, j)));
    }
  }
...
template <typename T>
inline polygon<T, 2> minkowski_sum(const quadix<T, 2>& quadix,
                                   const circle<T>& circle) {
  wykobi::polygon<T, 2> polygon;
  wykobi::polygon<T, 2> circle_polygon = make_polygon(circle);
...
inline polygon<T, 2> minkowski_sum(const quadix<T, 2>& quadix,
  ...
  for (std::size_t i = 0; i < wykobi::quadix<T, 2>::PointCount; ++i) {
    for (std::size_t j = 0; j < 4; ++j) {
      polygon.push_back(
          minkowski_sum(quadix[i], rectangle_corner(rectangle, j)));
    }
  }
...
template <typename T>
inline polygon<T, 2> minkowski_sum(const rectangle<T>& rectangle,
                                   const circle<T>& circle) {
  wykobi::polygon<T, 2> polygon;
  wykobi::polygon<T, 2> circle_polygon = make_polygon(circle);
  polygon.reserve(1440);
  ...
  for (std::size_t i = 0; i < 4; ++i) {
    for (std::size_t j = 0; j < circle_polygon.size(); ++j) {
      polygon.push_back(
          minkowski_sum(rectangle_corner(rectangle, i), circle_polygon[j]));
    }
  }
...
template <typename T>
inline polygon<T, 2> minkowski_sum(const polygon<T, 2>& polygon1,
...
template <typename T>
inline point2d<T> minkowski_difference(const point2d<T>& point1,
                                       const point2d<T>& point2) {
  return make_point(point1.x - point2.x, point1.y - point2.y);
}

template <typename T>
inline polygon<T, 2> minkowski_difference(const rectangle<T>& rectangle1,
                                          const rectangle<T>& rectangle2) {
  polygon<T, 2> polygon;
  polygon.reserve(16);
  ...
  for (std::size_t i = 0; i < 4; ++i) {
    ...
    for (std::size_t j = 0; j < 4; ++j) {
      polygon.push_back(
          minkowski_difference(point, rectangle_corner(rectangle2, j)));
    }
  }
...
template <typename T>
inline polygon<T, 2> minkowski_difference(const triangle<T, 2>& triangle1,
                                          const triangle<T, 2>& triangle2) {
  polygon<T, 2> polygon;
  polygon.reserve(9);
...
template <typename T>
inline polygon<T, 2> minkowski_difference(const quadix<T, 2>& quadix1,
                                          const quadix<T, 2>& quadix2) {
  polygon<T, 2> polygon;
  polygon.reserve(16);
...
template <typename T>
inline polygon<T, 2> minkowski_difference(const circle<T>& circle1,
                                          const circle<T>& circle2) {
  return minkowski_difference(make_polygon(circle1), make_polygon(circle2));
}

template <typename T>
inline polygon<T, 2> minkowski_difference(const triangle<T, 2>& triangle,
                                          const rectangle<T>& rectangle) {
  polygon<T, 2> polygon;
  polygon.reserve(12);
  ...
  for (std::size_t i = 0; i < wykobi::triangle<T, 2>::PointCount; ++i) {
    for (std::size_t j = 0; j < 4; ++j) {
      polygon.push_back(
          minkowski_difference(triangle[i], rectangle_corner(rectangle, j)));
    }
  }
...
template <typename T>
inline polygon<T, 2> minkowski_difference(const quadix<T, 2>& quadix,
                                          const circle<T>& circle) {
  wykobi::polygon<T, 2> polygon;
  wykobi::polygon<T, 2> circle_polygon = make_polygon(circle);
...
inline polygon<T, 2> minkowski_difference(const quadix<T, 2>& quadix,
  ...
  for (std::size_t i = 0; i < wykobi::quadix<T, 2>::PointCount; ++i) {
    for (std::size_t j = 0; j < 4; ++j) {
      polygon.push_back(
          minkowski_difference(quadix[i], rectangle_corner(rectangle, j)));
    }
  }
...
template <typename T>
inline polygon<T, 2> minkowski_difference(const rectangle<T>& rectangle,
                                          const circle<T>& circle) {
  wykobi::polygon<T, 2> polygon;
  wykobi::polygon<T, 2> circle_polygon = make_polygon(circle);
  ...
  for (std::size_t i = 0; i < 4; ++i) {
    for (std::size_t j = 0; j < circle_polygon.size(); ++j) {
      polygon.push_back(minkowski_difference(rectangle_corner(rectangle, i),
                                             circle_polygon[j]));
    }
  }
...
template <typename T>
inline polygon<T, 2> minkowski_difference(const polygon<T, 2>& polygon1,
                                          const polygon<T, 2>& polygon2) {
  polygon<T, 2> polygon;
...
template <typename T>
inline T distance_segment_to_segment(const T& x1, const T& y1, const T& x2,
                                     const T& y2, const T& x3, const T& y3,
                                     const T& x4, const T& y4) {
...
inline T distance_segment_to_segment(const T& x1, const T& y1, const T& z1,
                                     ...
                                     const T& x3, const T& y3, const T& z3,
                                     const T& x4, const T& y4, const T& z4) {
  return sqrt(lay_distance_segment_to_segment(x1, y1, z1, x2, y2, z2, x3, y3,
                                              z3, x4, y4, z4));
}

template <typename T>
inline T lay_distance_segment_to_segment(const T& x1, const T& y1, const T& x2,
                                         const T& y2, const T& x3, const T& y3,
                                         const T& x4, const T& y4) {
  const T ux = x2 - x1;
  const T uy = y2 - y1;
...
template <typename T>
inline T distance_line_to_line(const T& x1, const T& y1, const T& x2,
                               const T& y2, const T& x3, const T& y3,
                               const T& x4, const T& y4) {
...
inline T distance_line_to_line(const T& x1, const T& y1, const T& z1,
                               ...
                               const T& x3, const T& y3, const T& z3,
                               const T& x4, const T& y4, const T& z4) {
  return sqrt(lay_distance_line_to_line(x1, y1, z1, x2, y2, z2, x3, y3, z3, x4,
                                        y4, z4));
}

template <typename T>
inline T lay_distance_line_to_line(const T& x1, const T& y1, const T& x2,
                                   const T& y2, const T& x3, const T& y3,
                                   const T& x4, const T& y4) {
  const T ux = x2 - x1;
  const T uy = y2 - y1;
...
template <typename T>
inline T lay_distance_from_point_to_circle_center(const point2d<T>& point,
                                                  const circle<T>& circle) {
  return lay_distance(point.x, point.y, circle.x, circle.y);
}

template <typename T>
inline T lay_distance_from_point_to_sphere_center(const point3d<T>& point,
                                                  const sphere<T>& sphere) {
  return lay_distance(point.x, point.y, point.z, sphere.x, sphere.y, sphere.z);
}

template <typename T>
inline T distance_from_point_to_circle_center(const point2d<T>& point,
                                              const circle<T>& circle) {
  return sqrt(lay_distance_from_point_to_circle_center(point, circle));
}

template <typename T>
inline T distance_from_point_to_sphere_center(const point3d<T>& point,
                                              const sphere<T>& sphere) {
...
template <typename T>
inline void project_point_t(const T& srcx, const T& srcy, const T& destx,
                            const T& desty, const T& t, T& nx, T& ny) {
...
template <typename T>
inline void project_point(const T& srcx, const T& srcy, const T& destx,
                          const T& desty, const T& dist, T& nx, T& ny) {
  project_point_t(srcx, srcy, destx, desty,
                  dist / distance(srcx, srcy, destx, desty), nx, ny);
}

template <typename T>
inline void project_point(const T& srcx, const T& srcy, const T& srcz,
                          const T& destx, const T& desty, const T& destz,
                          const T& dist, T& nx, T& ny, T& nz) {
  project_point_t(srcx, srcy, srcz, destx, desty, destz,
                  dist / distance(srcx, srcy, srcz, destx, desty, destz), nx,
                  ny, nz);
}

template <typename T>
inline void project_point(const T& px, const T& py, const T& angle,
...
template <typename T>
inline void project_point0(const T& px, const T& py, const T& distance, T& nx,
                           T& ny) {
  nx = px + distance;
  ny = py;
}
...
template <typename T>
inline void project_point45(const T& px, const T& py, const T& distance, T& nx,
                            T& ny) {
...
template <typename T>
inline void project_point90(const T& px, const T& py, const T& distance, T& nx,
                            T& ny) {
  nx = px;
  ny = py + distance;
}
...
template <typename T>
inline void project_point135(const T& px, const T& py, const T& distance, T& nx,
                             T& ny) {
  nx = px - T(0.70710678118654752440084436210485) * distance;
  ny = py + T(0.70710678118654752440084436210485) * distance;
}
...
template <typename T>
inline void project_point180(const T& px, const T& py, const T& distance, T& nx,
                             T& ny) {
  nx = px - distance;
  ny = py;
}
...
template <typename T>
inline void project_point225(const T& px, const T& py, const T& distance, T& nx,
                             T& ny) {
  nx = px - T(0.70710678118654752440084436210485) * distance;
  ny = py - T(0.70710678118654752440084436210485) * distance;
}
...
template <typename T>
inline void project_point270(const T& px, const T& py, const T& distance, T& nx,
                             T& ny) {
  nx = px;
  ny = py - distance;
}
...
template <typename T>
inline void project_point315(const T& px, const T& py, const T& distance, T& nx,
                             T& ny) {
  nx = px + T(0.70710678118654752440084436210485) * distance;
  ny = py - T(0.70710678118654752440084436210485) * distance;
}
...
inline point2d<T> project_point_t(const point2d<T>& source_point,
  ...
  project_point_t(source_point.x, source_point.y, destination_point.x,
                  destination_point.y, t, point_.x, point_.y);
...
inline point2d<T> project_point(const point2d<T>& source_point,
  ...
  project_point(source_point.x, source_point.y, destination_point.x,
                destination_point.y, distance, point_.x, point_.y);
...
inline point3d<T> project_point(const point3d<T>& source_point,
  ...
  project_point(source_point.x, source_point.y, source_point.z,
                destination_point.x, destination_point.y, destination_point.z,
                distance, point_.x, point_.y, point_.z);

  return point_;
}

template <typename T>
inline point2d<T> project_point(const point2d<T>& point, const T& angle,
                                const T& distance) {
  point2d<T> point_;
...
template <typename T>
inline point2d<T> project_object(const point2d<T>& point, const T& angle,
                                 const T& distance) {
  return project_point(point, angle, distance);
}

template <typename T>
inline segment<T, 2> project_object(const segment<T, 2>& segment,
                                    const T& angle, const T& distance) {
  wykobi::segment<T, 2> segment_;
...
template <typename T>
inline triangle<T, 2> project_object(const triangle<T, 2>& triangle,
                                     const T& angle, const T& distance) {
  wykobi::triangle<T, 2> triangle_;
...
template <typename T>
inline quadix<T, 2> project_object(const quadix<T, 2>& quadix, const T& angle,
                                   const T& distance) {
  wykobi::quadix<T, 2> quadix_;
...
template <typename T>
inline circle<T> project_object(const circle<T>& circle, const T& angle,
                                const T& distance) {
  wykobi::circle<T> circle_ = circle;
...
template <typename T>
inline polygon<T, 2> project_object(const polygon<T, 2>& polygon,
                                    const T& angle, const T& distance) {
  wykobi::polygon<T, 2> polygon_;
...
template <typename T>
inline segment<T, 2> project_onto_axis(const point2d<T>& point,
                                       const line<T, 2>& axis) {
...
template <typename T>
inline segment<T, 2> project_onto_axis(const triangle<T, 2>& triangle,
                                       const line<T, 2>& axis) {
...
template <typename T>
inline segment<T, 2> project_onto_axis(const rectangle<T>& rectangle,
                                       const line<T, 2>& axis) {
  std::vector<point2d<T> > point_list;

  point_list.reserve(4);

  point_list.push_back(closest_point_on_line_from_point(
      axis, make_point(rectangle[0].x, rectangle[0].y)));
  point_list.push_back(closest_point_on_line_from_point(
      axis, make_point(rectangle[1].x, rectangle[0].y)));
  point_list.push_back(closest_point_on_line_from_point(
      axis, make_point(rectangle[1].x, rectangle[1].y)));
  point_list.push_back(closest_point_on_line_from_point(
      axis, make_point(rectangle[0].x, rectangle[1].y)));
...
template <typename T>
inline segment<T, 2> project_onto_axis(const quadix<T, 2>& quadix,
                                       const line<T, 2>& axis) {
  std::vector<point2d<T> > point_list;
...
template <typename T>
inline segment<T, 2> project_onto_axis(const circle<T>& circle,
                                       const line<T, 2>& axis) {
  ...
  point_list.push_back(
      closest_point_on_line_from_point(axis, make_point(circle.x, circle.y)));
  point_list.push_back(closest_point_on_line_from_point(
      axis, make_point(point_list.front().x + (v.x * circle.radius),
...
template <typename T>
inline segment<T, 2> project_onto_axis(const polygon<T, 2>& polygon,
                                       const line<T, 2>& axis) {
  if (polygon.size() == 0) return degenerate_segment2d<T>();
...
template <typename T>
inline segment<T, 3> project_onto_axis(const point3d<T>& point,
                                       const line<T, 3>& axis) {
...
template <typename T>
inline segment<T, 3> project_onto_axis(const triangle<T, 3>& triangle,
                                       const line<T, 3>& axis) {
...
template <typename T>
inline segment<T, 3> project_onto_axis(const box<T, 3>& box,
                                       const line<T, 3>& axis) {
  std::vector<point3d<T> > point_list;
  ...
  point_list.push_back(closest_point_on_line_from_point(
      axis, make_point(box[0].x, box[0].y, box[0].z)));
  point_list.push_back(closest_point_on_line_from_point(
      axis, make_point(box[1].x, box[0].y, box[0].z)));
  point_list.push_back(closest_point_on_line_from_point(
      axis, make_point(box[1].x, box[1].y, box[0].z)));
  point_list.push_back(closest_point_on_line_from_point(
      axis, make_point(box[0].x, box[1].y, box[0].z)));
  point_list.push_back(closest_point_on_line_from_point(
      axis, make_point(box[0].x, box[0].y, box[1].z)));
  point_list.push_back(closest_point_on_line_from_point(
      axis, make_point(box[1].x, box[0].y, box[1].z)));
  point_list.push_back(closest_point_on_line_from_point(
      axis, make_point(box[1].x, box[1].y, box[1].z)));
  point_list.push_back(closest_point_on_line_from_point(
      axis, make_point(box[0].x, box[1].y, box[1].z)));
...
template <typename T>
inline segment<T, 3> project_onto_axis(const quadix<T, 3>& quadix,
                                       const line<T, 3>& axis) {
  std::vector<point3d<T> > point_list;
...
template <typename T>
inline segment<T, 3> project_onto_axis(const sphere<T>& sphere,
                                       const line<T, 3>& axis) {
  ...
  point_list.push_back(closest_point_on_line_from_point(
      axis, make_point(sphere.x, sphere.y, sphere.z)));

  point_list.push_back(closest_point_on_line_from_point(
      axis, make_point(point_list.front().x + (v.x * sphere.radius),
...
template <typename T>
inline segment<T, 3> project_onto_axis(const polygon<T, 3>& polygon,
                                       const line<T, 3>& axis) {
  std::vector<point3d<T> > point_list;
...
template <typename T>
inline void calculate_bezier_coefficients(
    const quadratic_bezier<T, 2>& bezier,
    bezier_coefficients<T, 2, eQuadraticBezier>& coeffs) {
  calculate_bezier_coefficients(bezier, coeffs.value[0].x, coeffs.value[0].y,
...
inline void calculate_bezier_coefficients(
  ...
  calculate_bezier_coefficients(bezier, coeffs.value[0].x, coeffs.value[0].y,
                                coeffs.value[0].z, coeffs.value[1].x,
                                coeffs.value[1].y, coeffs.value[1].z);
}
...
inline void calculate_bezier_coefficients(
  ...
  calculate_bezier_coefficients(
      bezier, coeffs.value[0].x, coeffs.value[0].y, coeffs.value[0].z,
...
inline point2d<T> create_point_on_bezier(const point2d<T>& start_point,
                                         const T& ax, const T& bx, const T& ay,
                                         const T& by, const T& t) {
  const T tsqr = t * t;

  return make_point((ax * tsqr) + (bx * t) + start_point.x,
...
inline point3d<T> create_point_on_bezier(const point3d<T>& start_point,
                                         const T& ax, const T& bx, const T& ay,
                                         const T& by, const T& az, const T& bz,
                                         const T& t) {
  const T tsqr = t * t;
...
inline point2d<T> create_point_on_bezier(const point2d<T>& start_point,
  ...
  return make_point((ax * tcube) + (bx * tsqr) + (cx * t) + start_point.x,
...
template <typename T>
inline point2d<T> create_point_on_bezier(
    const point2d<T>& start_point,
    const bezier_coefficients<T, 2, eQuadraticBezier>& coeffs, const T& t) {
  return create_point_on_bezier(start_point, coeffs.value[0].x,
                                coeffs.value[0].y, coeffs.value[1].x,
                                coeffs.value[1].y, t);
}

template <typename T>
inline point3d<T> create_point_on_bezier(
    const point3d<T>& start_point,
    const bezier_coefficients<T, 3, eQuadraticBezier>& coeffs, const T& t) {
  return create_point_on_bezier(
      start_point, coeffs.value[0].x, coeffs.value[0].y, coeffs.value[0].z,
...
inline point2d<T> create_point_on_bezier(
    const point2d<T>& start_point,
    const bezier_coefficients<T, 2, eCubicBezier>& coeffs, const T& t) {
  return create_point_on_bezier(
      start_point, coeffs.value[0].x, coeffs.value[0].y, coeffs.value[1].x,
      coeffs.value[1].y, coeffs.value[2].x, coeffs.value[2].y, t);
}

template <typename T>
inline point3d<T> create_point_on_bezier(
    const point3d<T>& start_point,
    const bezier_coefficients<T, 3, eCubicBezier>& coeffs, const T& t) {
  return create_point_on_bezier(
      start_point, coeffs.value[0].x, coeffs.value[0].y, coeffs.value[0].z,
      coeffs.value[1].x, coeffs.value[1].y, coeffs.value[1].z,
...
template <typename T, typename OutputIterator>
inline void generate_bezier(const quadratic_bezier<T, 2>& bezier,
                            OutputIterator out,
...
template <typename T, typename OutputIterator>
inline void generate_bezier(const quadratic_bezier<T, 3>& bezier,
                            OutputIterator out,
                            const std::size_t& point_count) {
  if (0 == point_count) return;
...
template <typename T, typename OutputIterator>
inline void generate_bezier(const cubic_bezier<T, 2>& bezier,
                            OutputIterator out,
                            const std::size_t& point_count) {
  if (0 == point_count) return;
...
template <typename T, typename OutputIterator>
inline void generate_bezier(const cubic_bezier<T, 3>& bezier,
                            OutputIterator out,
                            const std::size_t& point_count) {
  if (0 == point_count) return;
  ...
  for (std::size_t i = 0; i < point_count; t += dt, ++i) {
    (*out++) = create_point_on_bezier(bezier[0], ax, bx, cx, ay, by, cy, az, bz,
                                      cz, t);
  }
}

template <typename T>
inline T bezier_curve_length(const quadratic_bezier<T, 2>& bezier,
                             const std::size_t& point_count) {
...
template <typename T>
inline T bezier_curve_length(const quadratic_bezier<T, 3>& bezier,
                             const std::size_t& point_count) {
...
template <typename T>
inline T bezier_curve_length(const cubic_bezier<T, 2>& bezier,
                             const std::size_t& point_count) {
  std::vector<point2d<T> > curve;
...
template <typename T>
inline T bezier_curve_length(const cubic_bezier<T, 3>& bezier,
                             const std::size_t& point_count) {
  std::vector<point3d<T> > curve;
...
template <typename T>
inline quadix<T, 2> bezier_convex_hull(const cubic_bezier<T, 2>& bezier) {
  if (orientation(bezier[0], bezier[2], bezier[1]) !=
      orientation(bezier[0], bezier[2], bezier[3]))
    return make_quadix(bezier[0], bezier[1], bezier[2], bezier[3]);
  else if (orientation(bezier[0], bezier[3], bezier[1]) !=
           orientation(bezier[0], bezier[3], bezier[2]))
...
template <typename T>
inline segment<T, 2> center_at_location(const segment<T, 2>& segment,
                                        const T& x, const T& y) {
  T cx = T(0.0);
  T cy = T(0.0);
...
template <typename T>
inline segment<T, 3> center_at_location(const segment<T, 3>& segment,
...
template <typename T>
inline triangle<T, 2> center_at_location(const triangle<T, 2>& triangle,
                                         const T& x, const T& y) {
  T cx = T(0.0);
  T cy = T(0.0);
...
template <typename T>
inline rectangle<T> center_at_location(const rectangle<T>& rectangle,
                                       const T& x, const T& y) {
  T cx = T(0.0);
  T cy = T(0.0);
...
template <typename T>
inline box<T, 3> center_at_location(const box<T, 3>& box, const T& x,
                                    const T& y, const T& z) {
  T cx = T(0.0);
  T cy = T(0.0);
  T cz = T(0.0);
...
template <typename T>
inline quadix<T, 2> center_at_location(const quadix<T, 2>& quadix, const T& x,
                                       const T& y) {
  T cx = T(0.0);
  T cy = T(0.0);
...
template <typename T>
inline circle<T> center_at_location(const circle<T>& circle, const T& x,
                                    const T& y) {
...
template <typename T>
inline polygon<T, 2> center_at_location(const polygon<T, 2>& polygon,
                                        const T& x, const T& y) {
  T cx = T(0.0);
  T cy = T(0.0);
...
template <typename T>
inline box<T, 3> center_at_location(const box<T, 3>& box,
                                    const point3d<T>& center_point) {
  return center_at_location(box, center_point.x, center_point.y,
                            center_point.z);
}

template <typename T>
inline quadix<T, 2> center_at_location(const quadix<T, 2>& quadix,
                                       const point2d<T>& center_point) {
  return center_at_location(quadix, center_point.x, center_point.y);
}

template <typename T>
inline circle<T> center_at_location(const circle<T>& circle,
                                    const point2d<T>& center_point) {
...
template <typename T>
inline void shorten_segment(T& x1, T& y1, T& z1, T& x2, T& y2, T& z2,
                            const T& amount) {
  const T segment_length = distance(x1, y1, x2, y2);
...
template <typename T>
inline segment<T, 2> shorten_segment(const segment<T, 2>& segment,
                                     const T& amount) {
  wykobi::segment<T, 2> segment_ = segment;
  shorten_segment(segment_[0].x, segment_[0].y, segment_[1].x, segment_[1].y,
                  amount);
  return segment_;
}

template <typename T>
inline segment<T, 3> shorten_segment(const segment<T, 3>& segment,
                                     const T& amount) {
  wykobi::segment<T, 3> segment_ = segment;
  shorten_segment(segment_[0].x, segment_[0].y, segment_[0].z, segment_[1].x,
                  segment_[1].y, segment_[1].z, amount);
  return segment_;
}
...
template <typename T>
inline void lengthen_segment(T& x1, T& y1, T& z1, T& x2, T& y2, T& z2,
                             const T& amount) {
  T cx = T(0.0);
  T cy = T(0.0);
  T cz = T(0.0);
...
template <typename T>
inline segment<T, 2> lengthen_segment(const segment<T, 2>& segment,
                                      const T& amount) {
  wykobi::segment<T, 2> segment_ = segment;
  lengthen_segment(segment_[0].x, segment_[0].y, segment_[1].x, segment_[1].y,
                   amount);
  return segment_;
}

template <typename T>
inline segment<T, 3> lengthen_segment(const segment<T, 3>& segment,
                                      const T& amount) {
  wykobi::segment<T, 3> segment_ = segment;
  lengthen_segment(segment_[0].x, segment_[0].y, segment_[0].z, segment_[1].x,
                   segment_[1].y, segment_[1].z, amount);
  return segment_;
}
...
template <typename T>
inline bool clip(const T& x1, const T& y1, const T& x2, const T& y2,
                 const T& x3, const T& y3, const T& x4, const T& y4, T& cx1,
                 T& cy1, T& cx2, T& cy2) {
...
template <typename T>
inline bool clip(const T& x1, const T& y1, const T& z1, const T& x2,
                 const T& y2, const T& z2, const T& x3, const T& y3,
                 const T& z3, const T& x4, const T& y4, const T& z4, T& cx1,
                 T& cy1, T& cz1, T& cx2, T& cy2, T& cz2) {
...
template <typename T>
inline bool clip(const segment<T, 2>& src_segment,
                 const rectangle<T>& rectangle, segment<T, 2>& csegment) {
  bool result = false;
  T x = T(0.0);
  T y = T(0.0);
...
template <typename T>
inline bool clip(const segment<T, 2>& src_segment,
                 const triangle<T, 2>& triangle, segment<T, 2>& csegment) {
  ...
  if (intersect(src_segment, edge(triangle, 0), csegment[pos].x,
                csegment[pos].y))
    pos++;

  if (intersect(src_segment, edge(triangle, 1), csegment[pos].x,
                csegment[pos].y))
    pos++;

  if ((pos < 2) && intersect(src_segment, edge(triangle, 2), csegment[pos].x,
                             csegment[pos].y))
    pos++;
...
template <typename T>
inline bool clip(const segment<T, 2>& src_segment, const quadix<T, 2>& quadix,
  ...
  if ((pos < 2) && (intersect(src_segment, edge(quadix, 2), csegment[pos].x,
                              csegment[pos].y)))
    pos++;
  if ((pos < 2) && (intersect(src_segment, edge(quadix, 3), csegment[pos].x,
                              csegment[pos].y)))
    pos++;
...
template <typename T>
inline bool clip(const segment<T, 2>& src_segment, const circle<T>& circle,
                 segment<T, 2>& csegment) {
...
template <typename T>
inline bool clip(const rectangle<T>& rectangle1, const rectangle<T>& rectangle2,
                 rectangle<T>& crectangle) {
  return clip(rectangle1[0].x, rectangle1[0].y, rectangle1[1].x,
              rectangle1[1].y, rectangle2[0].x, rectangle2[0].y,
              rectangle2[1].x, rectangle2[1].y, crectangle[0].x,
              crectangle[0].y, crectangle[1].x, crectangle[1].y);
}

template <typename T>
inline bool clip(const box<T, 3>& box1, const box<T, 3>& box2,
                 box<T, 3>& cbox) {
...
template <typename T>
inline T area(const point2d<T>& point1, const point2d<T>& point2,
              const point2d<T>& point3) {
...
template <typename T>
inline T area(const point3d<T>& point1, const point3d<T>& point2,
              const point3d<T>& point3) {
...
inline T area(const quadix<T, 3>& quadix) {
  return (area(make_triangle(quadix[0], quadix[1], quadix[2])) +
          area(make_triangle(quadix[2], quadix[3], quadix[0])));
}

template <typename T>
inline T area(const rectangle<T>& rectangle) {
  return abs(rectangle[1].x - rectangle[0].x) *
...
template <typename T>
inline T perimeter(const point2d<T>& point1, const point2d<T>& point2,
                   const point2d<T>& point3) {
...
template <typename T>
inline T perimeter(const point3d<T>& point1, const point3d<T>& point2,
                   const point3d<T>& point3) {
  return distance(point1, point2) + distance(point2, point3) +
         distance(point3, point1);
}
...
inline T perimeter(const quadix<T, 2>& quadix) {
  return distance(quadix[0], quadix[1]) + distance(quadix[1], quadix[2]) +
         distance(quadix[2], quadix[3]) + distance(quadix[3], quadix[0]);
}
...
inline T perimeter(const rectangle<T>& rectangle) {
  return T(2.0) * (abs(rectangle[1].x - rectangle[0].x) +
                   abs(rectangle[1].y - rectangle[0].y));
}
...
template <typename T>
inline void rotate(const T& rotation_angle, const T& x, const T& y, T& nx,
                   T& ny) {
...
template <typename T>
inline void rotate(const T& rotation_angle, const T& x, const T& y, const T& ox,
                   const T& oy, T& nx, T& ny) {
...
inline point2d<T> rotate(const T& rotation_angle, const point2d<T>& point,
  ...
  point2d<T> point_;
  rotate(rotation_angle, point.x, point.y, opoint.x, opoint.y, point_.x,
         point_.y);
  return point_;
}

template <typename T>
inline segment<T, 2> rotate(const T& rotation_angle,
                            const segment<T, 2>& segment) {
  wykobi::segment<T, 2> segment_;
...
template <typename T>
inline triangle<T, 2> rotate(const T& rotation_angle,
                             const triangle<T, 2>& triangle) {
  wykobi::triangle<T, 2> triangle_;
...
template <typename T>
inline quadix<T, 2> rotate(const T& rotation_angle,
                           const quadix<T, 2>& quadix) {
  wykobi::quadix<T, 2> quadix_;
...
template <typename T>
inline polygon<T, 2> rotate(const T& rotation_angle,
                            const polygon<T, 2>& polygon) {
  wykobi::polygon<T, 2> polygon_;
...
template <typename T>
inline void rotate(const T& rx, const T& ry, const T& rz, const T& x,
                   const T& y, const T& z, T& nx, T& ny, T& nz) {
...
template <typename T>
inline void rotate(const T& rx, const T& ry, const T& rz, const T& x,
                   const T& y, const T& z, const T& ox, const T& oy,
                   const T& oz, T& nx, T& ny, T& nz) {
...
template <typename T>
inline point3d<T> rotate(const T& rx, const T& ry, const T& rz,
                         const point3d<T>& point) {
  point3d<T> point_;
...
template <typename T>
inline point3d<T> rotate(const T& rx, const T& ry, const T& rz,
                         const point3d<T>& point, const point3d<T>& opoint) {
  point3d<T> point_;
  rotate(rx, ry, rz, point.x, point.y, point.z, opoint.x, opoint.y, opoint.z,
         point_.x, point_.y, point_.z);
  return point_;
}

template <typename T>
inline segment<T, 3> rotate(const T& rx, const T& ry, const T& rz,
                            const segment<T, 3>& segment) {
  wykobi::segment<T, 3> segment_;
...
template <typename T>
inline triangle<T, 3> rotate(const T& rx, const T& ry, const T& rz,
                             const triangle<T, 3>& triangle) {
  wykobi::triangle<T, 3> triangle_;
...
template <typename T>
inline quadix<T, 3> rotate(const T& rx, const T& ry, const T& rz,
...
template <typename T>
inline polygon<T, 3> rotate(const T& rx, const T& ry, const T& rz,
...
template <typename T>
inline void fast_rotate(const trig_luts<T>& lut, const int rotation_angle,
...
template <typename T>
inline void fast_rotate(const trig_luts<T>& lut, const int rotation_angle,
                        const T& x, const T& y, const T& ox, const T& oy, T& nx,
                        T& ny) {
...
template <typename T>
inline point2d<T> fast_rotate(const trig_luts<T>& lut, const int rotation_angle,
                              const point2d<T>& point) {
  point2d<T> point_;

  fast_rotate(lut, rotation_angle, point.x, point.y, point_.x, point_.y);
...
inline point2d<T> fast_rotate(const trig_luts<T>& lut, const int rotation_angle,
  ...
  fast_rotate(lut, rotation_angle, point.x, point.y, opoint.x, opoint.y,
              point_.x, point_.y);
...
template <typename T>
inline void fast_rotate(const trig_luts<T>& lut, const int rx, const int ry,
                        const int rz, const T& x, const T& y, const T& z, T& nx,
                        T& ny, T& nz) {
  int rx_ = rx % 360;
  int ry_ = ry % 360;
  int rz_ = rz % 360;
...
template <typename T>
inline void fast_rotate(const trig_luts<T>& lut, const int rx, const int ry,
                        const int rz, const T& x, const T& y, const T& z,
                        const T& ox, const T& oy, const T& oz, T& nx, T& ny,
                        T& nz) {
...
template <typename T>
inline point3d<T> fast_rotate(const trig_luts<T>& lut, const int rx,
                              const int ry, const int rz,
                              const point3d<T>& point) {
  point3d<T> point_;

  fast_rotate(lut, rx, ry, rz, point.x, point.y, point.z, point_.x, point_.y,
              point_.z);
...
inline point3d<T> fast_rotate(const trig_luts<T>& lut, const int rx,
  ...
  fast_rotate(lut, rx, ry, rz, point.x, point.y, point.z, opoint.x, opoint.y,
              opoint.z, point_.x, point_.y, point_.z);

  return point_;
}

template <typename T>
inline segment<T, 3> fast_rotate(const trig_luts<T>& lut, const int rx,
                                 const int ry, const int rz,
                                 const segment<T, 3>& segment) {
  wykobi::segment<T, 3> segment_;
...
template <typename T>
inline triangle<T, 3> fast_rotate(const trig_luts<T>& lut, const int rx,
                                  const int ry, const int rz,
                                  const triangle<T, 3>& triangle) {
  wykobi::triangle<T, 3> triangle_;
...
template <typename T>
inline quadix<T, 3> fast_rotate(const trig_luts<T>& lut, const int rx,
                                const int ry, const int rz,
                                const quadix<T, 3>& quadix) {
  wykobi::quadix<T, 3> quadix_;
...
template <typename T>
inline polygon<T, 3> fast_rotate(const trig_luts<T>& lut, const int rx,
                                 const int ry, const int rz,
                                 const polygon<T, 3>& polygon) {
  wykobi::polygon<T, 3> polygon_;
...
template <typename T>
inline segment<T, 2> translate(const T& dx, const T& dy,
                               const segment<T, 2>& segment) {
  wykobi::segment<T, 2> segment_;
...
template <typename T>
inline triangle<T, 2> translate(const T& dx, const T& dy,
                                const triangle<T, 2>& triangle) {
  wykobi::triangle<T, 2> triangle_;
...
template <typename T>
inline quadix<T, 2> translate(const T& dx, const T& dy,
                              const quadix<T, 2>& quadix) {
  wykobi::quadix<T, 2> quadix_;
...
template <typename T>
inline rectangle<T> translate(const T& dx, const T& dy,
                              const rectangle<T>& rectangle) {
  wykobi::rectangle<T> rectangle_;
...
template <typename T>
inline polygon<T, 2> translate(const T& dx, const T& dy,
                               const polygon<T, 2>& polygon) {
  wykobi::polygon<T, 2> polygon_;
...
template <typename T>
inline triangle<T, 2> translate(const T& delta,
                                const triangle<T, 2>& triangle) {
...
template <typename T>
inline segment<T, 2> translate(const vector2d<T>& v,
                               const segment<T, 2>& segment) {
  return translate(v.x, v.y, segment);
}

template <typename T>
inline triangle<T, 2> translate(const vector2d<T>& v,
                                const triangle<T, 2>& triangle) {
  return translate(v.x, v.y, triangle);
}

template <typename T>
inline quadix<T, 2> translate(const vector2d<T>& v,
                              const quadix<T, 2>& quadix) {
  return translate(v.x, v.y, quadix);
}

template <typename T>
inline rectangle<T> translate(const vector2d<T>& v,
                              const rectangle<T>& rectangle) {
...
template <typename T>
inline polygon<T, 2> translate(const vector2d<T>& v,
                               const polygon<T, 2>& polygon) {
  return translate(v.x, v.y, polygon);
}

template <typename T>
inline point3d<T> translate(const T& dx, const T& dy, const T& dz,
                            const point3d<T>& point) {
  point3d<T> point_;
...
template <typename T>
inline line<T, 3> translate(const T& dx, const T& dy, const T& dz,
                            const line<T, 3>& line) {
  wykobi::line<T, 3> line_;
...
template <typename T>
inline segment<T, 3> translate(const T& dx, const T& dy, const T& dz,
                               const segment<T, 3>& segment) {
  wykobi::segment<T, 3> segment_;
...
template <typename T>
inline triangle<T, 3> translate(const T& dx, const T& dy, const T& dz,
                                const triangle<T, 3>& triangle) {
  wykobi::triangle<T, 3> triangle_;
...
template <typename T>
inline quadix<T, 3> translate(const T& dx, const T& dy, const T& dz,
                              const quadix<T, 3>& quadix) {
  wykobi::quadix<T, 3> quadix_;
...
template <typename T>
inline box<T, 3> translate(const T& dx, const T& dy, const T& dz,
                           const box<T, 3>& box) {
  wykobi::box<T, 3> box_;
...
template <typename T>
inline sphere<T> translate(const T& dx, const T& dy, const T& dz,
                           const sphere<T>& sphere) {
...
template <typename T>
inline polygon<T, 3> translate(const T& dx, const T& dy, const T& dz,
                               const polygon<T, 3>& polygon) {
  wykobi::polygon<T, 3> polygon_;
...
template <typename T>
inline triangle<T, 3> translate(const T& delta,
                                const triangle<T, 3>& triangle) {
...
template <typename T>
inline segment<T, 3> translate(const vector3d<T>& v,
                               const segment<T, 3>& segment) {
  return translate(v.x, v.y, v.z, segment);
}

template <typename T>
inline triangle<T, 3> translate(const vector3d<T>& v,
                                const triangle<T, 3>& triangle) {
  return translate(v.x, v.y, v.z, triangle);
}

template <typename T>
inline quadix<T, 3> translate(const vector3d<T>& v,
                              const quadix<T, 3>& quadix) {
...
template <typename T>
inline polygon<T, 3> translate(const vector3d<T>& v,
                               const polygon<T, 3>& polygon) {
...
template <typename T>
inline segment<T, 2> scale(const T& dx, const T& dy,
                           const segment<T, 2>& segment) {
  wykobi::segment<T, 2> segment_;
...
template <typename T>
inline triangle<T, 2> scale(const T& dx, const T& dy,
                            const triangle<T, 2>& triangle) {
  wykobi::triangle<T, 2> triangle_;
...
template <typename T>
inline quadix<T, 2> scale(const T& dx, const T& dy,
                          const quadix<T, 2>& quadix) {
  wykobi::quadix<T, 2> quadix_;
...
template <typename T>
inline rectangle<T> scale(const T& dx, const T& dy,
                          const rectangle<T>& rectangle) {
  wykobi::rectangle<T> rectangle_;
...
template <typename T>
inline polygon<T, 2> scale(const T& dx, const T& dy,
                           const polygon<T, 2>& polygon) {
  wykobi::polygon<T, 2> polygon_;
...
template <typename T>
inline point3d<T> scale(const T& dx, const T& dy, const T& dz,
                        const point3d<T>& point) {
  point3d<T> point_;
...
template <typename T>
inline line<T, 3> scale(const T& dx, const T& dy, const T& dz,
                        const line<T, 3>& line) {
  wykobi::line<T, 3> line_;
...
template <typename T>
inline segment<T, 3> scale(const T& dx, const T& dy, const T& dz,
                           const segment<T, 3>& segment) {
  wykobi::segment<T, 3> segment_;
...
template <typename T>
inline triangle<T, 3> scale(const T& dx, const T& dy, const T& dz,
                            const triangle<T, 3>& triangle) {
  wykobi::triangle<T, 3> triangle_;
...
template <typename T>
inline quadix<T, 3> scale(const T& dx, const T& dy, const T& dz,
                          const quadix<T, 3>& quadix) {
  wykobi::quadix<T, 3> quadix_;
...
template <typename T>
inline box<T, 3> scale(const T& dx, const T& dy, const T& dz,
                       const box<T, 3>& box) {
  wykobi::box<T, 3> box_;
...
template <typename T>
inline polygon<T, 3> scale(const T& dx, const T& dy, const T& dz,
                           const polygon<T, 3>& polygon) {
  wykobi::polygon<T, 3> polygon_;
...
inline box<T, 3> aabb(const sphere<T>& sphere) {
  return make_box(sphere.x - sphere.radius, sphere.y - sphere.radius,
                  sphere.z - sphere.radius, sphere.x + sphere.radius,
                  sphere.y + sphere.radius, sphere.z + sphere.radius);
}
...
template <typename T>
inline void aabb(const segment<T, 3>& segment, T& x1, T& y1, T& z1, T& x2,
                 T& y2, T& z2) {
...
template <typename T>
inline void aabb(const triangle<T, 3>& triangle, T& x1, T& y1, T& z1, T& x2,
                 T& y2, T& z2) {
...
template <typename T>
inline void aabb(const box<T, 3>& box, T& x1, T& y1, T& z1, T& x2, T& y2,
                 T& z2) {
...
template <typename T>
inline void aabb(const quadix<T, 3>& quadix, T& x1, T& y1, T& z1, T& x2, T& y2,
                 T& z2) {
...
template <typename T>
inline void aabb(const sphere<T>& sphere, T& x1, T& y1, T& z1, T& x2, T& y2,
                 T& z2) {
...
template <typename T>
inline void aabb(const polygon<T, 3>& polygon, T& x1, T& y1, T& z1, T& x2,
                 T& y2, T& z2) {
...
template <typename T>
inline rectangle<T> update_rectangle(const rectangle<T>& rectangle,
                                     point2d<T>& point) {
...
inline box<T, 3> update_box(const box<T, 3>& box, point3d<T>& point) {
  if (!point_in_box(point, box)) {
    return make_box(
        min(box[0].x, box[1].x, point.x), min(box[0].y, box[1].y, point.y),
        min(box[0].z, box[1].z, point.z), max(box[0].x, box[1].x, point.x),
        max(box[0].y, box[1].y, point.y), max(box[0].z, box[1].z, point.z));
  } else
    return box;
}
...
inline circle<T> update_circle(const circle<T>& circle, point2d<T>& point) {
  ...
  if (dist2 > sqr(circle.radius)) {
    ...
    return make_circle(circle.x + (d.x * ratio), circle.y + (d.y * ratio),
                       new_radius);
  } else
    return circle;
}
...
inline sphere<T> update_sphere(const sphere<T>& sphere, point3d<T>& point) {
  ...
  if (dist2 > sqr(sphere.radius)) {
    ...
    return make_sphere(sphere.x + (d.x * ratio), sphere.y + (d.y * ratio),
                       sphere.z + (d.z * ratio), new_radius);
  } else
    return sphere;
}

template <typename T>
inline point2d<T> generate_point_on_segment(const segment<T, 2>& segment,
                                            const T& t) {
  if ((t < T(0.0)) || (t > T(1.0))) {
    return degenerate_point2d<T>();
  }
...
template <typename T>
inline point3d<T> generate_point_on_segment(const segment<T, 3>& segment,
                                            const T& t) {
  if ((t < T(0.0)) || (t > T(1.0))) {
    return degenerate_point3d<T>();
  }
...
inline point2d<T> generate_random_point(const quadix<T, 2>& quadix) {
  ...
  return make_point(((r1 * quadix[0].x) + (r2 * quadix[1].x) +
                     (r3 * quadix[2].x) + (r4 * quadix[3].x)) *
                        T(0.25),
                    ((r1 * quadix[0].y) + (r2 * quadix[1].y) +
                     (r3 * quadix[2].y) + (r4 * quadix[3].y)) *
                        T(0.25));
}
...
inline point3d<T> generate_random_point(const quadix<T, 3>& quadix) {
  ...
  return make_point(((r1 * quadix[0].x) + (r2 * quadix[1].x) +
                    ...
                    ((r1 * quadix[0].y) + (r2 * quadix[1].y) +
                     (r3 * quadix[2].y) + (r4 * quadix[3].y)) *
                        T(0.25),
                    ((r1 * quadix[0].z) + (r2 * quadix[1].z) +
                     (r3 * quadix[2].z) + (r4 * quadix[3].z)) *
                        T(0.25));
}

template <typename T>
inline point2d<T> generate_random_point(const rectangle<T>& rectangle) {
  return translate(min(rectangle[0].x, rectangle[1].x),
...
inline point3d<T> generate_random_point(const box<T, 3>& box) {
  return translate(
      min(box[0].x, box[1].x), min(box[0].y, box[1].y), min(box[0].z, box[1].z),
      generate_random_point(abs(box[1].x - box[0].x), abs(box[1].y - box[0].y),
                            abs(box[1].z - box[0].z)));
}

template <typename T, typename OutputIterator>
inline void generate_random_points(const T& x1, const T& y1, const T& x2,
                                   const T& y2, const std::size_t& point_count,
                                   OutputIterator out) {
...
template <typename T, typename OutputIterator>
inline void generate_random_points(const rectangle<T>& rectangle,
                                   const std::size_t& point_count,
                                   OutputIterator out) {
  generate_random_points(rectangle[0].x, rectangle[0].y, rectangle[1].x,
                         rectangle[1].y, point_count, out);
}

template <typename T, typename OutputIterator>
inline void generate_random_points(const box<T, 3>& box,
                                   const std::size_t& point_count,
                                   OutputIterator out) {
  generate_random_points(box[0].x, box[0].y, box[0].z, box[1].x, box[1].y,
                         box[1].z, point_count, out);
}

template <typename T, typename OutputIterator>
inline void generate_random_points(const segment<T, 2>& segment,
                                   const std::size_t& point_count,
                                   OutputIterator out) {
  for (std::size_t i = 0; i < point_count; ++i) {
...
template <typename T, typename OutputIterator>
inline void generate_random_points(const segment<T, 3>& segment,
                                   const std::size_t& point_count,
                                   OutputIterator out) {
  for (std::size_t i = 0; i < point_count; ++i) {
    (*out++) = generate_random_point(segment);
...
template <typename T, typename OutputIterator>
inline void generate_random_points(const triangle<T, 2>& triangle,
                                   const std::size_t& point_count,
                                   OutputIterator out) {
  for (std::size_t i = 0; i < point_count; ++i) {
...
template <typename T, typename OutputIterator>
inline void generate_random_points(const triangle<T, 3>& triangle,
                                   const std::size_t& point_count,
                                   OutputIterator out) {
  for (std::size_t i = 0; i < point_count; ++i) {
    (*out++) = generate_random_point(triangle);
...
template <typename T, typename OutputIterator>
inline void generate_random_points(const quadix<T, 2>& quadix,
                                   const std::size_t& point_count,
                                   OutputIterator out) {
  for (std::size_t i = 0; i < point_count; ++i) {
...
template <typename T, typename OutputIterator>
inline void generate_random_points(const quadix<T, 3>& quadix,
                                   const std::size_t& point_count,
                                   OutputIterator out) {
  for (std::size_t i = 0; i < point_count; ++i) {
    (*out++) = generate_random_point(quadix);
...
template <typename T, typename OutputIterator>
inline void generate_random_points(const circle<T>& circle,
                                   const std::size_t& point_count,
                                   OutputIterator out) {
...
template <typename T>
inline void generate_random_object(const T& x1, const T& y1, const T& x2,
                                   const T& y2, segment<T, 2>& segment) {
  const T dx = abs(x2 - x1);
  const T dy = abs(y2 - y1);
...
template <typename T>
inline void generate_random_object(const T& x1, const T& y1, const T& x2,
                                   const T& y2, rectangle<T>& rectangle) {
  const T dx = abs(x2 - x1);
  const T dy = abs(y2 - y1);
...
template <typename T>
inline void generate_random_object(const T& x1, const T& y1, const T& x2,
                                   const T& y2, triangle<T, 2>& triangle) {
  const T dx = abs(x2 - x1);
  const T dy = abs(y2 - y1);
...
template <typename T>
inline void generate_random_object(const T& x1, const T& y1, const T& x2,
                                   const T& y2, circle<T>& circle) {
  const T dx = abs(x2 - x1);
  const T dy = abs(y2 - y1);

  circle.radius = generate_random_value(min(dx, dy) * T(0.5));
  circle.x =
      x1 + circle.radius + generate_random_value(dx - (T(2.0) * circle.radius));
  circle.y =
      y1 + circle.radius + generate_random_value(dy - (T(2.0) * circle.radius));
}

template <typename T>
inline void generate_random_object(const T& x1, const T& y1, const T& z1,
                                   const T& x2, const T& y2, const T& z2,
                                   box<T, 3>& box) {
...
template <typename T>
inline triangle<T, 2> right_shift(const triangle<T, 2>& triangle,
...
template <typename T>
inline triangle<T, 3> right_shift(const triangle<T, 3>& triangle,
                                  const std::size_t& shift) {
  switch (shift % 3) {
    case 0:
      return triangle;
...
template <typename T>
inline quadix<T, 2> right_shift(const quadix<T, 2>& quadix,
                                const std::size_t& shift) {
  switch (shift % 4) {
    case 0:
      return quadix;
...
template <typename T>
inline quadix<T, 3> right_shift(const quadix<T, 3>& quadix,
                                const std::size_t& shift) {
  switch (shift % 4) {
    case 0:
      return quadix;
...
template <typename T>
inline T triple_product(const vector3d<T>& v1, const vector3d<T>& v2,
                        const vector3d<T>& v3) {
...
template <typename T>
inline bool is_equal(const rectangle<T>& rectangle1,
                     const rectangle<T>& rectangle2) {
  return (is_equal(rectangle1[0], rectangle2[0]) &&
          is_equal(rectangle1[1], rectangle2[1])) ||
         (is_equal(rectangle1[0], rectangle2[1]) &&
          is_equal(rectangle1[1], rectangle2[0]));
}

template <typename T>
inline bool is_equal(const circle<T>& circle1, const circle<T>& circle2) {
  return is_equal(circle1.x, circle2.x) && is_equal(circle1.y, circle2.y) &&
...
inline bool is_equal(const sphere<T>& sphere1, const sphere<T>& sphere2) {
  return is_equal(sphere1.x, sphere2.x) && is_equal(sphere1.y, sphere2.y) &&
...
template <typename T>
inline bool not_equal(const rectangle<T>& rectangle1,
                      const rectangle<T>& rectangle2) {
...
template <typename T>
inline bool is_degenerate(const T& x1, const T& y1, const T& z1, const T& x2,
                          const T& y2, const T& z2) {
...
inline bool is_degenerate(const segment<T, 3>& segment) {
  return is_degenerate(segment[0].x, segment[0].y, segment[0].z, segment[1].x,
                       segment[1].y, segment[1].z);
}

template <typename T>
inline bool is_degenerate(const line<T, 3>& line) {
  return is_degenerate(line[0].x, line[0].y, line[0].z, line[1].x, line[1].y,
                       line[1].z);
}
...
inline bool is_degenerate(const triangle<T, 2>& triangle) {
  return is_equal(triangle[0], triangle[1]) ||
         ...
         is_equal(distance(edge(triangle, 0)), (distance(edge(triangle, 1)) +
                                                distance(edge(triangle, 2)))) ||
         is_equal(distance(edge(triangle, 1)), (distance(edge(triangle, 2)) +
                                                distance(edge(triangle, 0)))) ||
         is_equal(distance(edge(triangle, 2)),
                  (distance(edge(triangle, 0)) + distance(edge(triangle, 1))));
}
...
inline bool is_degenerate(const circular_arc<T>& arc) {
  return is_degenerate(arc.x1, arc.y1, arc.x2, arc.y2) ||
         ...
         (lay_distance(arc.x1, arc.y1, arc.cx, arc.cy) !=
          lay_distance(arc.x2, arc.y2, arc.cx, arc.cy)) ||
         (lay_distance(arc.x1, arc.y1, arc.cx, arc.cy) !=
          lay_distance(arc.px, arc.py, arc.cx, arc.cy)) ||
         (cartesian_angle(arc.x1 - arc.cx, arc.y1 - arc.cy) != arc.angle1) ||
         (cartesian_angle(arc.x2 - arc.cx, arc.y2 - arc.cy) != arc.angle2) ||
         (cartesian_angle(arc.px - arc.cx, arc.py - arc.cy) !=
          abs(arc.angle1 - arc.angle2)) ||
         (orientation(arc.x1, arc.y1, arc.x2, arc.y2, arc.px, arc.py) !=
          arc.orientation);
}
...
inline vector2d<T> degenerate_vector2d() {
  return make_vector(infinity<T>(), infinity<T>());
}

template <typename T>
inline vector3d<T> degenerate_vector3d() {
  return make_vector(infinity<T>(), infinity<T>(), infinity<T>());
}
...
inline triangle<T, 2> degenerate_triangle2d() {
  return make_triangle(degenerate_point2d<T>(), degenerate_point2d<T>(),
                       degenerate_point2d<T>());
}

template <typename T>
inline triangle<T, 3> degenerate_triangle3d() {
  return make_triangle(degenerate_point3d<T>(), degenerate_point3d<T>(),
                       degenerate_point3d<T>());
}

template <typename T>
inline quadix<T, 2> degenerate_quadix2d() {
  return make_quadix(degenerate_point2d<T>(), degenerate_point2d<T>(),
                     degenerate_point2d<T>(), degenerate_point2d<T>());
}

template <typename T>
inline quadix<T, 3> degenerate_quadix3d() {
  return make_quadix(degenerate_point3d<T>(), degenerate_point3d<T>(),
                     degenerate_point3d<T>(), degenerate_point3d<T>());
}
...
template <typename T>
inline ray<T, 2> make_ray(const T& ox, const T& oy, const T& dir_x,
                          const T& dir_y) {
  ray<T, 2> _ray;
  _ray.origin.x = ox;
  _ray.origin.y = oy;
...
template <typename T>
inline ray<T, 3> make_ray(const T& ox, const T& oy, const T& oz, const T& dir_x,
...
template <typename T>
inline ray<T, 2> make_ray(const point2d<T>& origin,
                          const vector2d<T>& direction) {
  return make_ray(origin.x, origin.y, direction.x, direction.y);
}

template <typename T>
inline ray<T, 3> make_ray(const point3d<T>& origin,
                          const vector3d<T>& direction) {
  return make_ray(origin.x, origin.y, origin.z, direction.x, direction.y,
                  direction.z);
}

template <typename T>
inline ray<T, 2> make_ray(const point2d<T>& origin, const T& bearing) {
  return make_ray(origin, make_vector(project_point<T>(
                              make_point(T(0.0), T(0.0)), bearing, T(1.0))));
}

template <typename T>
inline curve_point<T, 3> make_curve_point(const T& x, const T& y, const T& z,
                                          const T& t) {
...
template <typename T>
inline segment<T, 2> make_segment(const T& x1, const T& y1, const T& x2,
                                  const T& y2) {
  segment<T, 2> segment;
...
template <typename T>
inline segment<T, 3> make_segment(const T& x1, const T& y1, const T& z1,
                                  const T& x2, const T& y2, const T& z2) {
  segment<T, 3> segment;
...
template <typename T>
inline segment<T, 2> make_segment(const point2d<T>& point1,
                                  const point2d<T>& point2) {
  return make_segment(point1.x, point1.y, point2.x, point2.y);
}

template <typename T>
inline segment<T, 3> make_segment(const point3d<T>& point1,
                                  const point3d<T>& point2) {
  return make_segment(point1.x, point1.y, point1.z, point2.x, point2.y,
                      point2.z);
}
...
template <typename T>
inline line<T, 2> make_line(const T& x1, const T& y1, const T& x2,
                            const T& y2) {
  line<T, 2> line;
...
template <typename T>
inline line<T, 3> make_line(const T& x1, const T& y1, const T& z1, const T& x2,
                            const T& y2, const T& z2) {
  line<T, 3> line;
...
template <typename T>
inline line<T, 2> make_line(const point2d<T>& point1,
                            const point2d<T>& point2) {
  return make_line(point1.x, point1.y, point2.x, point2.y);
}

template <typename T>
inline line<T, 3> make_line(const point3d<T>& point1,
                            const point3d<T>& point2) {
...
template <typename T>
inline rectangle<T> make_rectangle(const T& x1, const T& y1, const T& x2,
                                   const T& y2) {
  rectangle<T> rectangle_;
...
template <typename T>
inline rectangle<T> make_rectangle(const point2d<T>& point1,
                                   const point2d<T>& point2) {
  return make_rectangle(point1.x, point1.y, point2.x, point2.y);
}

template <typename T>
inline box<T, 3> make_box(const T& x1, const T& y1, const T& z1, const T& x2,
                          const T& y2, const T& z2) {
  box<T, 3> box_;
...
template <typename T>
inline triangle<T, 2> make_triangle(const T& x1, const T& y1, const T& x2,
                                    const T& y2, const T& x3, const T& y3) {
  triangle<T, 2> triangle_;
...
template <typename T>
inline triangle<T, 2> make_triangle(const point2d<T>& point1,
                                    const point2d<T>& point2,
                                    const point2d<T>& point3) {
  return make_triangle(point1.x, point1.y, point2.x, point2.y, point3.x,
                       point3.y);
}

template <typename T>
inline triangle<T, 3> make_triangle(const point3d<T>& point1,
                                    const point3d<T>& point2,
                                    const point3d<T>& point3) {
  return make_triangle(point1.x, point1.y, point1.z, point2.x, point2.y,
                       point2.z, point3.x, point3.y, point3.z);
}

template <typename T>
inline quadix<T, 2> make_quadix(const T& x1, const T& y1, const T& x2,
                                const T& y2, const T& x3, const T& y3,
                                const T& x4, const T& y4) {
  quadix<T, 2> quadix_;
...
template <typename T>
inline quadix<T, 2> make_quadix(const point2d<T>& point1,
                                const point2d<T>& point2,
                                const point2d<T>& point3,
                                const point2d<T>& point4) {
  return make_quadix(point1.x, point1.y, point2.x, point2.y, point3.x, point3.y,
                     point4.x, point4.y);
}

template <typename T>
inline quadix<T, 3> make_quadix(const point3d<T>& point1,
                                const point3d<T>& point2,
                                const point3d<T>& point3,
                                const point3d<T>& point4) {
  return make_quadix(point1.x, point1.y, point1.z, point2.x, point2.y, point2.z,
                     point3.x, point3.y, point3.z, point4.x, point4.y,
                     point4.z);
}
...
inline quadix<T, 2> make_quadix(const rectangle<T>& rectangle) {
  return make_quadix(rectangle[0].x, rectangle[0].y, rectangle[1].x,
                     rectangle[1].y);
}
...
template <typename T>
inline circle<T> make_circle(const point2d<T>& point1,
                             const point2d<T>& point2) {
...
template <typename T>
inline sphere<T> make_sphere(const T& x, const T& y, const T& z,
                             const T& radius) {
  sphere<T> sphere_;
...
template <typename T>
inline sphere<T> make_sphere(const point3d<T>& point1,
                             const point3d<T>& point2) {
  return make_sphere(
      (point1.x + point2.x) * T(0.5), (point1.y + point2.y) * T(0.5),
      (point1.z + point2.z) * T(0.5), distance(point1, point2) * T(0.5));
}
...
inline plane<T, 3> make_plane(const point3d<T>& point1,
                              const point3d<T>& point2,
                              const point3d<T>& point3) {
  return make_plane(point1.x, point1.y, point1.z, point2.x, point2.y, point2.z,
                    point3.x, point3.y, point3.z);
}
...
inline polygon<T, D> make_polygon(const InputIterator begin,
                                  const InputIterator end) {
...
inline polygon<T, 2> make_polygon(const std::vector<point2d<T> >& point_list) {
  return make_polygon<T, 2, typename std::vector<point2d<T> >::const_iterator>(
      point_list.begin(), point_list.end());
}

template <typename T>
inline polygon<T, 3> make_polygon(const std::vector<point3d<T> >& point_list) {
  return make_polygon<T, 3, typename std::vector<point3d<T> >::const_iterator>(
      point_list.begin(), point_list.end());
}
...
template <typename T>
inline polygon<T, 2> make_polygon(const circle<T>& circle,
  ...
  for (std::size_t i = 0; i < point_count; ++i) {
    point2d<T> point_;
    rotate(angle * T(1.0 * i), circle.x + circle.radius, circle.y, circle.x,
           circle.y, point_.x, point_.y);
